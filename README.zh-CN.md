...
版本 0.1.22 使用本包自包含的 AgentTeams 内核，已针对公开 DSH `0.1.7-alpha.1` 包线完成验证；不需要未发布的官方实验性 Agent Teams 包或本地 DSH checkout。
...
```bash
cd ~/.dsh/profiles/web
pnpm add https://github.com/HelloJiada/dsh-experimental-agent-team-web/releases/latest/download/deepseek-ai-dsh-experimental-agent-team-web-0.1.22.tgz
```
...
Release tarball: `deepseek-ai-dsh-experimental-agent-team-web-0.1.22.tgz`
