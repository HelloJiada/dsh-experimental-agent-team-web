 ...
 * 是裸值则原样返回(测试夹具与旧宿主)。 */
export declare function unwrapVolatile<T>(value: unknown): T | undefined;
...
export declare function settingsAccessFromConfig(config: AgentTeamSettingsSource): AgentTeamSettingsAccess;
