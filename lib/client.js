window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function providersFromStateBody(body) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					rows.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						children: t(loading ? "settings.providers.loading" : "settings.providers.empty")
		...
		*/
		function apply(ctx) {
			...
			const providerGrantsScope = ctx.settingsScope.bind({ namespace: PROVIDER_GRANTS_NAMESPACE });
