	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"settings.agentTeam.legacyRoute": "旧路由记录：{provider} / {model}（仅兼容展示）",
			"settings.agentTeam.providerMissing": "provider 未记录",
			"settings.agentTeam.inheritCaptainRoute": "新成员默认继承队长路由",
			"settings.agentTeam.rolePreset": "角色预设",
			"settings.agentTeam.locked": "默认",
		...
		const en = {
			...
			"settings.agentTeam.legacyRoute": "Legacy route: {provider} / {model} (compatibility display only)",
			"settings.agentTeam.providerMissing": "provider not recorded",
			"settings.agentTeam.inheritCaptainRoute": "New members inherit the captain route by default",
			"settings.agentTeam.rolePreset": "Role presets",
			"settings.agentTeam.locked": "Default",
		...
		*/
		...
		const cssText$2 = ".iLM_pq_root{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:8px;width:100%;min-width:0;padding:10px 12px;display:flex}.iLM_pq_head{align-items:center;gap:8px;min-width:0;display:flex}.iLM_pq_leadAvatar{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0;flex:none;width:30px;height:30px}.iLM_pq_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.iLM_pq_memberCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;margin-left:auto;font-size:11px;line-height:16px}.iLM_pq_panelButton{border:1px solid var(--dsw-alias-line-strong);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;flex:none;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:16px;transition:border-color .12s,color .12s}.iLM_pq_panelButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.iLM_pq_panelButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.iLM_pq_members{flex-wrap:wrap;gap:6px;min-width:0;display:flex}.iLM_pq_member{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:160px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:5px;padding:3px 8px 3px 3px;font-size:11px;font-weight:500;line-height:16px;transition:border-color .12s,background-color .12s;display:inline-flex}.iLM_pq_member:hover{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-fill-neutral)}.iLM_pq_member:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.iLM_pq_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d482e);background:0 0;border:0;border-radius:0;width:24px;height:24px}.iLM_pq_memberInitial{background:var(--dsw-alias-bg-fill-business);width:20px;height:20px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:10px;font-weight:600;line-height:20px;display:inline-flex}.iLM_pq_memberName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}";
		...
		var AgentTeamsCard_module_css_default = {
			"head": "iLM_pq_head",
			"leadAvatar": "iLM_pq_leadAvatar",
			"member": "iLM_pq_member",
			"memberArt": "iLM_pq_memberArt",
			"memberCount": "iLM_pq_memberCount",
			"memberInitial": "iLM_pq_memberInitial",
			"memberName": "iLM_pq_memberName",
			"members": "iLM_pq_members",
			"panelButton": "iLM_pq_panelButton",
			"root": "iLM_pq_root",
			"teamName": "iLM_pq_teamName"
		};
		//#endregion
		...
		*/
		...
		const cssText$1 = "html{--agent-team-web-panel-shift:420px}html[data-agent-team-web-panel-open] div[data-phase]{box-sizing:border-box;padding-right:var(--agent-team-web-panel-shift)}.ISPsoq_badge,.ISPsoq_panel{--at-bg-panel:#fff;--at-bg-raised:#fafbfc;--at-bg-fill:#f4f6f9;--at-border:#e8ebf0;--at-border-strong:#d9dee8;--at-text-primary:#1b1f27;--at-text-secondary:#5a6474;--at-text-tertiary:#8f97a6;--at-accent:#2d5ca8;--at-accent-hover:#3568b8;--at-accent-strong:#244a8a;--at-success:#15875a;--at-warning:#a4681a;--at-danger:#c23b42;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #17203014;--at-shadow-panel:0 12px 32px #17203012, 0 32px 72px #1720301c;--at-shadow-active:0 16px 40px #1720301a, 0 36px 80px #17203024;--dsw-alias-bg-module:var(--at-bg-panel);--dsw-alias-bg-module-platform:var(--at-bg-raised);--dsw-alias-bg-fill-neutral:var(--at-bg-fill);--dsw-alias-bg-fill-business:var(--at-accent);--dsw-alias-bg-fill-success:var(--at-success);--dsw-alias-bg-fill-warning:var(--at-warning);--dsw-alias-bg-fill-danger:var(--at-danger);--dsw-alias-state-business-primary:var(--at-accent);--dsw-alias-state-success:var(--at-success);--dsw-alias-state-warning:var(--at-warning);--dsw-alias-state-danger:var(--at-danger);--dsw-alias-label-primary:var(--at-text-primary);--dsw-alias-label-secondary:var(--at-text-secondary);--dsw-alias-label-tertiary:var(--at-text-tertiary);--dsw-alias-label-on-fill:var(--at-on-accent);--dsw-alias-line-normal:var(--at-border);--dsw-alias-line-strong:var(--at-border-strong)}@media (prefers-color-scheme:dark){.ISPsoq_badge,.ISPsoq_panel{--at-bg-panel:#1e1f22;--at-bg-raised:#202125;--at-bg-fill:#2a2c30;--at-border:#2e3136;--at-border-strong:#3a3e45;--at-text-primary:#f5f6f8;--at-text-secondary:#b9bdc6;--at-text-tertiary:#8b90a0;--at-accent:#5b8dd9;--at-accent-hover:#6d9be0;--at-accent-strong:#4a7cc9;--at-success:#3ecf7f;--at-warning:#f0a83c;--at-danger:#f0606a;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #00000073;--at-shadow-panel:0 12px 32px #00000073, 0 32px 72px #0000008c;--at-shadow-active:0 16px 40px #00000080, 0 36px 80px #0009}.ISPsoq_stateArt{filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #00000073)}}.ISPsoq_badge{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:color-mix(in srgb, var(--dsw-alias-bg-module-platform) 92%, transparent);backdrop-filter:blur(16px);height:34px;box-shadow:var(--at-shadow-badge);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:7px;padding:0 12px;font-size:12px;font-weight:600;line-height:20px;transition:border-color .12s,transform .12s;display:inline-flex;position:absolute;top:64px;right:18px}.ISPsoq_badge:hover{border-color:var(--dsw-alias-line-strong);transform:translateY(-1px)}.ISPsoq_badge:active{transform:translateY(0)scale(.97)}.ISPsoq_badge:focus-visible,.ISPsoq_iconButton:focus-visible,.ISPsoq_memberRow:focus-visible,.ISPsoq_membersToggle:focus-visible,.ISPsoq_sectionToggleTitle:focus-visible,.ISPsoq_historyToggle:focus-visible,.ISPsoq_dagNode:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.ISPsoq_badgeDot,.ISPsoq_panelDot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:7px;height:7px}.ISPsoq_badgeDot[data-busy=true],.ISPsoq_panelDot[data-busy=true]{background:var(--dsw-alias-state-business-primary);animation:1.25s ease-in-out infinite ISPsoq_agentTeamsPulse}.ISPsoq_badgeCount,.ISPsoq_memberCount,.ISPsoq_teamStats,.ISPsoq_stageLabel,.ISPsoq_taskId{font-variant-numeric:tabular-nums}.ISPsoq_panel{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-line-strong) 58%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-module) 95%, transparent);backdrop-filter:blur(20px)saturate(1.08);box-shadow:var(--at-shadow-panel);will-change:transform;border-radius:16px;flex-direction:column;animation:.16s ease-out ISPsoq_agentTeamsPanelIn;display:flex;position:absolute;top:0;left:0;overflow:hidden}.ISPsoq_panel[data-dragging],.ISPsoq_panel[data-resizing]{user-select:none;box-shadow:var(--at-shadow-active)}@keyframes ISPsoq_agentTeamsPanelIn{0%{opacity:0}to{opacity:1}}@keyframes ISPsoq_agentTeamsPulse{0%,to{opacity:.42}50%{opacity:1}}.ISPsoq_panelHead{border-bottom:1px solid var(--dsw-alias-line-normal);cursor:grab;touch-action:none;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:0 14px;display:flex}.ISPsoq_panelHead:active,.ISPsoq_panel[data-dragging] .ISPsoq_panelHead{cursor:grabbing}.ISPsoq_panel[data-compact] .ISPsoq_panelHead{cursor:default;touch-action:auto}.ISPsoq_panelTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:8px;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}.ISPsoq_panelControls{flex:none;align-items:center;gap:2px;display:inline-flex}.ISPsoq_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,transform .12s;display:inline-flex}.ISPsoq_iconButton:hover{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-primary)}.ISPsoq_iconButton:active{transform:scale(.94)}.ISPsoq_iconButton[data-control=dock][data-mode=docked] svg{transform:scaleX(-1)}.ISPsoq_iconButton[data-control=close]:hover:not(:disabled){background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.ISPsoq_iconButton[data-control=close]:disabled{opacity:.45;cursor:not-allowed}.ISPsoq_closeError{color:var(--dsw-alias-state-danger);border-top:1px solid var(--dsw-alias-line-normal);padding:4px 14px;font-size:12px;line-height:16px}.ISPsoq_resizeHandle{z-index:1;touch-action:none;position:absolute}.ISPsoq_resizeHandle[data-resize-edge=left]{cursor:ew-resize;width:8px;top:44px;bottom:8px;left:0}.ISPsoq_resizeHandle[data-resize-edge=bottom]{cursor:ns-resize;height:8px;bottom:0;left:12px;right:12px}.ISPsoq_resizeHandle[data-resize-edge=corner]{cursor:nwse-resize;width:18px;height:18px;bottom:0;right:0}.ISPsoq_resizeHandle[data-resize-edge=corner]:after{border-right:1px solid var(--dsw-alias-label-tertiary);border-bottom:1px solid var(--dsw-alias-label-tertiary);content:\"\";opacity:.52;width:7px;height:7px;position:absolute;bottom:4px;right:4px}.ISPsoq_teams{overscroll-behavior:contain;scrollbar-color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent) transparent;scrollbar-width:thin;flex-direction:column;min-height:0;display:flex;overflow-y:auto}.ISPsoq_teams::-webkit-scrollbar{width:6px}.ISPsoq_teams::-webkit-scrollbar-track{background:0 0}.ISPsoq_teams::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent);background-clip:padding-box;border:2px solid #0000;border-radius:999px}.ISPsoq_teams:hover::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 44%, transparent);background-clip:padding-box}.ISPsoq_team{border-bottom:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:12px;padding:12px 14px 14px;display:flex}.ISPsoq_team:last-child{border-bottom:0}.ISPsoq_teamHead{align-items:center;gap:10px;min-width:0;display:flex}.ISPsoq_teamName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}.ISPsoq_teamStats{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;gap:8px;font-size:10px;line-height:16px;display:inline-flex}.ISPsoq_sectionHead{justify-content:space-between;align-items:center;gap:8px;min-width:0;display:flex}.ISPsoq_sectionTitle{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.ISPsoq_sectionHint{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.ISPsoq_delegationSection{flex-direction:column;gap:10px;min-width:0;display:flex}.ISPsoq_captainNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 32%, var(--dsw-alias-line-normal));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid}.ISPsoq_commandLayer{grid-template-columns:1fr;gap:10px;display:grid}.ISPsoq_commandLayer[data-leadership=solo]{grid-template-columns:1fr}.ISPsoq_commissarNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--at-accent) 32%, var(--at-border));background:color-mix(in srgb, var(--at-accent) 5%, var(--at-bg-panel));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid;position:relative}.ISPsoq_commissarNode:before{background:var(--at-accent);content:\"\";border-radius:2px;width:2px;position:absolute;top:8px;bottom:8px;left:0}.ISPsoq_commissarState{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;text-align:right;font-size:10px;line-height:14px;overflow:hidden}.ISPsoq_commissarState[data-activity=working]{color:var(--dsw-alias-state-business-primary);font-weight:600}.ISPsoq_captainAvatar,.ISPsoq_memberAvatar{flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}.ISPsoq_captainAvatar{width:46px;height:46px}.ISPsoq_leadAvatar,.ISPsoq_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0}.ISPsoq_leadAvatar{width:44px;height:44px}.ISPsoq_memberArt{width:40px;height:40px}.ISPsoq_captainInfo,.ISPsoq_memberInfo{flex-direction:column;min-width:0;display:flex}.ISPsoq_captainInfo{gap:2px}.ISPsoq_captainLine,.ISPsoq_memberLine{align-items:center;gap:6px;min-width:0;display:flex}.ISPsoq_captainName,.ISPsoq_memberName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:18px;overflow:hidden}.ISPsoq_captainRole,.ISPsoq_memberRole{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.ISPsoq_memberModel{color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 78%, transparent);text-overflow:ellipsis;white-space:nowrap;flex:none;margin-left:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:8px;line-height:12px;overflow:hidden}.ISPsoq_captainSummary,.ISPsoq_memberStatusLine{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:15px;overflow:hidden}.ISPsoq_memberElapsed{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:4px;flex:none;align-items:center;margin-left:6px;padding:0 4px;font-size:8.5px;font-weight:600;line-height:14px;display:inline-flex}.ISPsoq_memberElapsed[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 14%, transparent);color:var(--dsw-alias-state-warning)}.ISPsoq_memberElapsed[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 14%, transparent);color:var(--dsw-alias-state-danger)}.ISPsoq_captainState,.ISPsoq_memberState{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;align-items:center;gap:5px;font-size:10px;font-weight:500;line-height:15px;display:inline-flex}.ISPsoq_captainState[data-busy=true],.ISPsoq_memberState[data-activity=working]{color:var(--dsw-alias-state-business-primary)}.ISPsoq_workGlyph rect{opacity:.5}.ISPsoq_workGlyph[data-active=true] rect{animation:1.1s ease-in-out infinite ISPsoq_agentTeamsDot}@keyframes ISPsoq_agentTeamsDot{0%,to{opacity:.25}50%{opacity:1}}.ISPsoq_progressOverview{flex-direction:column;gap:7px;display:flex}.ISPsoq_progressTitle{color:var(--dsw-alias-label-secondary);font-size:11px;font-weight:600;line-height:16px}.ISPsoq_progressSegments{gap:3px;display:flex}.ISPsoq_progressSegments>span,.ISPsoq_progressEmpty{background:var(--dsw-alias-line-strong);border-radius:2px;flex:1;height:5px}.ISPsoq_progressEmpty{width:100%;display:block}.ISPsoq_progressSegments>span[data-state=running]{background:var(--dsw-alias-state-business-primary)}.ISPsoq_progressSegments>span[data-state=blocked]{background:var(--dsw-alias-state-warning)}.ISPsoq_progressSegments>span[data-state=completed]{background:var(--dsw-alias-state-success)}.ISPsoq_progressSegments>span[data-state=failed]{background:var(--dsw-alias-state-danger)}.ISPsoq_progressSegments>span[data-state=cancelled]{opacity:.55}.ISPsoq_progressLegend{color:var(--dsw-alias-label-tertiary);gap:10px;font-size:9px;line-height:14px;display:flex}.ISPsoq_progressLegend>span[data-state=running]{color:var(--dsw-alias-state-business-primary)}.ISPsoq_progressLegend>span[data-state=blocked]{color:var(--dsw-alias-state-warning)}.ISPsoq_progressLegend>span[data-state=completed]{color:var(--dsw-alias-state-success)}.ISPsoq_progressSummary{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));min-width:0;color:var(--dsw-alias-label-secondary);border-radius:8px;align-items:center;gap:6px;padding:5px 8px;font-size:10px;font-weight:600;line-height:15px;display:flex}.ISPsoq_progressSummary[data-state=warning]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 8%, var(--dsw-alias-bg-module))}.ISPsoq_progressSummary[data-state=completed]{background:color-mix(in srgb, var(--dsw-alias-state-success) 8%, var(--dsw-alias-bg-module))}.ISPsoq_progressSummary>span:last-child{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.ISPsoq_progressSummaryDot{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:5px;height:5px}.ISPsoq_progressSummary[data-state=warning] .ISPsoq_progressSummaryDot{background:var(--dsw-alias-state-warning)}.ISPsoq_progressSummary[data-state=completed] .ISPsoq_progressSummaryDot{background:var(--dsw-alias-state-success)}.ISPsoq_membersToggle{background:var(--dsw-alias-bg-module-platform);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.ISPsoq_membersToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.ISPsoq_membersToggle>span{align-items:center;gap:5px;display:inline-flex}.ISPsoq_membersToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.ISPsoq_historyToggle{background:var(--dsw-alias-bg-module);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.ISPsoq_historyToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.ISPsoq_historyToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.ISPsoq_chevron{flex:none;transition:transform .12s}.ISPsoq_chevron[data-open=true]{transform:rotate(90deg)}.ISPsoq_delegationTree{flex-direction:column;gap:2px;margin-left:18px;padding:0 0 0 20px;display:flex;position:relative}.ISPsoq_delegationTree:before{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));content:\"\";width:1px;position:absolute;top:0;bottom:22px;left:0}.ISPsoq_memberBlock{flex-direction:column;min-width:0;padding:3px 0 7px;display:flex;position:relative}.ISPsoq_memberBranch{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));width:20px;height:1px;display:block;position:absolute;top:27px;right:100%}.ISPsoq_memberBranch:before{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:5px;height:5px;position:absolute;top:-2px;right:-1px}.ISPsoq_memberRow{box-sizing:border-box;width:100%;min-width:0;min-height:48px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:46px minmax(0,1fr) auto;align-items:center;gap:8px;padding:4px 6px;transition:background-color .12s,transform .12s;display:grid}.ISPsoq_memberRow:hover,.ISPsoq_memberRow[data-activity=working]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.ISPsoq_memberRow:active{transform:scale(.99)}.ISPsoq_memberAvatar{width:42px;height:42px}.ISPsoq_memberAvatar[data-unread=true]:after{box-sizing:border-box;border:1px solid var(--dsw-alias-bg-module);background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:6px;height:6px;animation:1.8s ease-in-out infinite ISPsoq_agentTeamsUnreadPulse;position:absolute;top:0;right:-1px}@keyframes ISPsoq_agentTeamsUnreadPulse{0%,to{opacity:.78;transform:scale(.92)}50%{opacity:1;transform:scale(1.16)}}.ISPsoq_memberInitial{background:var(--dsw-alias-bg-fill-business);width:38px;height:38px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:15px;font-weight:600;line-height:20px;display:inline-flex}.ISPsoq_stateArt{box-sizing:border-box;object-fit:contain;width:22px;height:22px;filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #122d483d);background:0 0;border:0;border-radius:0;position:absolute;bottom:-3px;right:-5px}.ISPsoq_stateArt[data-activity=working]{animation:2.4s ease-in-out infinite ISPsoq_agentTeamsFloat}.ISPsoq_stateArt[data-activity=idle]{animation:4.2s ease-in-out infinite ISPsoq_agentTeamsBreathe}.ISPsoq_stateArt[data-activity=unknown]{animation:2.8s ease-in-out infinite ISPsoq_agentTeamsThink}@keyframes ISPsoq_agentTeamsFloat{0%,to{transform:translateY(0)rotate(-4deg)}50%{transform:translateY(-2px)rotate(4deg)}}@keyframes ISPsoq_agentTeamsBreathe{0%,to{opacity:.82;transform:scale(1)}50%{opacity:1;transform:scale(1.06)}}@keyframes ISPsoq_agentTeamsThink{0%,to{transform:rotate(-7deg)}50%{transform:rotate(7deg)}}.ISPsoq_memberRight{flex:none;align-items:center;gap:8px;display:inline-flex}.ISPsoq_memberCount{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}.ISPsoq_assignmentLine{align-items:center;gap:7px;min-width:0;padding:0 6px 0 60px;display:flex}.ISPsoq_assignmentLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:9px;line-height:14px}.ISPsoq_assignmentTasks{flex-wrap:wrap;flex:1;gap:4px;min-width:0;display:flex}.ISPsoq_assignmentChip{background:var(--dsw-alias-bg-fill-neutral);min-height:16px;color:var(--dsw-alias-label-secondary);border-radius:4px;align-items:center;padding:0 5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:600;line-height:14px;display:inline-flex}.ISPsoq_assignmentChip[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.ISPsoq_assignmentChip[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.ISPsoq_assignmentChip[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.ISPsoq_assignmentChip[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.ISPsoq_assignmentChip[data-state=cancelled]{color:var(--dsw-alias-label-tertiary);text-decoration:line-through}.ISPsoq_assignmentChip[data-review=pending]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.ISPsoq_assignmentChip[data-helping=true]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 50%, transparent);outline-offset:-1px}.ISPsoq_reviewChip,.ISPsoq_helpingChip,.ISPsoq_calibrationChip,.ISPsoq_blockedChip,.ISPsoq_inputChip{box-sizing:border-box;white-space:nowrap;min-height:16px;color:inherit;background:0 0;border-radius:4px;flex:none;align-items:center;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.ISPsoq_reviewChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-state-warning) 70%, transparent);outline-offset:-1px}.ISPsoq_blockedChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 75%, transparent);outline-offset:-1px}.ISPsoq_inputChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.ISPsoq_helpingChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 65%, transparent);outline-offset:-1px}.ISPsoq_calibrationChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.ISPsoq_assignmentChip[data-timing=warn]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.ISPsoq_assignmentChip[data-timing=over]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-danger) 62%, transparent);outline-offset:-1px}.ISPsoq_timingChip{box-sizing:border-box;white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:16px;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.ISPsoq_timingChip[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 16%, transparent);color:var(--dsw-alias-state-warning)}.ISPsoq_timingChip[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 16%, transparent);color:var(--dsw-alias-state-danger)}.ISPsoq_unreadPill{color:var(--dsw-alias-state-business-primary);white-space:nowrap;flex:none;font-size:9px;font-weight:600;line-height:14px}.ISPsoq_taskEmpty{color:var(--dsw-alias-label-tertiary);font-size:9px;line-height:14px}.ISPsoq_dependencySection{border-top:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:7px;min-width:0;padding-top:10px;display:flex}.ISPsoq_sectionToggleTitle{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.ISPsoq_dagViewport{scrollbar-width:thin;min-width:0;padding:2px 0 4px;overflow-x:auto}.ISPsoq_dagCanvas{min-width:100%;position:relative}.ISPsoq_dagCanvas[data-layout=parallel]{flex-wrap:wrap;gap:8px;display:flex}.ISPsoq_dagCanvas[data-layout=parallel] .ISPsoq_dagNode{flex:92px;min-width:92px;position:relative}.ISPsoq_dagEdges{pointer-events:none;position:absolute;inset:0;overflow:visible}.ISPsoq_dagEdges path{fill:none;stroke:var(--dsw-alias-line-strong);stroke-width:1px;transition:opacity .12s,stroke .12s,stroke-width .12s}.ISPsoq_dagEdges path[data-active=true]{stroke:var(--dsw-alias-state-business-primary);stroke-width:1.6px}.ISPsoq_dagEdges path[data-dimmed=true]{opacity:.24}.ISPsoq_dagNode{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:6px;flex-direction:column;justify-content:center;gap:1px;padding:0 6px;transition:border-color .12s,background-color .12s,opacity .12s;display:flex;position:absolute}.ISPsoq_dagNode:hover,.ISPsoq_dagNode[data-focused=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.ISPsoq_dagNode[data-dimmed=true]{opacity:.3}.ISPsoq_dagNode[data-state=running][data-dimmed=true]{opacity:.58}.ISPsoq_dagNode[data-state=completed]{border-color:color-mix(in srgb, var(--dsw-alias-state-success) 48%, var(--dsw-alias-line-normal))}.ISPsoq_dagNode[data-state=blocked]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 52%, var(--dsw-alias-line-normal))}.ISPsoq_dagNode[data-review=pending]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.ISPsoq_dagNode[data-helping=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 70%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-business-primary) 38%, transparent)}.ISPsoq_dagNode[data-timing=warn]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.ISPsoq_dagNode[data-timing=over]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-danger) 46%, transparent)}.ISPsoq_dagNode[data-state=failed]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 56%, var(--dsw-alias-line-normal))}.ISPsoq_dagNodeHead{color:var(--dsw-alias-label-primary);align-items:center;gap:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:700;display:flex}.ISPsoq_dagNodeDot{background:var(--dsw-alias-line-strong);border-radius:2px;flex:none;width:5px;height:5px}.ISPsoq_dagNode[data-state=running] .ISPsoq_dagNodeDot{background:var(--dsw-alias-state-business-primary)}.ISPsoq_dagNode[data-state=running] .ISPsoq_dagNodeHead{padding-right:12px}.ISPsoq_dagRunningState{width:9px;height:9px;color:var(--dsw-alias-state-business-primary);pointer-events:none;justify-content:center;align-items:center;display:inline-flex;position:absolute;top:4px;right:5px}.ISPsoq_dagRunningState .ISPsoq_workGlyph{width:9px;height:9px}.ISPsoq_dagNode[data-state=blocked] .ISPsoq_dagNodeDot{background:var(--dsw-alias-state-warning)}.ISPsoq_dagNode[data-state=completed] .ISPsoq_dagNodeDot{background:var(--dsw-alias-state-success)}.ISPsoq_dagNode[data-state=failed] .ISPsoq_dagNodeDot{background:var(--dsw-alias-state-danger)}.ISPsoq_dagNodeLabel{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:11px;overflow:hidden}.ISPsoq_taskDetail{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:8px;flex-direction:column;gap:3px;min-width:0;padding:7px 9px;display:flex}.ISPsoq_taskDetailHead{align-items:center;gap:6px;min-width:0;display:flex}.ISPsoq_taskDetailId{color:var(--dsw-alias-state-business-primary);flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;font-weight:700}.ISPsoq_taskDetailSubject{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.ISPsoq_taskDetailBadge{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:8.5px;font-weight:600;line-height:14px}.ISPsoq_taskDetailBadge[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.ISPsoq_taskDetailBadge[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.ISPsoq_taskDetailBadge[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.ISPsoq_taskDetailBadge[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.ISPsoq_taskDetailLine,.ISPsoq_taskDetailMeta{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.ISPsoq_taskDetailMeta{color:var(--dsw-alias-label-tertiary)}.ISPsoq_archiveAction{color:var(--dsw-alias-state-danger);background:color-mix(in srgb, var(--dsw-alias-state-danger) 12%, transparent);cursor:pointer;border:0;border-radius:5px;padding:3px 6px;font-size:9px}.ISPsoq_archiveAction:disabled{opacity:.55;cursor:not-allowed}.ISPsoq_diagnosticBanner{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-warning) 10%, var(--dsw-alias-bg-module));flex-wrap:wrap;align-items:flex-start;gap:6px 8px;padding:7px 10px;font-size:11px;line-height:16px;display:flex}.ISPsoq_diagnosticBanner button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-fill-neutral);cursor:pointer;border:0;border-radius:4px;padding:2px 6px}.ISPsoq_archiveConfirm{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-danger) 10%, var(--dsw-alias-background-base));justify-content:space-between;gap:8px;padding:7px 10px;font-size:10px;display:flex}.ISPsoq_archiveConfirmActions{gap:5px;display:flex}.ISPsoq_archiveConfirmActions button{cursor:pointer;border:0;border-radius:4px;padding:3px 6px}.ISPsoq_connectionStatus{color:var(--dsw-alias-label-tertiary);margin-left:5px;font-size:9px;font-weight:400}.ISPsoq_connectionStatus[data-connection=stale],.ISPsoq_connectionStatus[data-connection=offline],.ISPsoq_connectionStatus[data-connection=auth-failed]{color:var(--dsw-alias-state-warning)}.ISPsoq_taskDetailActions{gap:6px;margin-top:3px;display:flex}.ISPsoq_taskDetailActions button{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;padding:1px 4px;font-size:9px}.ISPsoq_taskDetailTiming{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.ISPsoq_taskDetailTiming[data-timing=warn]{color:var(--dsw-alias-state-warning)}.ISPsoq_taskDetailTiming[data-timing=over]{color:var(--dsw-alias-state-danger);font-weight:600}.ISPsoq_taskDetailBudgetFact{color:var(--dsw-alias-label-secondary);font-size:11px;line-height:16px}.ISPsoq_taskDetailBudgetFact[data-budget-fact=over_budget]{color:var(--dsw-alias-state-warning);font-weight:700}.ISPsoq_taskDetailBudgetFact[data-budget-fact=within_budget]{color:var(--dsw-alias-state-success)}.ISPsoq_taskDetailSignals,.ISPsoq_taskDetailRetro{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:13px;overflow:hidden}.ISPsoq_taskDetail[data-expanded] .ISPsoq_taskDetailSignals,.ISPsoq_taskDetail[data-expanded] .ISPsoq_taskDetailRetro{overflow-wrap:anywhere;text-overflow:clip;white-space:normal;font-size:12px;line-height:18px;overflow:visible}.ISPsoq_taskDetail[data-expanded] .ISPsoq_taskDetailActions{margin-top:7px}.ISPsoq_taskDetailActions button{min-height:32px}.ISPsoq_taskDetailActions button:focus-visible,.ISPsoq_archiveAction:focus-visible,.ISPsoq_archiveConfirmActions button:focus-visible{outline:2px solid var(--dsw-alias-state-primary);outline-offset:2px}.ISPsoq_taskDetailRetro[data-cause=underestimated],.ISPsoq_taskDetailRetro[data-cause=dependency-blocked]{color:var(--dsw-alias-state-danger)}.ISPsoq_taskDetailRetro[data-cause=on_time]{color:var(--dsw-alias-state-success)}.ISPsoq_taskDetailReview{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:600;line-height:14px}.ISPsoq_taskDetailReview[data-verdict=pass]{color:var(--dsw-alias-state-success)}.ISPsoq_taskDetailReview[data-verdict=reject]{color:var(--dsw-alias-state-danger)}.ISPsoq_taskDetailCalibration{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.ISPsoq_taskDetailBlocked{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:700;line-height:14px}.ISPsoq_taskDetailInput{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.ISPsoq_emptyHint{color:var(--dsw-alias-label-tertiary);padding:10px 14px;font-size:11px;line-height:16px}.ISPsoq_modeHint{color:var(--dsw-alias-label-secondary);padding:0 14px 6px;font-size:11px;line-height:16px;display:block}.ISPsoq_modeBadge{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 7px;font-size:11px;font-weight:600;line-height:16px}.ISPsoq_modeBadge[data-mode=light]{color:var(--dsw-alias-label-secondary)}.ISPsoq_modeBadge[data-mode=standard]{color:var(--dsw-alias-state-business-primary)}.ISPsoq_modeBadge[data-mode=governed]{color:var(--dsw-alias-state-warning)}.ISPsoq_historicPill{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;margin-left:auto;padding:1px 7px;font-size:9px;font-weight:600;line-height:15px}.ISPsoq_members{flex-direction:column;gap:3px;display:flex}.ISPsoq_archiveLabel{color:var(--dsw-alias-label-tertiary);padding:5px 14px 0;font-size:9px;font-weight:600;line-height:14px;display:block}.ISPsoq_archiveFilterBar{flex-wrap:wrap;align-items:center;gap:6px 8px;padding:6px 14px 2px;display:flex}.ISPsoq_archiveFilterField{color:var(--dsw-alias-label-tertiary);align-items:center;gap:4px;font-size:9px;line-height:14px;display:inline-flex}.ISPsoq_archiveFilterCaption{white-space:nowrap;font-weight:600}.ISPsoq_archiveSelect{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:120px;color:var(--dsw-alias-label-primary);border-radius:4px;padding:1px 2px;font-size:9px;line-height:14px}.ISPsoq_archiveFilterCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;margin-left:auto;font-size:9px}.ISPsoq_archiveEmpty{color:var(--dsw-alias-label-tertiary);padding:4px 14px 2px;font-size:9px;display:block}@media (prefers-reduced-motion:reduce){.ISPsoq_panel,.ISPsoq_badge,.ISPsoq_badgeDot,.ISPsoq_panelDot,.ISPsoq_workGlyph rect,.ISPsoq_stateArt,.ISPsoq_memberAvatar[data-unread=true]:after{transition:none;animation:none}}@media (width<=960px){html[data-agent-team-web-panel-open] div[data-phase]{padding-right:0}.ISPsoq_team{padding:12px 12px 14px}.ISPsoq_delegationTree{margin-left:12px;padding-left:15px}.ISPsoq_memberBranch{width:15px}}@media (width<=640px){.ISPsoq_badge{top:56px;right:10px}.ISPsoq_teamStats span[data-stat=messages]{display:none}.ISPsoq_captainNode{grid-template-columns:48px minmax(0,1fr)}.ISPsoq_captainState{display:none}.ISPsoq_assignmentLine{padding-left:60px}}.ISPsoq_healthChip{box-sizing:border-box;background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;flex:none;align-items:center;gap:5px;padding:1px 8px;font-size:11px;line-height:16px;display:inline-flex}.ISPsoq_healthChip strong{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:11px;font-weight:700}.ISPsoq_healthChip em{color:var(--dsw-alias-label-secondary);font-style:normal}.ISPsoq_healthChip[data-level=ok] strong{color:var(--dsw-alias-state-success)}.ISPsoq_healthChip[data-level=warn] strong{color:var(--dsw-alias-state-warning)}.ISPsoq_healthChip[data-level=critical] strong,.ISPsoq_riskStat{color:var(--dsw-alias-state-danger)}.ISPsoq_prioritySection{flex-direction:column;gap:5px;min-width:0;display:flex}.ISPsoq_priorityCard{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);border-radius:8px;align-items:flex-start;gap:8px;padding:6px 8px;display:flex}.ISPsoq_priorityCard[data-severity=high]{border-color:color-mix(in srgb,var(--dsw-alias-state-danger) 45%,var(--dsw-alias-line-normal))}.ISPsoq_priorityCard[data-severity=medium]{border-color:color-mix(in srgb,var(--dsw-alias-state-warning) 40%,var(--dsw-alias-line-normal))}.ISPsoq_priorityBadge{background:var(--dsw-alias-bg-fill-business);min-width:22px;height:18px;color:var(--dsw-alias-label-on-fill);border-radius:6px;flex:none;justify-content:center;align-items:center;font-size:11px;font-weight:700;display:inline-flex}.ISPsoq_priorityBody{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.ISPsoq_priorityTitle{flex-wrap:wrap;align-items:center;gap:5px;min-width:0;display:flex}.ISPsoq_priorityTitle strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.ISPsoq_chip{background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;padding:0 6px;font-size:11px;font-style:normal;font-weight:600;line-height:16px;display:inline-flex}.ISPsoq_chip[data-readiness=blocked],.ISPsoq_chip[data-readiness=orphaned],.ISPsoq_chip[data-readiness=stalled],.ISPsoq_chip[data-readiness=failed],.ISPsoq_chip[data-severity=high]{border-color:var(--dsw-alias-state-danger);color:var(--dsw-alias-state-danger)}.ISPsoq_chip[data-severity=medium],.ISPsoq_chip[data-readiness=ready]{border-color:var(--dsw-alias-state-warning);color:var(--dsw-alias-state-warning)}.ISPsoq_chip[data-severity=low],.ISPsoq_chip[data-readiness=cancelled]{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary)}.ISPsoq_priorityReasons{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.ISPsoq_milestoneRow{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;line-height:16px;display:flex}.ISPsoq_milestoneRow strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-weight:600;overflow:hidden}.ISPsoq_loadBar{background:var(--dsw-alias-line-strong);border-radius:999px;flex:none;align-items:stretch;width:44px;min-width:0;height:6px;display:inline-flex;overflow:hidden}.ISPsoq_loadBar>span{display:block}.ISPsoq_loadActive{background:var(--dsw-alias-state-business-primary)}.ISPsoq_loadPending{background:var(--dsw-alias-state-warning)}.ISPsoq_loadStalled,.ISPsoq_loadOrphaned{background:var(--dsw-alias-state-danger)}";
		...
		var ActivityPanel_module_css_default = {
			"agentTeamsBreathe": "ISPsoq_agentTeamsBreathe",
			"agentTeamsDot": "ISPsoq_agentTeamsDot",
			"agentTeamsFloat": "ISPsoq_agentTeamsFloat",
			"agentTeamsPanelIn": "ISPsoq_agentTeamsPanelIn",
			"agentTeamsPulse": "ISPsoq_agentTeamsPulse",
			"agentTeamsThink": "ISPsoq_agentTeamsThink",
			"agentTeamsUnreadPulse": "ISPsoq_agentTeamsUnreadPulse",
			"archiveAction": "ISPsoq_archiveAction",
			"archiveConfirm": "ISPsoq_archiveConfirm",
			"archiveConfirmActions": "ISPsoq_archiveConfirmActions",
			"archiveEmpty": "ISPsoq_archiveEmpty",
			"archiveFilterBar": "ISPsoq_archiveFilterBar",
			"archiveFilterCaption": "ISPsoq_archiveFilterCaption",
			"archiveFilterCount": "ISPsoq_archiveFilterCount",
			"archiveFilterField": "ISPsoq_archiveFilterField",
			"archiveLabel": "ISPsoq_archiveLabel",
			"archiveSelect": "ISPsoq_archiveSelect",
			"assignmentChip": "ISPsoq_assignmentChip",
			"assignmentLabel": "ISPsoq_assignmentLabel",
			"assignmentLine": "ISPsoq_assignmentLine",
			"assignmentTasks": "ISPsoq_assignmentTasks",
			"badge": "ISPsoq_badge",
			"badgeCount": "ISPsoq_badgeCount",
			"badgeDot": "ISPsoq_badgeDot",
			"blockedChip": "ISPsoq_blockedChip",
			"calibrationChip": "ISPsoq_calibrationChip",
			"captainAvatar": "ISPsoq_captainAvatar",
			"captainInfo": "ISPsoq_captainInfo",
			"captainLine": "ISPsoq_captainLine",
			"captainName": "ISPsoq_captainName",
			"captainNode": "ISPsoq_captainNode",
			"captainRole": "ISPsoq_captainRole",
			"captainState": "ISPsoq_captainState",
			"captainSummary": "ISPsoq_captainSummary",
			"chevron": "ISPsoq_chevron",
			"chip": "ISPsoq_chip",
			"closeError": "ISPsoq_closeError",
			"commandLayer": "ISPsoq_commandLayer",
			"commissarNode": "ISPsoq_commissarNode",
			"commissarState": "ISPsoq_commissarState",
			"connectionStatus": "ISPsoq_connectionStatus",
			"dagCanvas": "ISPsoq_dagCanvas",
			"dagEdges": "ISPsoq_dagEdges",
			"dagNode": "ISPsoq_dagNode",
			"dagNodeDot": "ISPsoq_dagNodeDot",
			"dagNodeHead": "ISPsoq_dagNodeHead",
			"dagNodeLabel": "ISPsoq_dagNodeLabel",
			"dagRunningState": "ISPsoq_dagRunningState",
			"dagViewport": "ISPsoq_dagViewport",
			"delegationSection": "ISPsoq_delegationSection",
			"delegationTree": "ISPsoq_delegationTree",
			"dependencySection": "ISPsoq_dependencySection",
			"diagnosticBanner": "ISPsoq_diagnosticBanner",
			"emptyHint": "ISPsoq_emptyHint",
			"healthChip": "ISPsoq_healthChip",
			"helpingChip": "ISPsoq_helpingChip",
			"historicPill": "ISPsoq_historicPill",
			"historyToggle": "ISPsoq_historyToggle",
			"iconButton": "ISPsoq_iconButton",
			"inputChip": "ISPsoq_inputChip",
			"leadAvatar": "ISPsoq_leadAvatar",
			"loadActive": "ISPsoq_loadActive",
			"loadBar": "ISPsoq_loadBar",
			"loadOrphaned": "ISPsoq_loadOrphaned",
			"loadPending": "ISPsoq_loadPending",
			"loadStalled": "ISPsoq_loadStalled",
			"memberArt": "ISPsoq_memberArt",
			"memberAvatar": "ISPsoq_memberAvatar",
			"memberBlock": "ISPsoq_memberBlock",
			"memberBranch": "ISPsoq_memberBranch",
			"memberCount": "ISPsoq_memberCount",
			"memberElapsed": "ISPsoq_memberElapsed",
			"memberInfo": "ISPsoq_memberInfo",
			"memberInitial": "ISPsoq_memberInitial",
			"memberLine": "ISPsoq_memberLine",
			"memberModel": "ISPsoq_memberModel",
			"memberName": "ISPsoq_memberName",
			"memberRight": "ISPsoq_memberRight",
			"memberRole": "ISPsoq_memberRole",
			"memberRow": "ISPsoq_memberRow",
			"memberState": "ISPsoq_memberState",
			"memberStatusLine": "ISPsoq_memberStatusLine",
			"members": "ISPsoq_members",
			"membersToggle": "ISPsoq_membersToggle",
			"milestoneRow": "ISPsoq_milestoneRow",
			"modeBadge": "ISPsoq_modeBadge",
			"modeHint": "ISPsoq_modeHint",
			"panel": "ISPsoq_panel",
			"panelControls": "ISPsoq_panelControls",
			"panelDot": "ISPsoq_panelDot",
			"panelHead": "ISPsoq_panelHead",
			"panelTitle": "ISPsoq_panelTitle",
			"priorityBadge": "ISPsoq_priorityBadge",
			"priorityBody": "ISPsoq_priorityBody",
			"priorityCard": "ISPsoq_priorityCard",
			"priorityReasons": "ISPsoq_priorityReasons",
			"prioritySection": "ISPsoq_prioritySection",
			"priorityTitle": "ISPsoq_priorityTitle",
			"progressEmpty": "ISPsoq_progressEmpty",
			"progressLegend": "ISPsoq_progressLegend",
			"progressOverview": "ISPsoq_progressOverview",
			"progressSegments": "ISPsoq_progressSegments",
			"progressSummary": "ISPsoq_progressSummary",
			"progressSummaryDot": "ISPsoq_progressSummaryDot",
			"progressTitle": "ISPsoq_progressTitle",
			"resizeHandle": "ISPsoq_resizeHandle",
			"reviewChip": "ISPsoq_reviewChip",
			"riskStat": "ISPsoq_riskStat",
			"sectionHead": "ISPsoq_sectionHead",
			"sectionHint": "ISPsoq_sectionHint",
			"sectionTitle": "ISPsoq_sectionTitle",
			"sectionToggleTitle": "ISPsoq_sectionToggleTitle",
			"stageLabel": "ISPsoq_stageLabel",
			"stateArt": "ISPsoq_stateArt",
			"taskDetail": "ISPsoq_taskDetail",
			"taskDetailActions": "ISPsoq_taskDetailActions",
			"taskDetailBadge": "ISPsoq_taskDetailBadge",
			"taskDetailBlocked": "ISPsoq_taskDetailBlocked",
			"taskDetailBudgetFact": "ISPsoq_taskDetailBudgetFact",
			"taskDetailCalibration": "ISPsoq_taskDetailCalibration",
			"taskDetailHead": "ISPsoq_taskDetailHead",
			"taskDetailId": "ISPsoq_taskDetailId",
			"taskDetailInput": "ISPsoq_taskDetailInput",
			"taskDetailLine": "ISPsoq_taskDetailLine",
			"taskDetailMeta": "ISPsoq_taskDetailMeta",
			"taskDetailRetro": "ISPsoq_taskDetailRetro",
			"taskDetailReview": "ISPsoq_taskDetailReview",
			"taskDetailSignals": "ISPsoq_taskDetailSignals",
			"taskDetailSubject": "ISPsoq_taskDetailSubject",
			"taskDetailTiming": "ISPsoq_taskDetailTiming",
			"taskEmpty": "ISPsoq_taskEmpty",
			"taskId": "ISPsoq_taskId",
			"team": "ISPsoq_team",
			"teamHead": "ISPsoq_teamHead",
			"teamName": "ISPsoq_teamName",
			"teamStats": "ISPsoq_teamStats",
			"teams": "ISPsoq_teams",
			"timingChip": "ISPsoq_timingChip",
			"unreadPill": "ISPsoq_unreadPill",
			"workGlyph": "ISPsoq_workGlyph"
		};
		//#endregion
		...
		*/
		...
		const cssText = ".i7Omva_section{flex-direction:column;gap:14px;display:flex}.i7Omva_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:10px;padding:14px 16px;display:flex}.i7Omva_head{align-items:center;gap:8px;display:flex}.i7Omva_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.i7Omva_list{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.i7Omva_row{box-sizing:border-box;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;min-width:0;min-height:36px;padding:0 10px;display:flex}.i7Omva_nameWrap{flex:1;align-items:center;gap:8px;min-width:0;display:flex}.i7Omva_name{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.i7Omva_rowSub{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;line-height:16px}.i7Omva_pill{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.i7Omva_switch{box-sizing:border-box;background:var(--dsw-alias-border-l2);cursor:pointer;border:none;border-radius:999px;flex:none;width:32px;height:18px;padding:0;transition:background .12s ease-in-out;position:relative}.i7Omva_switch[data-on=true]{background:var(--dsw-alias-state-business-primary)}.i7Omva_switch:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.i7Omva_switchThumb{background:var(--dsw-alias-bg-layer-1);border-radius:50%;width:14px;height:14px;transition:transform .12s ease-in-out;position:absolute;top:2px;left:2px}.i7Omva_switch[data-on=true] .i7Omva_switchThumb{transform:translate(14px)}.i7Omva_select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;max-width:200px;color:var(--dsw-alias-label-primary);border-radius:6px;flex:1;padding:2px 4px;font-size:11px;line-height:16px}.i7Omva_select:disabled{opacity:.55}@media (prefers-color-scheme:dark){.i7Omva_select{color:#e8e8e8;background:#26282b}}.i7Omva_resetBtn{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;flex:none;margin-left:auto;padding:2px 10px;font-size:11px;line-height:16px;transition:color .12s ease-in-out,border-color .12s ease-in-out}.i7Omva_resetBtn:hover:not(:disabled){border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.i7Omva_resetBtn:disabled{opacity:.45;cursor:default}.i7Omva_presetPopover{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 56%, transparent);border-radius:10px;flex-direction:column;gap:8px;margin:2px 0 10px;padding:10px;display:flex}.i7Omva_presetTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}.i7Omva_presetHelp{color:var(--dsw-alias-label-tertiary);margin:0;font-size:11px;line-height:16px}.i7Omva_presetTabs{flex-wrap:wrap;gap:6px;display:flex}.i7Omva_presetTab{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:999px;padding:3px 8px;font-size:11px;line-height:16px}.i7Omva_presetTab[data-active=true]{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.i7Omva_presetList{flex-direction:column;gap:6px;display:flex}.i7Omva_presetItem{border:1px solid var(--dsw-alias-border-l2);color:inherit;text-align:left;cursor:pointer;background:0 0;border-radius:8px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.i7Omva_presetItem[data-active=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.i7Omva_presetItemHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.i7Omva_presetItemName{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:600;line-height:16px}.i7Omva_presetMetaRow{flex-wrap:wrap;gap:6px;display:flex}.i7Omva_presetMetaChip{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 46%, transparent);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 6px;font-size:10px;line-height:15px}.i7Omva_presetItemDesc{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.i7Omva_presetDiffBadge{color:var(--dsw-alias-label-secondary);flex:none;font-size:10px;line-height:15px}.i7Omva_presetActions{justify-content:flex-end;gap:8px;display:flex}.i7Omva_presetActionGhost,.i7Omva_presetActionPrimary{cursor:pointer;border-radius:6px;padding:3px 10px;font-size:11px;line-height:16px}.i7Omva_presetActionGhost{color:var(--dsw-alias-label-secondary);background:0 0;border:1px solid #0000}.i7Omva_presetActionPrimary{border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary);color:#fff}.i7Omva_empty{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 8px;font-size:11px;line-height:16px}.i7Omva_viewBtn{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex;position:relative}.i7Omva_viewBtn:hover{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.i7Omva_viewBtn:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.i7Omva_modalMask{z-index:100;background:#00000073;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.i7Omva_modal{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:12px;width:460px;max-width:100%;padding:16px;box-shadow:0 12px 40px #00000080}.i7Omva_modalHead{align-items:center;gap:8px;margin-bottom:12px;display:flex}.i7Omva_modalTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.i7Omva_modalClose{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;margin-left:auto;padding:2px 6px;font-size:13px;line-height:16px}.i7Omva_modalClose:hover{color:var(--dsw-alias-label-primary);background:#ffffff0f}.i7Omva_roleSlogan{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, transparent);color:var(--dsw-alias-state-business-primary);border-radius:8px;padding:8px 10px;font-size:13px;font-weight:500;line-height:20px}.i7Omva_modalSectionTitle{color:var(--dsw-alias-label-tertiary);margin:12px 0 6px;font-size:11px;line-height:16px}.i7Omva_dutyRow{gap:8px;padding:6px 10px;font-size:12px;line-height:20px;display:flex}.i7Omva_dutyRow+.i7Omva_dutyRow{border-top:1px dashed var(--dsw-alias-border-l2)}.i7Omva_dutyStep{color:var(--dsw-alias-label-secondary);flex:none;font-weight:500}.i7Omva_dutyDesc{color:var(--dsw-alias-label-primary)}.i7Omva_modalKv{align-items:center;gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.i7Omva_modalK{width:72px;color:var(--dsw-alias-label-tertiary);flex:none}.i7Omva_modalV{color:var(--dsw-alias-label-secondary);flex:1;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}.i7Omva_modalEmpty{color:var(--dsw-alias-label-tertiary);padding:6px 10px;font-size:12px;line-height:20px}.i7Omva_modalBody{max-height:min(52vh,420px);margin-right:-4px;padding-right:4px;overflow:auto}.i7Omva_ruleRow{gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.i7Omva_ruleBullet{color:var(--dsw-alias-state-business-primary);flex:none}.i7Omva_growthStat{color:var(--dsw-alias-label-primary);margin:0 0 8px;padding:0 10px;font-size:12px;line-height:20px}.i7Omva_growthList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.i7Omva_growthItem{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 40%, transparent);border-radius:8px;flex-direction:column;gap:2px;padding:8px 10px;display:flex}.i7Omva_growthPractice{color:var(--dsw-alias-label-primary);font-size:12px;line-height:20px}.i7Omva_growthMeta{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}.i7Omva_modelHelp{color:var(--dsw-alias-label-secondary);margin:0;padding:0 10px;font-size:11px;line-height:17px}.i7Omva_modelPresetReference{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;padding-top:8px;display:flex}.i7Omva_modelProvider{flex-direction:column;gap:4px;display:flex}.i7Omva_modelProviderTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:8px;margin:4px 0;font-size:12px;display:flex}.i7Omva_modelRow{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 35%, transparent);border-radius:8px;align-items:center;gap:10px;min-height:36px;padding:4px 10px;display:flex}.i7Omva_modelName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;flex:1;font:11px/16px ui-monospace,SFMono-Regular,Menlo,monospace;overflow:hidden}.i7Omva_modelEffort{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:10px;display:flex}";
		...
		var ProviderGrantsSection_module_css_default = {
			"card": "i7Omva_card",
			"dutyDesc": "i7Omva_dutyDesc",
			"dutyRow": "i7Omva_dutyRow",
			"dutyStep": "i7Omva_dutyStep",
			"empty": "i7Omva_empty",
			"growthItem": "i7Omva_growthItem",
			"growthList": "i7Omva_growthList",
			"growthMeta": "i7Omva_growthMeta",
			"growthPractice": "i7Omva_growthPractice",
			"growthStat": "i7Omva_growthStat",
			"head": "i7Omva_head",
			"list": "i7Omva_list",
			"modal": "i7Omva_modal",
			"modalBody": "i7Omva_modalBody",
			"modalClose": "i7Omva_modalClose",
			"modalEmpty": "i7Omva_modalEmpty",
			"modalHead": "i7Omva_modalHead",
			"modalK": "i7Omva_modalK",
			"modalKv": "i7Omva_modalKv",
			"modalMask": "i7Omva_modalMask",
			"modalSectionTitle": "i7Omva_modalSectionTitle",
			"modalTitle": "i7Omva_modalTitle",
			"modalV": "i7Omva_modalV",
			"modelEffort": "i7Omva_modelEffort",
			"modelHelp": "i7Omva_modelHelp",
			"modelName": "i7Omva_modelName",
			"modelPresetReference": "i7Omva_modelPresetReference",
			"modelProvider": "i7Omva_modelProvider",
			"modelProviderTitle": "i7Omva_modelProviderTitle",
			"modelRow": "i7Omva_modelRow",
			"name": "i7Omva_name",
			"nameWrap": "i7Omva_nameWrap",
			"pill": "i7Omva_pill",
			"presetActionGhost": "i7Omva_presetActionGhost",
			"presetActionPrimary": "i7Omva_presetActionPrimary",
			"presetActions": "i7Omva_presetActions",
			"presetDiffBadge": "i7Omva_presetDiffBadge",
			"presetHelp": "i7Omva_presetHelp",
			"presetItem": "i7Omva_presetItem",
			"presetItemDesc": "i7Omva_presetItemDesc",
			"presetItemHead": "i7Omva_presetItemHead",
			"presetItemName": "i7Omva_presetItemName",
			"presetList": "i7Omva_presetList",
			"presetMetaChip": "i7Omva_presetMetaChip",
			"presetMetaRow": "i7Omva_presetMetaRow",
			"presetPopover": "i7Omva_presetPopover",
			"presetTab": "i7Omva_presetTab",
			"presetTabs": "i7Omva_presetTabs",
			"presetTitle": "i7Omva_presetTitle",
			"resetBtn": "i7Omva_resetBtn",
			"roleSlogan": "i7Omva_roleSlogan",
			"row": "i7Omva_row",
			"rowSub": "i7Omva_rowSub",
			"ruleBullet": "i7Omva_ruleBullet",
			"ruleRow": "i7Omva_ruleRow",
			"section": "i7Omva_section",
			"select": "i7Omva_select",
			"switch": "i7Omva_switch",
			"switchThumb": "i7Omva_switchThumb",
			"title": "i7Omva_title",
			"viewBtn": "i7Omva_viewBtn"
		};
		//#endregion
		...
		* 判定(驱动「恢复默认」disabled 态与选中回显)。 */
		...
		function roleRouteNotice(row, t) {
			return row.model !== void 0 && row.model !== "" ? t("settings.agentTeam.legacyRoute", {
				provider: row.provider ?? t("settings.agentTeam.providerMissing"),
				model: row.model
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									locked ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: ProviderGrantsSection_module_css_default.pill,
										children: t("settings.agentTeam.locked")
									}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										role: "switch",
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
						...
						children: rows.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									className: ProviderGrantsSection_module_css_default.nameWrap,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									children: roleRouteNotice(row, t)
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
