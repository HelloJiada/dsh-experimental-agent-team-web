...
const COMPACT_DAG_NODE_WIDTH = 92;
const COMPACT_DAG_NODE_HEIGHT = 30;
const COMPACT_DAG_COLUMN_GAP = 26;
const COMPACT_DAG_ROW_GAP = 8;
...
function relatedTaskIds(taskId, tasks) {
	...
	for (const task of tasks) for (const dependency of task.dependencies) {
		const targets$1 = dependents.get(dependency) ?? [];
		targets$1.push(task.id);
		dependents.set(dependency, targets$1);
	}
...
function startActivityPolling(monitorTargets, runtime = {}) {
	...
	const schedule = runtime.schedule ?? ((callback, intervalMs$1) => setInterval(callback, intervalMs$1));
	const cancel = runtime.cancel ?? ((timer$1) => {
...
function panelMaximumHeight(layout, bounds) {
	const bottomInset = compactPanelForBounds(bounds) || layout.mode === "floating" ? PANEL_FLOAT_MARGIN : PANEL_DOCK_BOTTOM;
...
function resolvePanelGeometry(layout, bounds) {
	...
	if (layout.mode === "docked") {
		...
		const height$1 = clamp(availableHeight, Math.min(minimumHeight, availableHeight), maximumHeight);
		...
		return {
			mode: "docked",
			x: clamp(anchorRight - PANEL_DOCK_RIGHT - width, PANEL_FLOAT_MARGIN, maximumX),
			y,
			width,
			height: height$1,
...
function resizePanelLayout(start, edge, dx, dy, bounds) {
	...
	if (edge === "left") {
		...
		const maximumWidth$1 = Math.max(1, Math.min(PANEL_MAX_WIDTH, right - PANEL_FLOAT_MARGIN));
		const width$1 = clamp(resolved.width - dx, Math.min(minimumWidth, maximumWidth$1), maximumWidth$1);
		return {
			...resolved,
			x: right - width$1,
			width: width$1
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [!parallel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
					...
					style: parallel ? { height: COMPACT_DAG_NODE_HEIGHT } : {
						left: x,
						top: y,
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					...
					children: [
						!compact && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconPanelLeftOutline16, {})
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: ActivityPanel_module_css_default.iconButton,
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, {})
						}),
						liveTeam !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconCloseOutline16, {})
						})
					]
				})]
			}),
