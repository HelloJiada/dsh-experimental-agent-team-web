	...
	factory: (require) => {
		...
		*/
		...
		var ActivityPanel_module_css_default = {
			...
			"providerError": "lmmxYa_providerError",
			"providerHint": "lmmxYa_providerHint",
			"providerId": "lmmxYa_providerId",
			"providerList": "lmmxYa_providerList",
			"providerLocked": "lmmxYa_providerLocked",
			"providerName": "lmmxYa_providerName",
			"providerRow": "lmmxYa_providerRow",
			"providerSection": "lmmxYa_providerSection",
			"providerSwitch": "lmmxYa_providerSwitch",
			"providerSwitchThumb": "lmmxYa_providerSwitchThumb",
		...
		* claimed/pending/failed/cancelled keep their own labels and colors. */
		...
		function providerGrantRows(providers) {
		...
		function providerToggleRequest(provider) {
			return {
				method: "POST",
		...
		* (POST /plugins/agent-team-web/provider-grant, R-17 token 保护)。 */
		function ProviderGrantPanel({ providers, t, compact = false }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				className: ActivityPanel_module_css_default.providerSection,
				"aria-label": t("provider.aria"),
				"data-provider-grant": true,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							className: ActivityPanel_module_css_default.providerError,
							children: error
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: ActivityPanel_module_css_default.providerList,
						children: rows.map((provider) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							className: ActivityPanel_module_css_default.providerRow,
							"data-enabled": provider.enabled,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: ActivityPanel_module_css_default.providerName,
									title: provider.id,
									children: provider.name
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: ActivityPanel_module_css_default.providerId,
									children: provider.id
								}),
								provider.locked ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: ActivityPanel_module_css_default.providerLocked,
									children: t("provider.locked")
								}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									role: "switch",
									"aria-checked": provider.enabled,
									className: ActivityPanel_module_css_default.providerSwitch,
									"data-on": provider.enabled,
									disabled: busy === provider.id,
									onClick: () => {
										toggle(provider);
									},
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: ActivityPanel_module_css_default.providerSwitchThumb })
								})
							]
						}, provider.id))
					}),
					!compact && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: ActivityPanel_module_css_default.providerHint,
		...
		function TeamSection({ team, onNavigate, t, historic = false, compact = false }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderGrantPanel, {
