	...
	factory: (require) => {
		...
		*/
		...
		var ActivityPanel_module_css_default = {
			...
			"archiveAction": "lmmxYa_archiveAction",
			"archiveConfirm": "lmmxYa_archiveConfirm",
			"archiveConfirmActions": "lmmxYa_archiveConfirmActions",
			...
			"connectionStatus": "lmmxYa_connectionStatus",
			...
			"modeBadge": "lmmxYa_modeBadge",
			"modeHint": "lmmxYa_modeHint",
			"panel": "lmmxYa_panel",
			...
			"taskDetailActions": "lmmxYa_taskDetailActions",
			"taskDetailBadge": "lmmxYa_taskDetailBadge",
			"taskDetailBlocked": "lmmxYa_taskDetailBlocked",
			"taskDetailBudgetFact": "lmmxYa_taskDetailBudgetFact",
		...
		*/
		...
		const cssText = ".xoTlpq_section{flex-direction:column;gap:14px;display:flex}.xoTlpq_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:10px;padding:14px 16px;display:flex}.xoTlpq_head{align-items:center;gap:8px;display:flex}.xoTlpq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.xoTlpq_list{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.xoTlpq_row{box-sizing:border-box;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;min-width:0;min-height:36px;padding:0 10px;display:flex}.xoTlpq_nameWrap{flex:1;align-items:center;gap:8px;min-width:0;display:flex}.xoTlpq_name{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.xoTlpq_rowSub{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;line-height:16px}.xoTlpq_pill{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.xoTlpq_switch{box-sizing:border-box;background:var(--dsw-alias-border-l2);cursor:pointer;border:none;border-radius:999px;flex:none;width:32px;height:18px;padding:0;transition:background .12s ease-in-out;position:relative}.xoTlpq_switch[data-on=true]{background:var(--dsw-alias-state-business-primary)}.xoTlpq_switch:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.xoTlpq_switchThumb{background:var(--dsw-alias-bg-layer-1);border-radius:50%;width:14px;height:14px;transition:transform .12s ease-in-out;position:absolute;top:2px;left:2px}.xoTlpq_switch[data-on=true] .xoTlpq_switchThumb{transform:translate(14px)}.xoTlpq_select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;max-width:200px;color:var(--dsw-alias-label-primary);border-radius:6px;flex:1;padding:2px 4px;font-size:11px;line-height:16px}.xoTlpq_select:disabled{opacity:.55}@media (prefers-color-scheme:dark){.xoTlpq_select{color:#e8e8e8;background:#26282b}}.xoTlpq_resetBtn{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;flex:none;margin-left:auto;padding:2px 10px;font-size:11px;line-height:16px;transition:color .12s ease-in-out,border-color .12s ease-in-out}.xoTlpq_resetBtn:hover:not(:disabled){border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.xoTlpq_resetBtn:disabled{opacity:.45;cursor:default}.xoTlpq_presetPopover{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 56%, transparent);border-radius:10px;flex-direction:column;gap:8px;margin:2px 0 10px;padding:10px;display:flex}.xoTlpq_presetTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}.xoTlpq_presetHelp{color:var(--dsw-alias-label-tertiary);margin:0;font-size:11px;line-height:16px}.xoTlpq_presetTabs{flex-wrap:wrap;gap:6px;display:flex}.xoTlpq_presetTab{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:999px;padding:3px 8px;font-size:11px;line-height:16px}.xoTlpq_presetTab[data-active=true]{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.xoTlpq_presetList{flex-direction:column;gap:6px;display:flex}.xoTlpq_presetItem{border:1px solid var(--dsw-alias-border-l2);color:inherit;text-align:left;cursor:pointer;background:0 0;border-radius:8px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.xoTlpq_presetItem[data-active=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.xoTlpq_presetItemHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.xoTlpq_presetItemName{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:600;line-height:16px}.xoTlpq_presetMetaRow{flex-wrap:wrap;gap:6px;display:flex}.xoTlpq_presetMetaChip{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 46%, transparent);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 6px;font-size:10px;line-height:15px}.xoTlpq_presetItemDesc{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.xoTlpq_presetDiffBadge{color:var(--dsw-alias-label-secondary);flex:none;font-size:10px;line-height:15px}.xoTlpq_presetActions{justify-content:flex-end;gap:8px;display:flex}.xoTlpq_presetActionGhost,.xoTlpq_presetActionPrimary{cursor:pointer;border-radius:6px;padding:3px 10px;font-size:11px;line-height:16px}.xoTlpq_presetActionGhost{color:var(--dsw-alias-label-secondary);background:0 0;border:1px solid #0000}.xoTlpq_presetActionPrimary{border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary);color:#fff}.xoTlpq_empty{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 8px;font-size:11px;line-height:16px}.xoTlpq_viewBtn{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex;position:relative}.xoTlpq_viewBtn:hover{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.xoTlpq_viewBtn:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.xoTlpq_modalMask{z-index:100;background:#00000073;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.xoTlpq_modal{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:12px;width:460px;max-width:100%;padding:16px;box-shadow:0 12px 40px #00000080}.xoTlpq_modalHead{align-items:center;gap:8px;margin-bottom:12px;display:flex}.xoTlpq_modalTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.xoTlpq_modalClose{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;margin-left:auto;padding:2px 6px;font-size:13px;line-height:16px}.xoTlpq_modalClose:hover{color:var(--dsw-alias-label-primary);background:#ffffff0f}.xoTlpq_roleSlogan{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, transparent);color:var(--dsw-alias-state-business-primary);border-radius:8px;padding:8px 10px;font-size:13px;font-weight:500;line-height:20px}.xoTlpq_modalSectionTitle{color:var(--dsw-alias-label-tertiary);margin:12px 0 6px;font-size:11px;line-height:16px}.xoTlpq_dutyRow{gap:8px;padding:6px 10px;font-size:12px;line-height:20px;display:flex}.xoTlpq_dutyRow+.xoTlpq_dutyRow{border-top:1px dashed var(--dsw-alias-border-l2)}.xoTlpq_dutyStep{color:var(--dsw-alias-label-secondary);flex:none;font-weight:500}.xoTlpq_dutyDesc{color:var(--dsw-alias-label-primary)}.xoTlpq_modalKv{align-items:center;gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.xoTlpq_modalK{width:72px;color:var(--dsw-alias-label-tertiary);flex:none}.xoTlpq_modalV{color:var(--dsw-alias-label-secondary);flex:1;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}.xoTlpq_modalEmpty{color:var(--dsw-alias-label-tertiary);padding:6px 10px;font-size:12px;line-height:20px}.xoTlpq_modalBody{max-height:min(52vh,420px);margin-right:-4px;padding-right:4px;overflow:auto}.xoTlpq_ruleRow{gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.xoTlpq_ruleBullet{color:var(--dsw-alias-state-business-primary);flex:none}.xoTlpq_growthStat{color:var(--dsw-alias-label-primary);margin:0 0 8px;padding:0 10px;font-size:12px;line-height:20px}.xoTlpq_growthList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.xoTlpq_growthItem{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 40%, transparent);border-radius:8px;flex-direction:column;gap:2px;padding:8px 10px;display:flex}.xoTlpq_growthPractice{color:var(--dsw-alias-label-primary);font-size:12px;line-height:20px}.xoTlpq_growthMeta{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}";
		...
		var ProviderGrantsSection_module_css_default = {
			"card": "xoTlpq_card",
			"dutyDesc": "xoTlpq_dutyDesc",
			"dutyRow": "xoTlpq_dutyRow",
			"dutyStep": "xoTlpq_dutyStep",
			"empty": "xoTlpq_empty",
			"growthItem": "xoTlpq_growthItem",
			"growthList": "xoTlpq_growthList",
			"growthMeta": "xoTlpq_growthMeta",
			"growthPractice": "xoTlpq_growthPractice",
			"growthStat": "xoTlpq_growthStat",
			"head": "xoTlpq_head",
			"list": "xoTlpq_list",
			"modal": "xoTlpq_modal",
			"modalBody": "xoTlpq_modalBody",
			"modalClose": "xoTlpq_modalClose",
			"modalEmpty": "xoTlpq_modalEmpty",
			"modalHead": "xoTlpq_modalHead",
			"modalK": "xoTlpq_modalK",
			"modalKv": "xoTlpq_modalKv",
			"modalMask": "xoTlpq_modalMask",
			"modalSectionTitle": "xoTlpq_modalSectionTitle",
			"modalTitle": "xoTlpq_modalTitle",
			"modalV": "xoTlpq_modalV",
			"name": "xoTlpq_name",
			"nameWrap": "xoTlpq_nameWrap",
			"pill": "xoTlpq_pill",
			"presetActionGhost": "xoTlpq_presetActionGhost",
			"presetActionPrimary": "xoTlpq_presetActionPrimary",
			"presetActions": "xoTlpq_presetActions",
			"presetDiffBadge": "xoTlpq_presetDiffBadge",
			"presetHelp": "xoTlpq_presetHelp",
			"presetItem": "xoTlpq_presetItem",
			"presetItemDesc": "xoTlpq_presetItemDesc",
			"presetItemHead": "xoTlpq_presetItemHead",
			"presetItemName": "xoTlpq_presetItemName",
			"presetList": "xoTlpq_presetList",
			"presetMetaChip": "xoTlpq_presetMetaChip",
			"presetMetaRow": "xoTlpq_presetMetaRow",
			"presetPopover": "xoTlpq_presetPopover",
			"presetTab": "xoTlpq_presetTab",
			"presetTabs": "xoTlpq_presetTabs",
			"presetTitle": "xoTlpq_presetTitle",
			"resetBtn": "xoTlpq_resetBtn",
			"roleSlogan": "xoTlpq_roleSlogan",
			"row": "xoTlpq_row",
			"rowSub": "xoTlpq_rowSub",
			"ruleBullet": "xoTlpq_ruleBullet",
			"ruleRow": "xoTlpq_ruleRow",
			"section": "xoTlpq_section",
			"select": "xoTlpq_select",
			"switch": "xoTlpq_switch",
			"switchThumb": "xoTlpq_switchThumb",
			"title": "xoTlpq_title",
			"viewBtn": "xoTlpq_viewBtn"
		};
		//#endregion
