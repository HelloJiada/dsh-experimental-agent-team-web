window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region src/client/AgentTeamActivityPanel.module.css
		var AgentTeamActivityPanel_module_default = {
			"badge": "KZ92iW_badge",
		...
		function AgentTeamActivityPanel({ useSessions, openMember }) {
			...
			if (!expanded) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				ref: rootRef,
				className: AgentTeamActivityPanel_module_default.root,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					type: "button",
					className: AgentTeamActivityPanel_module_default.badge,
					"aria-label": "Open team activity",
					onClick: () => setExpanded(true),
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: AgentTeamActivityPanel_module_default.statusDot,
							"aria-hidden": "true"
						}),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					...
					className: AgentTeamActivityPanel_module_default.panel,
					style: panelStyle,
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
							className: AgentTeamActivityPanel_module_default.header,
							children: [
								!compact && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: AgentTeamActivityPanel_module_default.dragHandle,
								...
								compact && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: AgentTeamActivityPanel_module_default.title,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: AgentTeamActivityPanel_module_default.statusDot,
										"aria-hidden": "true"
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: AgentTeamActivityPanel_module_default.headerActions,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: AgentTeamActivityPanel_module_default.content,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
									className: AgentTeamActivityPanel_module_default.overview,
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: AgentTeamActivityPanel_module_default.metrics,
											children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
									className: AgentTeamActivityPanel_module_default.section,
									...
									children: [
										...
										view.priorities.map((priority) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
											className: AgentTeamActivityPanel_module_default.row,
										...
										view.fallback !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
											className: AgentTeamActivityPanel_module_default.fallback,
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
										...
										type: "button",
										className: AgentTeamActivityPanel_module_default.memberRow,
						...
						!compact && layout.mode === "floating" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: `${AgentTeamActivityPanel_module_default.resizeHandle} ${AgentTeamActivityPanel_module_default.resizeLeft}`,
								"data-testid": "panel-resize-handle",
								onPointerDown: (event) => beginPointer(event, "resize", "left"),
								onLostPointerCapture: clearPointerOperation
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: `${AgentTeamActivityPanel_module_default.resizeHandle} ${AgentTeamActivityPanel_module_default.resizeBottom}`,
								onPointerDown: (event) => beginPointer(event, "resize", "bottom"),
								onLostPointerCapture: clearPointerOperation
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: `${AgentTeamActivityPanel_module_default.resizeHandle} ${AgentTeamActivityPanel_module_default.resizeCorner}`,
