	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"settings.agentTeam.providerAria": "Provider",
		...
		* 模型粒度(enabledModels 复合 key)不变。 */
		...
		function rolePresetRows(views, providers) {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "",
									children: t("settings.agentTeam.inherit")
								}), row.modelOptions.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: model,
									children: model
								}, model))]
							}),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: ProviderGrantsSection_module_css_default.defaultBtn,
								disabled: !row.overridden,
								onClick: () => {
									write(row.role, void 0);
								},
								children: t("settings.agentTeam.default")
							})
						]
					}, row.role))
				})]
