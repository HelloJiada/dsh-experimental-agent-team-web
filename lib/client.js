		...
		const ROLE_DUTY = {
			researcher: {
				...
				steps: [
					{
						title: "先读再想",
						desc: "下结论前先读相关代码、文档和团队状态，每个判断都有出处（引用文件路径和关键行）。"
					},
					{
						title: "根因 + 计划",
						desc: "交付问题的根因，然后是具体计划：文件路径、关键实现点、预期效果。如果是提问，就用证据回答。"
					},
					{
						title: "自查后交棒",
						desc: "对照证据复查计划是否成立，标注假设与风险，然后交给队长或技术员。"
					}
				],
			...
			engineer: {
				...
				steps: [
					{
						title: "按计划行事",
						desc: "先读任务描述（及侦察参谋的计划）；计划缺失或不清晰时先问，不猜。"
					},
					{
						title: "实现",
						desc: "用可用工具完成改动，diff 聚焦在任务范围内。"
					},
					{
						title: "自测",
						desc: "验证改动：typecheck / 测试 / 直接探针；报告前修复自己引入的问题。"
					},
					{
						title: "交付摘要",
						desc: "报告精简摘要：改动文件 + 关键决策；偏离计划处明确标注。"
					}
				],
			...
			qa: {
				...
				steps: [
					{
						title: "清单先行",
						desc: "验收前先从需求推导出具体核验清单。"
					},
					{
						title: "逐项核验",
						desc: "对照清单检查实际产物：跑命令、读输出、查文件片段。"
					},
					{
						title: "带证据结论",
						desc: "逐项给出 pass/拒收 + 证据（命令、输出、摘录）；拒收时列出具体失败项。"
					}
				],
			...
			designer: {
				...
				steps: [{
					title: "具体视觉方案",
					desc: "产出带具体值的视觉/UX 方案：颜色（hex）、间距、字号、排版、文案——没有含糊的\"更好看\"。"
				}, {
					title: "交棒",
					desc: "把方案交给技术员实施；评审视觉产物时对照具体规格给可执行意见。"
				}],
			...
			data: {
				...
				steps: [
					...
					{
						title: "可审计报告",
						desc: "产出可复查报告：指标定义、方法、原始数字、结论——他人可复现。"
					}
				],
			...
			docs: {
				...
				steps: [
					{
						title: "结构先行",
						desc: "动笔前定义文档结构（章节、标题、各节内容），受众/目的不清时先确认。"
					},
					{
						title: "按规格写",
						desc: "按既定结构与规格写作，内容清晰准确。"
					},
					{
						title: "同步核对",
						desc: "成文后对照实际产物核对，确保文档与事实一致。"
					}
				],
			...
			security: {
				...
				steps: [
					...
					{
						title: "探测暴露面",
						desc: "用攻击场景探测暴露面，评估影响。"
					},
					{
						title: "分级结论",
						desc: "给出分级（含利用场景证据）；并验证正向面不受影响。"
					}
				],
			...
			reviewer: {
				...
				steps: [{
					title: "专项复核",
					desc: "在需要独立审查时加入，按任务专项核验关键产出。"
				}, {
					title: "独立结论",
					desc: "给出独立、有依据的审查结论，不受执行者立场影响。"
				}],
			...
			commissar: {
				...
				steps: [
					{
						title: "监督目标",
						desc: "跟踪团队目标对齐与执行方向，发现偏离及时提示。"
					},
					{
						title: "审查风险",
						desc: "审查高风险/关键节点任务，评估风险并给出监督意见。"
					},
					{
						title: "把关质量",
						desc: "对门禁任务行使 pass/reject 复核，拒绝时附证据。"
					},
					{
						title: "上报分歧",
						desc: "重大分歧或风险主动上报队长。"
