window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const cssText$2 = "._6d4xKW_root{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:8px;width:100%;min-width:0;padding:10px 12px;display:flex}._6d4xKW_head{align-items:center;gap:8px;min-width:0;display:flex}._6d4xKW_leadAvatar{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0;flex:none;width:30px;height:30px}._6d4xKW_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}._6d4xKW_memberCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;margin-left:auto;font-size:11px;line-height:16px}._6d4xKW_panelButton{border:1px solid var(--dsw-alias-line-strong);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;flex:none;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:16px;transition:border-color .12s,color .12s}._6d4xKW_panelButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}._6d4xKW_panelButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._6d4xKW_members{flex-wrap:wrap;gap:6px;min-width:0;display:flex}._6d4xKW_member{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:160px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:5px;padding:3px 8px 3px 3px;font-size:11px;font-weight:500;line-height:16px;transition:border-color .12s,background-color .12s;display:inline-flex}._6d4xKW_member:hover{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-fill-neutral)}._6d4xKW_member:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._6d4xKW_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d482e);background:0 0;border:0;border-radius:0;width:24px;height:24px}._6d4xKW_memberInitial{background:var(--dsw-alias-bg-fill-business);width:20px;height:20px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:10px;font-weight:600;line-height:20px;display:inline-flex}._6d4xKW_memberName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}";
		...
		var AgentTeamsCard_module_css_default = {
			"head": "_6d4xKW_head",
			"leadAvatar": "_6d4xKW_leadAvatar",
			"member": "_6d4xKW_member",
			"memberArt": "_6d4xKW_memberArt",
			"memberCount": "_6d4xKW_memberCount",
			"memberInitial": "_6d4xKW_memberInitial",
			"memberName": "_6d4xKW_memberName",
			"members": "_6d4xKW_members",
			"panelButton": "_6d4xKW_panelButton",
			"root": "_6d4xKW_root",
			"teamName": "_6d4xKW_teamName"
		};
		//#endregion
		...
		*/
		...
		const cssText$1 = "html{--agent-team-web-panel-shift:420px}html[data-agent-team-web-panel-open] div[data-phase]{box-sizing:border-box;padding-right:var(--agent-team-web-panel-shift)}.LIc2bG_badge,.LIc2bG_panel{--at-bg-panel:#fff;--at-bg-raised:#fafbfc;--at-bg-fill:#f4f6f9;--at-border:#e8ebf0;--at-border-strong:#d9dee8;--at-text-primary:#1b1f27;--at-text-secondary:#5a6474;--at-text-tertiary:#8f97a6;--at-accent:#2d5ca8;--at-accent-hover:#3568b8;--at-accent-strong:#244a8a;--at-success:#15875a;--at-warning:#a4681a;--at-danger:#c23b42;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #17203014;--at-shadow-panel:0 12px 32px #17203012, 0 32px 72px #1720301c;--at-shadow-active:0 16px 40px #1720301a, 0 36px 80px #17203024;--dsw-alias-bg-module:var(--at-bg-panel);--dsw-alias-bg-module-platform:var(--at-bg-raised);--dsw-alias-bg-fill-neutral:var(--at-bg-fill);--dsw-alias-bg-fill-business:var(--at-accent);--dsw-alias-bg-fill-success:var(--at-success);--dsw-alias-bg-fill-warning:var(--at-warning);--dsw-alias-bg-fill-danger:var(--at-danger);--dsw-alias-state-business-primary:var(--at-accent);--dsw-alias-state-success:var(--at-success);--dsw-alias-state-warning:var(--at-warning);--dsw-alias-state-danger:var(--at-danger);--dsw-alias-label-primary:var(--at-text-primary);--dsw-alias-label-secondary:var(--at-text-secondary);--dsw-alias-label-tertiary:var(--at-text-tertiary);--dsw-alias-label-on-fill:var(--at-on-accent);--dsw-alias-line-normal:var(--at-border);--dsw-alias-line-strong:var(--at-border-strong)}@media (prefers-color-scheme:dark){.LIc2bG_badge,.LIc2bG_panel{--at-bg-panel:#1e1f22;--at-bg-raised:#202125;--at-bg-fill:#2a2c30;--at-border:#2e3136;--at-border-strong:#3a3e45;--at-text-primary:#f5f6f8;--at-text-secondary:#b9bdc6;--at-text-tertiary:#8b90a0;--at-accent:#5b8dd9;--at-accent-hover:#6d9be0;--at-accent-strong:#4a7cc9;--at-success:#3ecf7f;--at-warning:#f0a83c;--at-danger:#f0606a;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #00000073;--at-shadow-panel:0 12px 32px #00000073, 0 32px 72px #0000008c;--at-shadow-active:0 16px 40px #00000080, 0 36px 80px #0009}.LIc2bG_stateArt{filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #00000073)}}.LIc2bG_badge{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:color-mix(in srgb, var(--dsw-alias-bg-module-platform) 92%, transparent);backdrop-filter:blur(16px);height:34px;box-shadow:var(--at-shadow-badge);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:7px;padding:0 12px;font-size:12px;font-weight:600;line-height:20px;transition:border-color .12s,transform .12s;display:inline-flex;position:absolute;top:64px;right:18px}.LIc2bG_badge:hover{border-color:var(--dsw-alias-line-strong);transform:translateY(-1px)}.LIc2bG_badge:active{transform:translateY(0)scale(.97)}.LIc2bG_badge:focus-visible,.LIc2bG_iconButton:focus-visible,.LIc2bG_memberRow:focus-visible,.LIc2bG_membersToggle:focus-visible,.LIc2bG_sectionToggleTitle:focus-visible,.LIc2bG_historyToggle:focus-visible,.LIc2bG_dagNode:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.LIc2bG_badgeDot,.LIc2bG_panelDot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:7px;height:7px}.LIc2bG_badgeDot[data-busy=true],.LIc2bG_panelDot[data-busy=true]{background:var(--dsw-alias-state-business-primary);animation:1.25s ease-in-out infinite LIc2bG_agentTeamsPulse}.LIc2bG_badgeCount,.LIc2bG_memberCount,.LIc2bG_teamStats,.LIc2bG_stageLabel,.LIc2bG_taskId{font-variant-numeric:tabular-nums}.LIc2bG_panel{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-line-strong) 58%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-module) 95%, transparent);backdrop-filter:blur(20px)saturate(1.08);box-shadow:var(--at-shadow-panel);will-change:transform;border-radius:16px;flex-direction:column;animation:.16s ease-out LIc2bG_agentTeamsPanelIn;display:flex;position:absolute;top:0;left:0;overflow:hidden}.LIc2bG_panel[data-dragging],.LIc2bG_panel[data-resizing]{user-select:none;box-shadow:var(--at-shadow-active)}@keyframes LIc2bG_agentTeamsPanelIn{0%{opacity:0}to{opacity:1}}@keyframes LIc2bG_agentTeamsPulse{0%,to{opacity:.42}50%{opacity:1}}.LIc2bG_panelHead{border-bottom:1px solid var(--dsw-alias-line-normal);cursor:grab;touch-action:none;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:0 14px;display:flex}.LIc2bG_panelHead:active,.LIc2bG_panel[data-dragging] .LIc2bG_panelHead{cursor:grabbing}.LIc2bG_panel[data-compact] .LIc2bG_panelHead{cursor:default;touch-action:auto}.LIc2bG_panelTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:8px;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}.LIc2bG_panelControls{flex:none;align-items:center;gap:2px;display:inline-flex}.LIc2bG_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,transform .12s;display:inline-flex}.LIc2bG_iconButton:hover{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-primary)}.LIc2bG_iconButton:active{transform:scale(.94)}.LIc2bG_iconButton[data-control=dock][data-mode=docked] svg{transform:scaleX(-1)}.LIc2bG_iconButton[data-control=close]:hover:not(:disabled){background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.LIc2bG_iconButton[data-control=close]:disabled{opacity:.45;cursor:not-allowed}.LIc2bG_closeError{color:var(--dsw-alias-state-danger);border-top:1px solid var(--dsw-alias-line-normal);padding:4px 14px;font-size:12px;line-height:16px}.LIc2bG_resizeHandle{z-index:1;touch-action:none;position:absolute}.LIc2bG_resizeHandle[data-resize-edge=left]{cursor:ew-resize;width:8px;top:44px;bottom:8px;left:0}.LIc2bG_resizeHandle[data-resize-edge=bottom]{cursor:ns-resize;height:8px;bottom:0;left:12px;right:12px}.LIc2bG_resizeHandle[data-resize-edge=corner]{cursor:nwse-resize;width:18px;height:18px;bottom:0;right:0}.LIc2bG_resizeHandle[data-resize-edge=corner]:after{border-right:1px solid var(--dsw-alias-label-tertiary);border-bottom:1px solid var(--dsw-alias-label-tertiary);content:\"\";opacity:.52;width:7px;height:7px;position:absolute;bottom:4px;right:4px}.LIc2bG_teams{overscroll-behavior:contain;scrollbar-color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent) transparent;scrollbar-width:thin;flex-direction:column;min-height:0;display:flex;overflow-y:auto}.LIc2bG_teams::-webkit-scrollbar{width:6px}.LIc2bG_teams::-webkit-scrollbar-track{background:0 0}.LIc2bG_teams::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent);background-clip:padding-box;border:2px solid #0000;border-radius:999px}.LIc2bG_teams:hover::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 44%, transparent);background-clip:padding-box}.LIc2bG_team{border-bottom:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:12px;padding:12px 14px 14px;display:flex}.LIc2bG_team:last-child{border-bottom:0}.LIc2bG_teamHead{align-items:center;gap:10px;min-width:0;display:flex}.LIc2bG_teamName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}.LIc2bG_teamStats{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;gap:8px;font-size:10px;line-height:16px;display:inline-flex}.LIc2bG_sectionHead{justify-content:space-between;align-items:center;gap:8px;min-width:0;display:flex}.LIc2bG_sectionTitle{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.LIc2bG_sectionHint{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.LIc2bG_delegationSection{flex-direction:column;gap:10px;min-width:0;display:flex}.LIc2bG_captainNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 32%, var(--dsw-alias-line-normal));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid}.LIc2bG_commandLayer{grid-template-columns:1fr;gap:10px;display:grid}.LIc2bG_commandLayer[data-leadership=solo]{grid-template-columns:1fr}.LIc2bG_commissarNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--at-accent) 32%, var(--at-border));background:color-mix(in srgb, var(--at-accent) 5%, var(--at-bg-panel));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid;position:relative}.LIc2bG_commissarNode:before{background:var(--at-accent);content:\"\";border-radius:2px;width:2px;position:absolute;top:8px;bottom:8px;left:0}.LIc2bG_commissarState{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;text-align:right;font-size:10px;line-height:14px;overflow:hidden}.LIc2bG_commissarState[data-activity=working]{color:var(--dsw-alias-state-business-primary);font-weight:600}.LIc2bG_captainAvatar,.LIc2bG_memberAvatar{flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}.LIc2bG_captainAvatar{width:46px;height:46px}.LIc2bG_leadAvatar,.LIc2bG_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0}.LIc2bG_leadAvatar{width:44px;height:44px}.LIc2bG_memberArt{width:40px;height:40px}.LIc2bG_captainInfo,.LIc2bG_memberInfo{flex-direction:column;min-width:0;display:flex}.LIc2bG_captainInfo{gap:2px}.LIc2bG_captainLine,.LIc2bG_memberLine{align-items:center;gap:6px;min-width:0;display:flex}.LIc2bG_captainName,.LIc2bG_memberName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:18px;overflow:hidden}.LIc2bG_captainRole,.LIc2bG_memberRole{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.LIc2bG_memberModel{color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 78%, transparent);text-overflow:ellipsis;white-space:nowrap;flex:none;margin-left:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:8px;line-height:12px;overflow:hidden}.LIc2bG_captainSummary,.LIc2bG_memberStatusLine{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:15px;overflow:hidden}.LIc2bG_memberElapsed{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:4px;flex:none;align-items:center;margin-left:6px;padding:0 4px;font-size:8.5px;font-weight:600;line-height:14px;display:inline-flex}.LIc2bG_memberElapsed[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 14%, transparent);color:var(--dsw-alias-state-warning)}.LIc2bG_memberElapsed[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 14%, transparent);color:var(--dsw-alias-state-danger)}.LIc2bG_captainState,.LIc2bG_memberState{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;align-items:center;gap:5px;font-size:10px;font-weight:500;line-height:15px;display:inline-flex}.LIc2bG_captainState[data-busy=true],.LIc2bG_memberState[data-activity=working]{color:var(--dsw-alias-state-business-primary)}.LIc2bG_workGlyph rect{opacity:.5}.LIc2bG_workGlyph[data-active=true] rect{animation:1.1s ease-in-out infinite LIc2bG_agentTeamsDot}@keyframes LIc2bG_agentTeamsDot{0%,to{opacity:.25}50%{opacity:1}}.LIc2bG_progressOverview{flex-direction:column;gap:7px;display:flex}.LIc2bG_progressTitle{color:var(--dsw-alias-label-secondary);font-size:11px;font-weight:600;line-height:16px}.LIc2bG_progressSegments{gap:3px;display:flex}.LIc2bG_progressSegments>span,.LIc2bG_progressEmpty{background:var(--dsw-alias-line-strong);border-radius:2px;flex:1;height:5px}.LIc2bG_progressEmpty{width:100%;display:block}.LIc2bG_progressSegments>span[data-state=running]{background:var(--dsw-alias-state-business-primary)}.LIc2bG_progressSegments>span[data-state=blocked]{background:var(--dsw-alias-state-warning)}.LIc2bG_progressSegments>span[data-state=completed]{background:var(--dsw-alias-state-success)}.LIc2bG_progressSegments>span[data-state=failed]{background:var(--dsw-alias-state-danger)}.LIc2bG_progressSegments>span[data-state=cancelled]{opacity:.55}.LIc2bG_progressLegend{color:var(--dsw-alias-label-tertiary);gap:10px;font-size:9px;line-height:14px;display:flex}.LIc2bG_progressLegend>span[data-state=running]{color:var(--dsw-alias-state-business-primary)}.LIc2bG_progressLegend>span[data-state=blocked]{color:var(--dsw-alias-state-warning)}.LIc2bG_progressLegend>span[data-state=completed]{color:var(--dsw-alias-state-success)}.LIc2bG_progressSummary{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));min-width:0;color:var(--dsw-alias-label-secondary);border-radius:8px;align-items:center;gap:6px;padding:5px 8px;font-size:10px;font-weight:600;line-height:15px;display:flex}.LIc2bG_progressSummary[data-state=warning]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 8%, var(--dsw-alias-bg-module))}.LIc2bG_progressSummary[data-state=completed]{background:color-mix(in srgb, var(--dsw-alias-state-success) 8%, var(--dsw-alias-bg-module))}.LIc2bG_progressSummary>span:last-child{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.LIc2bG_progressSummaryDot{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:5px;height:5px}.LIc2bG_progressSummary[data-state=warning] .LIc2bG_progressSummaryDot{background:var(--dsw-alias-state-warning)}.LIc2bG_progressSummary[data-state=completed] .LIc2bG_progressSummaryDot{background:var(--dsw-alias-state-success)}.LIc2bG_membersToggle{background:var(--dsw-alias-bg-module-platform);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.LIc2bG_membersToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.LIc2bG_membersToggle>span{align-items:center;gap:5px;display:inline-flex}.LIc2bG_membersToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.LIc2bG_historyToggle{background:var(--dsw-alias-bg-module);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.LIc2bG_historyToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.LIc2bG_historyToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.LIc2bG_chevron{flex:none;transition:transform .12s}.LIc2bG_chevron[data-open=true]{transform:rotate(90deg)}.LIc2bG_delegationTree{flex-direction:column;gap:2px;margin-left:18px;padding:0 0 0 20px;display:flex;position:relative}.LIc2bG_delegationTree:before{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));content:\"\";width:1px;position:absolute;top:0;bottom:22px;left:0}.LIc2bG_memberBlock{flex-direction:column;min-width:0;padding:3px 0 7px;display:flex;position:relative}.LIc2bG_memberBranch{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));width:20px;height:1px;display:block;position:absolute;top:27px;right:100%}.LIc2bG_memberBranch:before{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:5px;height:5px;position:absolute;top:-2px;right:-1px}.LIc2bG_memberRow{box-sizing:border-box;width:100%;min-width:0;min-height:48px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:46px minmax(0,1fr) auto;align-items:center;gap:8px;padding:4px 6px;transition:background-color .12s,transform .12s;display:grid}.LIc2bG_memberRow:hover,.LIc2bG_memberRow[data-activity=working]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.LIc2bG_memberRow:active{transform:scale(.99)}.LIc2bG_memberAvatar{width:42px;height:42px}.LIc2bG_memberAvatar[data-unread=true]:after{box-sizing:border-box;border:1px solid var(--dsw-alias-bg-module);background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:6px;height:6px;animation:1.8s ease-in-out infinite LIc2bG_agentTeamsUnreadPulse;position:absolute;top:0;right:-1px}@keyframes LIc2bG_agentTeamsUnreadPulse{0%,to{opacity:.78;transform:scale(.92)}50%{opacity:1;transform:scale(1.16)}}.LIc2bG_memberInitial{background:var(--dsw-alias-bg-fill-business);width:38px;height:38px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:15px;font-weight:600;line-height:20px;display:inline-flex}.LIc2bG_stateArt{box-sizing:border-box;object-fit:contain;width:22px;height:22px;filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #122d483d);background:0 0;border:0;border-radius:0;position:absolute;bottom:-3px;right:-5px}.LIc2bG_stateArt[data-activity=working]{animation:2.4s ease-in-out infinite LIc2bG_agentTeamsFloat}.LIc2bG_stateArt[data-activity=idle]{animation:4.2s ease-in-out infinite LIc2bG_agentTeamsBreathe}.LIc2bG_stateArt[data-activity=unknown]{animation:2.8s ease-in-out infinite LIc2bG_agentTeamsThink}@keyframes LIc2bG_agentTeamsFloat{0%,to{transform:translateY(0)rotate(-4deg)}50%{transform:translateY(-2px)rotate(4deg)}}@keyframes LIc2bG_agentTeamsBreathe{0%,to{opacity:.82;transform:scale(1)}50%{opacity:1;transform:scale(1.06)}}@keyframes LIc2bG_agentTeamsThink{0%,to{transform:rotate(-7deg)}50%{transform:rotate(7deg)}}.LIc2bG_memberRight{flex:none;align-items:center;gap:8px;display:inline-flex}.LIc2bG_memberCount{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}.LIc2bG_assignmentLine{align-items:center;gap:7px;min-width:0;padding:0 6px 0 60px;display:flex}.LIc2bG_assignmentLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:9px;line-height:14px}.LIc2bG_assignmentTasks{flex-wrap:wrap;flex:1;gap:4px;min-width:0;display:flex}.LIc2bG_assignmentChip{background:var(--dsw-alias-bg-fill-neutral);min-height:16px;color:var(--dsw-alias-label-secondary);border-radius:4px;align-items:center;padding:0 5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:600;line-height:14px;display:inline-flex}.LIc2bG_assignmentChip[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.LIc2bG_assignmentChip[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.LIc2bG_assignmentChip[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.LIc2bG_assignmentChip[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.LIc2bG_assignmentChip[data-state=cancelled]{color:var(--dsw-alias-label-tertiary);text-decoration:line-through}.LIc2bG_assignmentChip[data-review=pending]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.LIc2bG_assignmentChip[data-helping=true]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 50%, transparent);outline-offset:-1px}.LIc2bG_reviewChip,.LIc2bG_helpingChip,.LIc2bG_calibrationChip,.LIc2bG_blockedChip,.LIc2bG_inputChip{box-sizing:border-box;white-space:nowrap;min-height:16px;color:inherit;background:0 0;border-radius:4px;flex:none;align-items:center;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.LIc2bG_reviewChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-state-warning) 70%, transparent);outline-offset:-1px}.LIc2bG_blockedChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 75%, transparent);outline-offset:-1px}.LIc2bG_inputChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.LIc2bG_helpingChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 65%, transparent);outline-offset:-1px}.LIc2bG_calibrationChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.LIc2bG_assignmentChip[data-timing=warn]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.LIc2bG_assignmentChip[data-timing=over]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-danger) 62%, transparent);outline-offset:-1px}.LIc2bG_timingChip{box-sizing:border-box;white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:16px;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.LIc2bG_timingChip[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 16%, transparent);color:var(--dsw-alias-state-warning)}.LIc2bG_timingChip[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 16%, transparent);color:var(--dsw-alias-state-danger)}.LIc2bG_unreadPill{color:var(--dsw-alias-state-business-primary);white-space:nowrap;flex:none;font-size:9px;font-weight:600;line-height:14px}.LIc2bG_taskEmpty{color:var(--dsw-alias-label-tertiary);font-size:9px;line-height:14px}.LIc2bG_dependencySection{border-top:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:7px;min-width:0;padding-top:10px;display:flex}.LIc2bG_sectionToggleTitle{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.LIc2bG_dagViewport{scrollbar-width:thin;min-width:0;padding:2px 0 4px;overflow-x:auto}.LIc2bG_dagCanvas{min-width:100%;position:relative}.LIc2bG_dagCanvas[data-layout=parallel]{flex-wrap:wrap;gap:8px;display:flex}.LIc2bG_dagCanvas[data-layout=parallel] .LIc2bG_dagNode{flex:92px;min-width:92px;position:relative}.LIc2bG_dagEdges{pointer-events:none;position:absolute;inset:0;overflow:visible}.LIc2bG_dagEdges path{fill:none;stroke:var(--dsw-alias-line-strong);stroke-width:1px;transition:opacity .12s,stroke .12s,stroke-width .12s}.LIc2bG_dagEdges path[data-active=true]{stroke:var(--dsw-alias-state-business-primary);stroke-width:1.6px}.LIc2bG_dagEdges path[data-dimmed=true]{opacity:.24}.LIc2bG_dagNode{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:6px;flex-direction:column;justify-content:center;gap:1px;padding:0 6px;transition:border-color .12s,background-color .12s,opacity .12s;display:flex;position:absolute}.LIc2bG_dagNode:hover,.LIc2bG_dagNode[data-focused=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.LIc2bG_dagNode[data-dimmed=true]{opacity:.3}.LIc2bG_dagNode[data-state=running][data-dimmed=true]{opacity:.58}.LIc2bG_dagNode[data-state=completed]{border-color:color-mix(in srgb, var(--dsw-alias-state-success) 48%, var(--dsw-alias-line-normal))}.LIc2bG_dagNode[data-state=blocked]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 52%, var(--dsw-alias-line-normal))}.LIc2bG_dagNode[data-review=pending]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.LIc2bG_dagNode[data-helping=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 70%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-business-primary) 38%, transparent)}.LIc2bG_dagNode[data-timing=warn]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.LIc2bG_dagNode[data-timing=over]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-danger) 46%, transparent)}.LIc2bG_dagNode[data-state=failed]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 56%, var(--dsw-alias-line-normal))}.LIc2bG_dagNodeHead{color:var(--dsw-alias-label-primary);align-items:center;gap:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:700;display:flex}.LIc2bG_dagNodeDot{background:var(--dsw-alias-line-strong);border-radius:2px;flex:none;width:5px;height:5px}.LIc2bG_dagNode[data-state=running] .LIc2bG_dagNodeDot{background:var(--dsw-alias-state-business-primary)}.LIc2bG_dagNode[data-state=running] .LIc2bG_dagNodeHead{padding-right:12px}.LIc2bG_dagRunningState{width:9px;height:9px;color:var(--dsw-alias-state-business-primary);pointer-events:none;justify-content:center;align-items:center;display:inline-flex;position:absolute;top:4px;right:5px}.LIc2bG_dagRunningState .LIc2bG_workGlyph{width:9px;height:9px}.LIc2bG_dagNode[data-state=blocked] .LIc2bG_dagNodeDot{background:var(--dsw-alias-state-warning)}.LIc2bG_dagNode[data-state=completed] .LIc2bG_dagNodeDot{background:var(--dsw-alias-state-success)}.LIc2bG_dagNode[data-state=failed] .LIc2bG_dagNodeDot{background:var(--dsw-alias-state-danger)}.LIc2bG_dagNodeLabel{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:11px;overflow:hidden}.LIc2bG_taskDetail{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:8px;flex-direction:column;gap:3px;min-width:0;padding:7px 9px;display:flex}.LIc2bG_taskDetailHead{align-items:center;gap:6px;min-width:0;display:flex}.LIc2bG_taskDetailId{color:var(--dsw-alias-state-business-primary);flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;font-weight:700}.LIc2bG_taskDetailSubject{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.LIc2bG_taskDetailBadge{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:8.5px;font-weight:600;line-height:14px}.LIc2bG_taskDetailBadge[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.LIc2bG_taskDetailBadge[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.LIc2bG_taskDetailBadge[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.LIc2bG_taskDetailBadge[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.LIc2bG_taskDetailLine,.LIc2bG_taskDetailMeta{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.LIc2bG_taskDetailMeta{color:var(--dsw-alias-label-tertiary)}.LIc2bG_archiveAction{color:var(--dsw-alias-state-danger);background:color-mix(in srgb, var(--dsw-alias-state-danger) 12%, transparent);cursor:pointer;border:0;border-radius:5px;padding:3px 6px;font-size:9px}.LIc2bG_archiveAction:disabled{opacity:.55;cursor:not-allowed}.LIc2bG_diagnosticBanner{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-warning) 10%, var(--dsw-alias-bg-module));flex-wrap:wrap;align-items:flex-start;gap:6px 8px;padding:7px 10px;font-size:11px;line-height:16px;display:flex}.LIc2bG_diagnosticBanner button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-fill-neutral);cursor:pointer;border:0;border-radius:4px;padding:2px 6px}.LIc2bG_archiveConfirm{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-danger) 10%, var(--dsw-alias-background-base));justify-content:space-between;gap:8px;padding:7px 10px;font-size:10px;display:flex}.LIc2bG_archiveConfirmActions{gap:5px;display:flex}.LIc2bG_archiveConfirmActions button{cursor:pointer;border:0;border-radius:4px;padding:3px 6px}.LIc2bG_connectionStatus{color:var(--dsw-alias-label-tertiary);margin-left:5px;font-size:9px;font-weight:400}.LIc2bG_connectionStatus[data-connection=stale],.LIc2bG_connectionStatus[data-connection=offline],.LIc2bG_connectionStatus[data-connection=auth-failed]{color:var(--dsw-alias-state-warning)}.LIc2bG_taskDetailActions{gap:6px;margin-top:3px;display:flex}.LIc2bG_taskDetailActions button{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;padding:1px 4px;font-size:9px}.LIc2bG_taskDetailTiming{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.LIc2bG_taskDetailTiming[data-timing=warn]{color:var(--dsw-alias-state-warning)}.LIc2bG_taskDetailTiming[data-timing=over]{color:var(--dsw-alias-state-danger);font-weight:600}.LIc2bG_taskDetailBudgetFact{color:var(--dsw-alias-label-secondary);font-size:11px;line-height:16px}.LIc2bG_taskDetailBudgetFact[data-budget-fact=over_budget]{color:var(--dsw-alias-state-warning);font-weight:700}.LIc2bG_taskDetailBudgetFact[data-budget-fact=within_budget]{color:var(--dsw-alias-state-success)}.LIc2bG_taskDetailSignals,.LIc2bG_taskDetailRetro{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:13px;overflow:hidden}.LIc2bG_taskDetail[data-expanded] .LIc2bG_taskDetailSignals,.LIc2bG_taskDetail[data-expanded] .LIc2bG_taskDetailRetro{overflow-wrap:anywhere;text-overflow:clip;white-space:normal;font-size:12px;line-height:18px;overflow:visible}.LIc2bG_taskDetail[data-expanded] .LIc2bG_taskDetailActions{margin-top:7px}.LIc2bG_taskDetailActions button{min-height:32px}.LIc2bG_taskDetailActions button:focus-visible,.LIc2bG_archiveAction:focus-visible,.LIc2bG_archiveConfirmActions button:focus-visible{outline:2px solid var(--dsw-alias-state-primary);outline-offset:2px}.LIc2bG_taskDetailRetro[data-cause=underestimated],.LIc2bG_taskDetailRetro[data-cause=dependency-blocked]{color:var(--dsw-alias-state-danger)}.LIc2bG_taskDetailRetro[data-cause=on_time]{color:var(--dsw-alias-state-success)}.LIc2bG_taskDetailReview{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:600;line-height:14px}.LIc2bG_taskDetailReview[data-verdict=pass]{color:var(--dsw-alias-state-success)}.LIc2bG_taskDetailReview[data-verdict=reject]{color:var(--dsw-alias-state-danger)}.LIc2bG_taskDetailCalibration{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.LIc2bG_taskDetailBlocked{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:700;line-height:14px}.LIc2bG_taskDetailInput{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.LIc2bG_emptyHint{color:var(--dsw-alias-label-tertiary);padding:10px 14px;font-size:11px;line-height:16px}.LIc2bG_modeHint{color:var(--dsw-alias-label-secondary);padding:0 14px 6px;font-size:11px;line-height:16px;display:block}.LIc2bG_modeBadge{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 7px;font-size:11px;font-weight:600;line-height:16px}.LIc2bG_modeBadge[data-mode=light]{color:var(--dsw-alias-label-secondary)}.LIc2bG_modeBadge[data-mode=standard]{color:var(--dsw-alias-state-business-primary)}.LIc2bG_modeBadge[data-mode=governed]{color:var(--dsw-alias-state-warning)}.LIc2bG_historicPill{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;margin-left:auto;padding:1px 7px;font-size:9px;font-weight:600;line-height:15px}.LIc2bG_members{flex-direction:column;gap:3px;display:flex}.LIc2bG_archiveLabel{color:var(--dsw-alias-label-tertiary);padding:5px 14px 0;font-size:9px;font-weight:600;line-height:14px;display:block}.LIc2bG_archiveFilterBar{flex-wrap:wrap;align-items:center;gap:6px 8px;padding:6px 14px 2px;display:flex}.LIc2bG_archiveFilterField{color:var(--dsw-alias-label-tertiary);align-items:center;gap:4px;font-size:9px;line-height:14px;display:inline-flex}.LIc2bG_archiveFilterCaption{white-space:nowrap;font-weight:600}.LIc2bG_archiveSelect{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:120px;color:var(--dsw-alias-label-primary);border-radius:4px;padding:1px 2px;font-size:9px;line-height:14px}.LIc2bG_archiveFilterCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;margin-left:auto;font-size:9px}.LIc2bG_archiveEmpty{color:var(--dsw-alias-label-tertiary);padding:4px 14px 2px;font-size:9px;display:block}@media (prefers-reduced-motion:reduce){.LIc2bG_panel,.LIc2bG_badge,.LIc2bG_badgeDot,.LIc2bG_panelDot,.LIc2bG_workGlyph rect,.LIc2bG_stateArt,.LIc2bG_memberAvatar[data-unread=true]:after{transition:none;animation:none}}@media (width<=960px){html[data-agent-team-web-panel-open] div[data-phase]{padding-right:0}.LIc2bG_team{padding:12px 12px 14px}.LIc2bG_delegationTree{margin-left:12px;padding-left:15px}.LIc2bG_memberBranch{width:15px}}@media (width<=640px){.LIc2bG_badge{top:56px;right:10px}.LIc2bG_teamStats span[data-stat=messages]{display:none}.LIc2bG_captainNode{grid-template-columns:48px minmax(0,1fr)}.LIc2bG_captainState{display:none}.LIc2bG_assignmentLine{padding-left:60px}}.LIc2bG_healthChip{box-sizing:border-box;background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;flex:none;align-items:center;gap:5px;padding:1px 8px;font-size:11px;line-height:16px;display:inline-flex}.LIc2bG_healthChip strong{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:11px;font-weight:700}.LIc2bG_healthChip em{color:var(--dsw-alias-label-secondary);font-style:normal}.LIc2bG_healthChip[data-level=ok] strong{color:var(--dsw-alias-state-success)}.LIc2bG_healthChip[data-level=warn] strong{color:var(--dsw-alias-state-warning)}.LIc2bG_healthChip[data-level=critical] strong,.LIc2bG_riskStat{color:var(--dsw-alias-state-danger)}.LIc2bG_prioritySection{flex-direction:column;gap:5px;min-width:0;display:flex}.LIc2bG_priorityCard{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);border-radius:8px;align-items:flex-start;gap:8px;padding:6px 8px;display:flex}.LIc2bG_priorityCard[data-severity=high]{border-color:color-mix(in srgb,var(--dsw-alias-state-danger) 45%,var(--dsw-alias-line-normal))}.LIc2bG_priorityCard[data-severity=medium]{border-color:color-mix(in srgb,var(--dsw-alias-state-warning) 40%,var(--dsw-alias-line-normal))}.LIc2bG_priorityBadge{background:var(--dsw-alias-bg-fill-business);min-width:22px;height:18px;color:var(--dsw-alias-label-on-fill);border-radius:6px;flex:none;justify-content:center;align-items:center;font-size:11px;font-weight:700;display:inline-flex}.LIc2bG_priorityBody{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.LIc2bG_priorityTitle{flex-wrap:wrap;align-items:center;gap:5px;min-width:0;display:flex}.LIc2bG_priorityTitle strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.LIc2bG_chip{background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;padding:0 6px;font-size:11px;font-style:normal;font-weight:600;line-height:16px;display:inline-flex}.LIc2bG_chip[data-readiness=blocked],.LIc2bG_chip[data-readiness=orphaned],.LIc2bG_chip[data-readiness=stalled],.LIc2bG_chip[data-readiness=failed],.LIc2bG_chip[data-severity=high]{border-color:var(--dsw-alias-state-danger);color:var(--dsw-alias-state-danger)}.LIc2bG_chip[data-severity=medium],.LIc2bG_chip[data-readiness=ready]{border-color:var(--dsw-alias-state-warning);color:var(--dsw-alias-state-warning)}.LIc2bG_chip[data-severity=low],.LIc2bG_chip[data-readiness=cancelled]{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary)}.LIc2bG_priorityReasons{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.LIc2bG_milestoneRow{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;line-height:16px;display:flex}.LIc2bG_milestoneRow strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-weight:600;overflow:hidden}.LIc2bG_loadBar{background:var(--dsw-alias-line-strong);border-radius:999px;flex:none;align-items:stretch;width:44px;min-width:0;height:6px;display:inline-flex;overflow:hidden}.LIc2bG_loadBar>span{display:block}.LIc2bG_loadActive{background:var(--dsw-alias-state-business-primary)}.LIc2bG_loadPending{background:var(--dsw-alias-state-warning)}.LIc2bG_loadStalled,.LIc2bG_loadOrphaned{background:var(--dsw-alias-state-danger)}";
		...
		var ActivityPanel_module_css_default = {
			"agentTeamsBreathe": "LIc2bG_agentTeamsBreathe",
			"agentTeamsDot": "LIc2bG_agentTeamsDot",
			"agentTeamsFloat": "LIc2bG_agentTeamsFloat",
			"agentTeamsPanelIn": "LIc2bG_agentTeamsPanelIn",
			"agentTeamsPulse": "LIc2bG_agentTeamsPulse",
			"agentTeamsThink": "LIc2bG_agentTeamsThink",
			"agentTeamsUnreadPulse": "LIc2bG_agentTeamsUnreadPulse",
			"archiveAction": "LIc2bG_archiveAction",
			"archiveConfirm": "LIc2bG_archiveConfirm",
			"archiveConfirmActions": "LIc2bG_archiveConfirmActions",
			"archiveEmpty": "LIc2bG_archiveEmpty",
			"archiveFilterBar": "LIc2bG_archiveFilterBar",
			"archiveFilterCaption": "LIc2bG_archiveFilterCaption",
			"archiveFilterCount": "LIc2bG_archiveFilterCount",
			"archiveFilterField": "LIc2bG_archiveFilterField",
			"archiveLabel": "LIc2bG_archiveLabel",
			"archiveSelect": "LIc2bG_archiveSelect",
			"assignmentChip": "LIc2bG_assignmentChip",
			"assignmentLabel": "LIc2bG_assignmentLabel",
			"assignmentLine": "LIc2bG_assignmentLine",
			"assignmentTasks": "LIc2bG_assignmentTasks",
			"badge": "LIc2bG_badge",
			"badgeCount": "LIc2bG_badgeCount",
			"badgeDot": "LIc2bG_badgeDot",
			"blockedChip": "LIc2bG_blockedChip",
			"calibrationChip": "LIc2bG_calibrationChip",
			"captainAvatar": "LIc2bG_captainAvatar",
			"captainInfo": "LIc2bG_captainInfo",
			"captainLine": "LIc2bG_captainLine",
			"captainName": "LIc2bG_captainName",
			"captainNode": "LIc2bG_captainNode",
			"captainRole": "LIc2bG_captainRole",
			"captainState": "LIc2bG_captainState",
			"captainSummary": "LIc2bG_captainSummary",
			"chevron": "LIc2bG_chevron",
			"chip": "LIc2bG_chip",
			"closeError": "LIc2bG_closeError",
			"commandLayer": "LIc2bG_commandLayer",
			"commissarNode": "LIc2bG_commissarNode",
			"commissarState": "LIc2bG_commissarState",
			"connectionStatus": "LIc2bG_connectionStatus",
			"dagCanvas": "LIc2bG_dagCanvas",
			"dagEdges": "LIc2bG_dagEdges",
			"dagNode": "LIc2bG_dagNode",
			"dagNodeDot": "LIc2bG_dagNodeDot",
			"dagNodeHead": "LIc2bG_dagNodeHead",
			"dagNodeLabel": "LIc2bG_dagNodeLabel",
			"dagRunningState": "LIc2bG_dagRunningState",
			"dagViewport": "LIc2bG_dagViewport",
			"delegationSection": "LIc2bG_delegationSection",
			"delegationTree": "LIc2bG_delegationTree",
			"dependencySection": "LIc2bG_dependencySection",
			"diagnosticBanner": "LIc2bG_diagnosticBanner",
			"emptyHint": "LIc2bG_emptyHint",
			"healthChip": "LIc2bG_healthChip",
			"helpingChip": "LIc2bG_helpingChip",
			"historicPill": "LIc2bG_historicPill",
			"historyToggle": "LIc2bG_historyToggle",
			"iconButton": "LIc2bG_iconButton",
			"inputChip": "LIc2bG_inputChip",
			"leadAvatar": "LIc2bG_leadAvatar",
			"loadActive": "LIc2bG_loadActive",
			"loadBar": "LIc2bG_loadBar",
			"loadOrphaned": "LIc2bG_loadOrphaned",
			"loadPending": "LIc2bG_loadPending",
			"loadStalled": "LIc2bG_loadStalled",
			"memberArt": "LIc2bG_memberArt",
			"memberAvatar": "LIc2bG_memberAvatar",
			"memberBlock": "LIc2bG_memberBlock",
			"memberBranch": "LIc2bG_memberBranch",
			"memberCount": "LIc2bG_memberCount",
			"memberElapsed": "LIc2bG_memberElapsed",
			"memberInfo": "LIc2bG_memberInfo",
			"memberInitial": "LIc2bG_memberInitial",
			"memberLine": "LIc2bG_memberLine",
			"memberModel": "LIc2bG_memberModel",
			"memberName": "LIc2bG_memberName",
			"memberRight": "LIc2bG_memberRight",
			"memberRole": "LIc2bG_memberRole",
			"memberRow": "LIc2bG_memberRow",
			"memberState": "LIc2bG_memberState",
			"memberStatusLine": "LIc2bG_memberStatusLine",
			"members": "LIc2bG_members",
			"membersToggle": "LIc2bG_membersToggle",
			"milestoneRow": "LIc2bG_milestoneRow",
			"modeBadge": "LIc2bG_modeBadge",
			"modeHint": "LIc2bG_modeHint",
			"panel": "LIc2bG_panel",
			"panelControls": "LIc2bG_panelControls",
			"panelDot": "LIc2bG_panelDot",
			"panelHead": "LIc2bG_panelHead",
			"panelTitle": "LIc2bG_panelTitle",
			"priorityBadge": "LIc2bG_priorityBadge",
			"priorityBody": "LIc2bG_priorityBody",
			"priorityCard": "LIc2bG_priorityCard",
			"priorityReasons": "LIc2bG_priorityReasons",
			"prioritySection": "LIc2bG_prioritySection",
			"priorityTitle": "LIc2bG_priorityTitle",
			"progressEmpty": "LIc2bG_progressEmpty",
			"progressLegend": "LIc2bG_progressLegend",
			"progressOverview": "LIc2bG_progressOverview",
			"progressSegments": "LIc2bG_progressSegments",
			"progressSummary": "LIc2bG_progressSummary",
			"progressSummaryDot": "LIc2bG_progressSummaryDot",
			"progressTitle": "LIc2bG_progressTitle",
			"resizeHandle": "LIc2bG_resizeHandle",
			"reviewChip": "LIc2bG_reviewChip",
			"riskStat": "LIc2bG_riskStat",
			"sectionHead": "LIc2bG_sectionHead",
			"sectionHint": "LIc2bG_sectionHint",
			"sectionTitle": "LIc2bG_sectionTitle",
			"sectionToggleTitle": "LIc2bG_sectionToggleTitle",
			"stageLabel": "LIc2bG_stageLabel",
			"stateArt": "LIc2bG_stateArt",
			"taskDetail": "LIc2bG_taskDetail",
			"taskDetailActions": "LIc2bG_taskDetailActions",
			"taskDetailBadge": "LIc2bG_taskDetailBadge",
			"taskDetailBlocked": "LIc2bG_taskDetailBlocked",
			"taskDetailBudgetFact": "LIc2bG_taskDetailBudgetFact",
			"taskDetailCalibration": "LIc2bG_taskDetailCalibration",
			"taskDetailHead": "LIc2bG_taskDetailHead",
			"taskDetailId": "LIc2bG_taskDetailId",
			"taskDetailInput": "LIc2bG_taskDetailInput",
			"taskDetailLine": "LIc2bG_taskDetailLine",
			"taskDetailMeta": "LIc2bG_taskDetailMeta",
			"taskDetailRetro": "LIc2bG_taskDetailRetro",
			"taskDetailReview": "LIc2bG_taskDetailReview",
			"taskDetailSignals": "LIc2bG_taskDetailSignals",
			"taskDetailSubject": "LIc2bG_taskDetailSubject",
			"taskDetailTiming": "LIc2bG_taskDetailTiming",
			"taskEmpty": "LIc2bG_taskEmpty",
			"taskId": "LIc2bG_taskId",
			"team": "LIc2bG_team",
			"teamHead": "LIc2bG_teamHead",
			"teamName": "LIc2bG_teamName",
			"teamStats": "LIc2bG_teamStats",
			"teams": "LIc2bG_teams",
			"timingChip": "LIc2bG_timingChip",
			"unreadPill": "LIc2bG_unreadPill",
			"workGlyph": "LIc2bG_workGlyph"
		};
		//#endregion
		...
		*/
		...
		const cssText = ".d9ioJG_section{flex-direction:column;gap:14px;display:flex}.d9ioJG_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:10px;padding:14px 16px;display:flex}.d9ioJG_head{align-items:center;gap:8px;display:flex}.d9ioJG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.d9ioJG_list{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.d9ioJG_row{box-sizing:border-box;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;min-width:0;min-height:36px;padding:0 10px;display:flex}.d9ioJG_nameWrap{flex:1;align-items:center;gap:8px;min-width:0;display:flex}.d9ioJG_name{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.d9ioJG_rowSub{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;line-height:16px}.d9ioJG_pill{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.d9ioJG_switch{box-sizing:border-box;background:var(--dsw-alias-border-l2);cursor:pointer;border:none;border-radius:999px;flex:none;width:32px;height:18px;padding:0;transition:background .12s ease-in-out;position:relative}.d9ioJG_switch[data-on=true]{background:var(--dsw-alias-state-business-primary)}.d9ioJG_switch:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.d9ioJG_switchThumb{background:var(--dsw-alias-bg-layer-1);border-radius:50%;width:14px;height:14px;transition:transform .12s ease-in-out;position:absolute;top:2px;left:2px}.d9ioJG_switch[data-on=true] .d9ioJG_switchThumb{transform:translate(14px)}.d9ioJG_select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;max-width:200px;color:var(--dsw-alias-label-primary);border-radius:6px;flex:1;padding:2px 4px;font-size:11px;line-height:16px}.d9ioJG_select:disabled{opacity:.55}@media (prefers-color-scheme:dark){.d9ioJG_select{color:#e8e8e8;background:#26282b}}.d9ioJG_resetBtn{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;flex:none;margin-left:auto;padding:2px 10px;font-size:11px;line-height:16px;transition:color .12s ease-in-out,border-color .12s ease-in-out}.d9ioJG_resetBtn:hover:not(:disabled){border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.d9ioJG_resetBtn:disabled{opacity:.45;cursor:default}.d9ioJG_presetPopover{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 56%, transparent);border-radius:10px;flex-direction:column;gap:8px;margin:2px 0 10px;padding:10px;display:flex}.d9ioJG_presetTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}.d9ioJG_presetHelp{color:var(--dsw-alias-label-tertiary);margin:0;font-size:11px;line-height:16px}.d9ioJG_presetTabs{flex-wrap:wrap;gap:6px;display:flex}.d9ioJG_presetTab{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:999px;padding:3px 8px;font-size:11px;line-height:16px}.d9ioJG_presetTab[data-active=true]{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.d9ioJG_presetList{flex-direction:column;gap:6px;display:flex}.d9ioJG_presetItem{border:1px solid var(--dsw-alias-border-l2);color:inherit;text-align:left;cursor:pointer;background:0 0;border-radius:8px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.d9ioJG_presetItem[data-active=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.d9ioJG_presetItemHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.d9ioJG_presetItemName{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:600;line-height:16px}.d9ioJG_presetMetaRow{flex-wrap:wrap;gap:6px;display:flex}.d9ioJG_presetMetaChip{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 46%, transparent);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 6px;font-size:10px;line-height:15px}.d9ioJG_presetItemDesc{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.d9ioJG_presetDiffBadge{color:var(--dsw-alias-label-secondary);flex:none;font-size:10px;line-height:15px}.d9ioJG_presetActions{justify-content:flex-end;gap:8px;display:flex}.d9ioJG_presetActionGhost,.d9ioJG_presetActionPrimary{cursor:pointer;border-radius:6px;padding:3px 10px;font-size:11px;line-height:16px}.d9ioJG_presetActionGhost{color:var(--dsw-alias-label-secondary);background:0 0;border:1px solid #0000}.d9ioJG_presetActionPrimary{border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary);color:#fff}.d9ioJG_empty{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 8px;font-size:11px;line-height:16px}.d9ioJG_viewBtn{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex;position:relative}.d9ioJG_viewBtn:hover{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.d9ioJG_viewBtn:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.d9ioJG_modalMask{z-index:100;background:#00000073;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.d9ioJG_modal{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:12px;width:460px;max-width:100%;padding:16px;box-shadow:0 12px 40px #00000080}.d9ioJG_modalHead{align-items:center;gap:8px;margin-bottom:12px;display:flex}.d9ioJG_modalTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.d9ioJG_modalClose{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;margin-left:auto;padding:2px 6px;font-size:13px;line-height:16px}.d9ioJG_modalClose:hover{color:var(--dsw-alias-label-primary);background:#ffffff0f}.d9ioJG_roleSlogan{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, transparent);color:var(--dsw-alias-state-business-primary);border-radius:8px;padding:8px 10px;font-size:13px;font-weight:500;line-height:20px}.d9ioJG_modalSectionTitle{color:var(--dsw-alias-label-tertiary);margin:12px 0 6px;font-size:11px;line-height:16px}.d9ioJG_dutyRow{gap:8px;padding:6px 10px;font-size:12px;line-height:20px;display:flex}.d9ioJG_dutyRow+.d9ioJG_dutyRow{border-top:1px dashed var(--dsw-alias-border-l2)}.d9ioJG_dutyStep{color:var(--dsw-alias-label-secondary);flex:none;font-weight:500}.d9ioJG_dutyDesc{color:var(--dsw-alias-label-primary)}.d9ioJG_modalKv{align-items:center;gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.d9ioJG_modalK{width:72px;color:var(--dsw-alias-label-tertiary);flex:none}.d9ioJG_modalV{color:var(--dsw-alias-label-secondary);flex:1;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}.d9ioJG_modalEmpty{color:var(--dsw-alias-label-tertiary);padding:6px 10px;font-size:12px;line-height:20px}.d9ioJG_modalBody{max-height:min(52vh,420px);margin-right:-4px;padding-right:4px;overflow:auto}.d9ioJG_ruleRow{gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.d9ioJG_ruleBullet{color:var(--dsw-alias-state-business-primary);flex:none}.d9ioJG_growthStat{color:var(--dsw-alias-label-primary);margin:0 0 8px;padding:0 10px;font-size:12px;line-height:20px}.d9ioJG_growthList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.d9ioJG_growthItem{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 40%, transparent);border-radius:8px;flex-direction:column;gap:2px;padding:8px 10px;display:flex}.d9ioJG_growthPractice{color:var(--dsw-alias-label-primary);font-size:12px;line-height:20px}.d9ioJG_growthMeta{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}";
		...
		var ProviderGrantsSection_module_css_default = {
			"card": "d9ioJG_card",
			"dutyDesc": "d9ioJG_dutyDesc",
			"dutyRow": "d9ioJG_dutyRow",
			"dutyStep": "d9ioJG_dutyStep",
			"empty": "d9ioJG_empty",
			"growthItem": "d9ioJG_growthItem",
			"growthList": "d9ioJG_growthList",
			"growthMeta": "d9ioJG_growthMeta",
			"growthPractice": "d9ioJG_growthPractice",
			"growthStat": "d9ioJG_growthStat",
			"head": "d9ioJG_head",
			"list": "d9ioJG_list",
			"modal": "d9ioJG_modal",
			"modalBody": "d9ioJG_modalBody",
			"modalClose": "d9ioJG_modalClose",
			"modalEmpty": "d9ioJG_modalEmpty",
			"modalHead": "d9ioJG_modalHead",
			"modalK": "d9ioJG_modalK",
			"modalKv": "d9ioJG_modalKv",
			"modalMask": "d9ioJG_modalMask",
			"modalSectionTitle": "d9ioJG_modalSectionTitle",
			"modalTitle": "d9ioJG_modalTitle",
			"modalV": "d9ioJG_modalV",
			"name": "d9ioJG_name",
			"nameWrap": "d9ioJG_nameWrap",
			"pill": "d9ioJG_pill",
			"presetActionGhost": "d9ioJG_presetActionGhost",
			"presetActionPrimary": "d9ioJG_presetActionPrimary",
			"presetActions": "d9ioJG_presetActions",
			"presetDiffBadge": "d9ioJG_presetDiffBadge",
			"presetHelp": "d9ioJG_presetHelp",
			"presetItem": "d9ioJG_presetItem",
			"presetItemDesc": "d9ioJG_presetItemDesc",
			"presetItemHead": "d9ioJG_presetItemHead",
			"presetItemName": "d9ioJG_presetItemName",
			"presetList": "d9ioJG_presetList",
			"presetMetaChip": "d9ioJG_presetMetaChip",
			"presetMetaRow": "d9ioJG_presetMetaRow",
			"presetPopover": "d9ioJG_presetPopover",
			"presetTab": "d9ioJG_presetTab",
			"presetTabs": "d9ioJG_presetTabs",
			"presetTitle": "d9ioJG_presetTitle",
			"resetBtn": "d9ioJG_resetBtn",
			"roleSlogan": "d9ioJG_roleSlogan",
			"row": "d9ioJG_row",
			"rowSub": "d9ioJG_rowSub",
			"ruleBullet": "d9ioJG_ruleBullet",
			"ruleRow": "d9ioJG_ruleRow",
			"section": "d9ioJG_section",
			"select": "d9ioJG_select",
			"switch": "d9ioJG_switch",
			"switchThumb": "d9ioJG_switchThumb",
			"title": "d9ioJG_title",
			"viewBtn": "d9ioJG_viewBtn"
		};
		//#endregion
