window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function modelGrantRows(providers, enabledModels) {
			const rows = [];
			for (const provider of providers) for (const model of provider.models ?? []) rows.push({
		...
		function toggleModelMap(current, key, nextEnabled) {
			return {
				...current ?? {},
				[key]: nextEnabled
			};
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("header", {
					...
					children: rows.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							title: modelKeyOf(row.provider, row.model),
							children: [
								row.provider,
								"/",
								row.model
					...
					}, modelKeyOf(row.provider, row.model)))
				})]
			});
		}
		/** 卡片二:角色预设。 */
		...
		*/
		function ProviderGrantsSection(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: modelRows.length === 0 && roleRows.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
