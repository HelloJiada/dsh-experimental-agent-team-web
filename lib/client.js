window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const cssText$2 = ".VAyGLq_root{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:8px;width:100%;min-width:0;padding:10px 12px;display:flex}.VAyGLq_head{align-items:center;gap:8px;min-width:0;display:flex}.VAyGLq_leadAvatar{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0;flex:none;width:30px;height:30px}.VAyGLq_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.VAyGLq_memberCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;margin-left:auto;font-size:11px;line-height:16px}.VAyGLq_panelButton{border:1px solid var(--dsw-alias-line-strong);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;flex:none;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:16px;transition:border-color .12s,color .12s}.VAyGLq_panelButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.VAyGLq_panelButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.VAyGLq_members{flex-wrap:wrap;gap:6px;min-width:0;display:flex}.VAyGLq_member{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:160px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:5px;padding:3px 8px 3px 3px;font-size:11px;font-weight:500;line-height:16px;transition:border-color .12s,background-color .12s;display:inline-flex}.VAyGLq_member:hover{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-fill-neutral)}.VAyGLq_member:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.VAyGLq_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d482e);background:0 0;border:0;border-radius:0;width:24px;height:24px}.VAyGLq_memberInitial{background:var(--dsw-alias-bg-fill-business);width:20px;height:20px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:10px;font-weight:600;line-height:20px;display:inline-flex}.VAyGLq_memberName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}";
		...
		var AgentTeamsCard_module_css_default = {
			"head": "VAyGLq_head",
			"leadAvatar": "VAyGLq_leadAvatar",
			"member": "VAyGLq_member",
			"memberArt": "VAyGLq_memberArt",
			"memberCount": "VAyGLq_memberCount",
			"memberInitial": "VAyGLq_memberInitial",
			"memberName": "VAyGLq_memberName",
			"members": "VAyGLq_members",
			"panelButton": "VAyGLq_panelButton",
			"root": "VAyGLq_root",
			"teamName": "VAyGLq_teamName"
		};
		//#endregion
		...
		*/
		...
		const cssText$1 = "html{--agent-team-web-panel-shift:420px}html[data-agent-team-web-panel-open] div[data-phase]{box-sizing:border-box;padding-right:var(--agent-team-web-panel-shift)}.vyiEUa_badge,.vyiEUa_panel{--at-bg-panel:#fff;--at-bg-raised:#fafbfc;--at-bg-fill:#f4f6f9;--at-border:#e8ebf0;--at-border-strong:#d9dee8;--at-text-primary:#1b1f27;--at-text-secondary:#5a6474;--at-text-tertiary:#8f97a6;--at-accent:#2d5ca8;--at-accent-hover:#3568b8;--at-accent-strong:#244a8a;--at-success:#15875a;--at-warning:#a4681a;--at-danger:#c23b42;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #17203014;--at-shadow-panel:0 12px 32px #17203012, 0 32px 72px #1720301c;--at-shadow-active:0 16px 40px #1720301a, 0 36px 80px #17203024;--dsw-alias-bg-module:var(--at-bg-panel);--dsw-alias-bg-module-platform:var(--at-bg-raised);--dsw-alias-bg-fill-neutral:var(--at-bg-fill);--dsw-alias-bg-fill-business:var(--at-accent);--dsw-alias-bg-fill-success:var(--at-success);--dsw-alias-bg-fill-warning:var(--at-warning);--dsw-alias-bg-fill-danger:var(--at-danger);--dsw-alias-state-business-primary:var(--at-accent);--dsw-alias-state-success:var(--at-success);--dsw-alias-state-warning:var(--at-warning);--dsw-alias-state-danger:var(--at-danger);--dsw-alias-label-primary:var(--at-text-primary);--dsw-alias-label-secondary:var(--at-text-secondary);--dsw-alias-label-tertiary:var(--at-text-tertiary);--dsw-alias-label-on-fill:var(--at-on-accent);--dsw-alias-line-normal:var(--at-border);--dsw-alias-line-strong:var(--at-border-strong)}@media (prefers-color-scheme:dark){.vyiEUa_badge,.vyiEUa_panel{--at-bg-panel:#1e1f22;--at-bg-raised:#202125;--at-bg-fill:#2a2c30;--at-border:#2e3136;--at-border-strong:#3a3e45;--at-text-primary:#f5f6f8;--at-text-secondary:#b9bdc6;--at-text-tertiary:#8b90a0;--at-accent:#5b8dd9;--at-accent-hover:#6d9be0;--at-accent-strong:#4a7cc9;--at-success:#3ecf7f;--at-warning:#f0a83c;--at-danger:#f0606a;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #00000073;--at-shadow-panel:0 12px 32px #00000073, 0 32px 72px #0000008c;--at-shadow-active:0 16px 40px #00000080, 0 36px 80px #0009}.vyiEUa_stateArt{filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #00000073)}}.vyiEUa_badge{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:color-mix(in srgb, var(--dsw-alias-bg-module-platform) 92%, transparent);backdrop-filter:blur(16px);height:34px;box-shadow:var(--at-shadow-badge);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:7px;padding:0 12px;font-size:12px;font-weight:600;line-height:20px;transition:border-color .12s,transform .12s;display:inline-flex;position:absolute;top:64px;right:18px}.vyiEUa_badge:hover{border-color:var(--dsw-alias-line-strong);transform:translateY(-1px)}.vyiEUa_badge:active{transform:translateY(0)scale(.97)}.vyiEUa_badge:focus-visible,.vyiEUa_iconButton:focus-visible,.vyiEUa_memberRow:focus-visible,.vyiEUa_membersToggle:focus-visible,.vyiEUa_sectionToggleTitle:focus-visible,.vyiEUa_historyToggle:focus-visible,.vyiEUa_dagNode:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.vyiEUa_badgeDot,.vyiEUa_panelDot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:7px;height:7px}.vyiEUa_badgeDot[data-busy=true],.vyiEUa_panelDot[data-busy=true]{background:var(--dsw-alias-state-business-primary);animation:1.25s ease-in-out infinite vyiEUa_agentTeamsPulse}.vyiEUa_badgeCount,.vyiEUa_memberCount,.vyiEUa_teamStats,.vyiEUa_stageLabel,.vyiEUa_taskId{font-variant-numeric:tabular-nums}.vyiEUa_panel{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-line-strong) 58%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-module) 95%, transparent);backdrop-filter:blur(20px)saturate(1.08);box-shadow:var(--at-shadow-panel);will-change:transform;border-radius:16px;flex-direction:column;animation:.16s ease-out vyiEUa_agentTeamsPanelIn;display:flex;position:absolute;top:0;left:0;overflow:hidden}.vyiEUa_panel[data-dragging],.vyiEUa_panel[data-resizing]{user-select:none;box-shadow:var(--at-shadow-active)}@keyframes vyiEUa_agentTeamsPanelIn{0%{opacity:0}to{opacity:1}}@keyframes vyiEUa_agentTeamsPulse{0%,to{opacity:.42}50%{opacity:1}}.vyiEUa_panelHead{border-bottom:1px solid var(--dsw-alias-line-normal);cursor:grab;touch-action:none;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:0 14px;display:flex}.vyiEUa_panelHead:active,.vyiEUa_panel[data-dragging] .vyiEUa_panelHead{cursor:grabbing}.vyiEUa_panel[data-compact] .vyiEUa_panelHead{cursor:default;touch-action:auto}.vyiEUa_panelTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:8px;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}.vyiEUa_panelControls{flex:none;align-items:center;gap:2px;display:inline-flex}.vyiEUa_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,transform .12s;display:inline-flex}.vyiEUa_iconButton:hover{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-primary)}.vyiEUa_iconButton:active{transform:scale(.94)}.vyiEUa_iconButton[data-control=dock][data-mode=docked] svg{transform:scaleX(-1)}.vyiEUa_iconButton[data-control=close]:hover:not(:disabled){background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.vyiEUa_iconButton[data-control=close]:disabled{opacity:.45;cursor:not-allowed}.vyiEUa_closeError{color:var(--dsw-alias-state-danger);border-top:1px solid var(--dsw-alias-line-normal);padding:4px 14px;font-size:12px;line-height:16px}.vyiEUa_resizeHandle{z-index:1;touch-action:none;position:absolute}.vyiEUa_resizeHandle[data-resize-edge=left]{cursor:ew-resize;width:8px;top:44px;bottom:8px;left:0}.vyiEUa_resizeHandle[data-resize-edge=bottom]{cursor:ns-resize;height:8px;bottom:0;left:12px;right:12px}.vyiEUa_resizeHandle[data-resize-edge=corner]{cursor:nwse-resize;width:18px;height:18px;bottom:0;right:0}.vyiEUa_resizeHandle[data-resize-edge=corner]:after{border-right:1px solid var(--dsw-alias-label-tertiary);border-bottom:1px solid var(--dsw-alias-label-tertiary);content:\"\";opacity:.52;width:7px;height:7px;position:absolute;bottom:4px;right:4px}.vyiEUa_teams{overscroll-behavior:contain;scrollbar-color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent) transparent;scrollbar-width:thin;flex-direction:column;min-height:0;display:flex;overflow-y:auto}.vyiEUa_teams::-webkit-scrollbar{width:6px}.vyiEUa_teams::-webkit-scrollbar-track{background:0 0}.vyiEUa_teams::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent);background-clip:padding-box;border:2px solid #0000;border-radius:999px}.vyiEUa_teams:hover::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 44%, transparent);background-clip:padding-box}.vyiEUa_team{border-bottom:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:12px;padding:12px 14px 14px;display:flex}.vyiEUa_team:last-child{border-bottom:0}.vyiEUa_teamHead{align-items:center;gap:10px;min-width:0;display:flex}.vyiEUa_teamName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}.vyiEUa_teamStats{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;gap:8px;font-size:10px;line-height:16px;display:inline-flex}.vyiEUa_sectionHead{justify-content:space-between;align-items:center;gap:8px;min-width:0;display:flex}.vyiEUa_sectionTitle{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.vyiEUa_sectionHint{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.vyiEUa_delegationSection{flex-direction:column;gap:10px;min-width:0;display:flex}.vyiEUa_captainNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 32%, var(--dsw-alias-line-normal));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid}.vyiEUa_commandLayer{grid-template-columns:1fr;gap:10px;display:grid}.vyiEUa_commandLayer[data-leadership=solo]{grid-template-columns:1fr}.vyiEUa_commissarNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--at-accent) 32%, var(--at-border));background:color-mix(in srgb, var(--at-accent) 5%, var(--at-bg-panel));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid;position:relative}.vyiEUa_commissarNode:before{background:var(--at-accent);content:\"\";border-radius:2px;width:2px;position:absolute;top:8px;bottom:8px;left:0}.vyiEUa_commissarState{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;text-align:right;font-size:10px;line-height:14px;overflow:hidden}.vyiEUa_commissarState[data-activity=working]{color:var(--dsw-alias-state-business-primary);font-weight:600}.vyiEUa_captainAvatar,.vyiEUa_memberAvatar{flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}.vyiEUa_captainAvatar{width:46px;height:46px}.vyiEUa_leadAvatar,.vyiEUa_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0}.vyiEUa_leadAvatar{width:44px;height:44px}.vyiEUa_memberArt{width:40px;height:40px}.vyiEUa_captainInfo,.vyiEUa_memberInfo{flex-direction:column;min-width:0;display:flex}.vyiEUa_captainInfo{gap:2px}.vyiEUa_captainLine,.vyiEUa_memberLine{align-items:center;gap:6px;min-width:0;display:flex}.vyiEUa_captainName,.vyiEUa_memberName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:18px;overflow:hidden}.vyiEUa_captainRole,.vyiEUa_memberRole{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.vyiEUa_memberModel{color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 78%, transparent);text-overflow:ellipsis;white-space:nowrap;flex:none;margin-left:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:8px;line-height:12px;overflow:hidden}.vyiEUa_captainSummary,.vyiEUa_memberStatusLine{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:15px;overflow:hidden}.vyiEUa_memberElapsed{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:4px;flex:none;align-items:center;margin-left:6px;padding:0 4px;font-size:8.5px;font-weight:600;line-height:14px;display:inline-flex}.vyiEUa_memberElapsed[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 14%, transparent);color:var(--dsw-alias-state-warning)}.vyiEUa_memberElapsed[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 14%, transparent);color:var(--dsw-alias-state-danger)}.vyiEUa_captainState,.vyiEUa_memberState{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;align-items:center;gap:5px;font-size:10px;font-weight:500;line-height:15px;display:inline-flex}.vyiEUa_captainState[data-busy=true],.vyiEUa_memberState[data-activity=working]{color:var(--dsw-alias-state-business-primary)}.vyiEUa_workGlyph rect{opacity:.5}.vyiEUa_workGlyph[data-active=true] rect{animation:1.1s ease-in-out infinite vyiEUa_agentTeamsDot}@keyframes vyiEUa_agentTeamsDot{0%,to{opacity:.25}50%{opacity:1}}.vyiEUa_progressOverview{flex-direction:column;gap:7px;display:flex}.vyiEUa_progressTitle{color:var(--dsw-alias-label-secondary);font-size:11px;font-weight:600;line-height:16px}.vyiEUa_progressSegments{gap:3px;display:flex}.vyiEUa_progressSegments>span,.vyiEUa_progressEmpty{background:var(--dsw-alias-line-strong);border-radius:2px;flex:1;height:5px}.vyiEUa_progressEmpty{width:100%;display:block}.vyiEUa_progressSegments>span[data-state=running]{background:var(--dsw-alias-state-business-primary)}.vyiEUa_progressSegments>span[data-state=blocked]{background:var(--dsw-alias-state-warning)}.vyiEUa_progressSegments>span[data-state=completed]{background:var(--dsw-alias-state-success)}.vyiEUa_progressSegments>span[data-state=failed]{background:var(--dsw-alias-state-danger)}.vyiEUa_progressSegments>span[data-state=cancelled]{opacity:.55}.vyiEUa_progressLegend{color:var(--dsw-alias-label-tertiary);gap:10px;font-size:9px;line-height:14px;display:flex}.vyiEUa_progressLegend>span[data-state=running]{color:var(--dsw-alias-state-business-primary)}.vyiEUa_progressLegend>span[data-state=blocked]{color:var(--dsw-alias-state-warning)}.vyiEUa_progressLegend>span[data-state=completed]{color:var(--dsw-alias-state-success)}.vyiEUa_progressSummary{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));min-width:0;color:var(--dsw-alias-label-secondary);border-radius:8px;align-items:center;gap:6px;padding:5px 8px;font-size:10px;font-weight:600;line-height:15px;display:flex}.vyiEUa_progressSummary[data-state=warning]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 8%, var(--dsw-alias-bg-module))}.vyiEUa_progressSummary[data-state=completed]{background:color-mix(in srgb, var(--dsw-alias-state-success) 8%, var(--dsw-alias-bg-module))}.vyiEUa_progressSummary>span:last-child{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.vyiEUa_progressSummaryDot{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:5px;height:5px}.vyiEUa_progressSummary[data-state=warning] .vyiEUa_progressSummaryDot{background:var(--dsw-alias-state-warning)}.vyiEUa_progressSummary[data-state=completed] .vyiEUa_progressSummaryDot{background:var(--dsw-alias-state-success)}.vyiEUa_membersToggle{background:var(--dsw-alias-bg-module-platform);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.vyiEUa_membersToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.vyiEUa_membersToggle>span{align-items:center;gap:5px;display:inline-flex}.vyiEUa_membersToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.vyiEUa_historyToggle{background:var(--dsw-alias-bg-module);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.vyiEUa_historyToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.vyiEUa_historyToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.vyiEUa_chevron{flex:none;transition:transform .12s}.vyiEUa_chevron[data-open=true]{transform:rotate(90deg)}.vyiEUa_delegationTree{flex-direction:column;gap:2px;margin-left:18px;padding:0 0 0 20px;display:flex;position:relative}.vyiEUa_delegationTree:before{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));content:\"\";width:1px;position:absolute;top:0;bottom:22px;left:0}.vyiEUa_memberBlock{flex-direction:column;min-width:0;padding:3px 0 7px;display:flex;position:relative}.vyiEUa_memberBranch{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));width:20px;height:1px;display:block;position:absolute;top:27px;right:100%}.vyiEUa_memberBranch:before{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:5px;height:5px;position:absolute;top:-2px;right:-1px}.vyiEUa_memberRow{box-sizing:border-box;width:100%;min-width:0;min-height:48px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:46px minmax(0,1fr) auto;align-items:center;gap:8px;padding:4px 6px;transition:background-color .12s,transform .12s;display:grid}.vyiEUa_memberRow:hover,.vyiEUa_memberRow[data-activity=working]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.vyiEUa_memberRow:active{transform:scale(.99)}.vyiEUa_memberAvatar{width:42px;height:42px}.vyiEUa_memberAvatar[data-unread=true]:after{box-sizing:border-box;border:1px solid var(--dsw-alias-bg-module);background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:6px;height:6px;animation:1.8s ease-in-out infinite vyiEUa_agentTeamsUnreadPulse;position:absolute;top:0;right:-1px}@keyframes vyiEUa_agentTeamsUnreadPulse{0%,to{opacity:.78;transform:scale(.92)}50%{opacity:1;transform:scale(1.16)}}.vyiEUa_memberInitial{background:var(--dsw-alias-bg-fill-business);width:38px;height:38px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:15px;font-weight:600;line-height:20px;display:inline-flex}.vyiEUa_stateArt{box-sizing:border-box;object-fit:contain;width:22px;height:22px;filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #122d483d);background:0 0;border:0;border-radius:0;position:absolute;bottom:-3px;right:-5px}.vyiEUa_stateArt[data-activity=working]{animation:2.4s ease-in-out infinite vyiEUa_agentTeamsFloat}.vyiEUa_stateArt[data-activity=idle]{animation:4.2s ease-in-out infinite vyiEUa_agentTeamsBreathe}.vyiEUa_stateArt[data-activity=unknown]{animation:2.8s ease-in-out infinite vyiEUa_agentTeamsThink}@keyframes vyiEUa_agentTeamsFloat{0%,to{transform:translateY(0)rotate(-4deg)}50%{transform:translateY(-2px)rotate(4deg)}}@keyframes vyiEUa_agentTeamsBreathe{0%,to{opacity:.82;transform:scale(1)}50%{opacity:1;transform:scale(1.06)}}@keyframes vyiEUa_agentTeamsThink{0%,to{transform:rotate(-7deg)}50%{transform:rotate(7deg)}}.vyiEUa_memberRight{flex:none;align-items:center;gap:8px;display:inline-flex}.vyiEUa_memberCount{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}.vyiEUa_assignmentLine{align-items:center;gap:7px;min-width:0;padding:0 6px 0 60px;display:flex}.vyiEUa_assignmentLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:9px;line-height:14px}.vyiEUa_assignmentTasks{flex-wrap:wrap;flex:1;gap:4px;min-width:0;display:flex}.vyiEUa_assignmentChip{background:var(--dsw-alias-bg-fill-neutral);min-height:16px;color:var(--dsw-alias-label-secondary);border-radius:4px;align-items:center;padding:0 5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:600;line-height:14px;display:inline-flex}.vyiEUa_assignmentChip[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.vyiEUa_assignmentChip[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.vyiEUa_assignmentChip[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.vyiEUa_assignmentChip[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.vyiEUa_assignmentChip[data-state=cancelled]{color:var(--dsw-alias-label-tertiary);text-decoration:line-through}.vyiEUa_assignmentChip[data-review=pending]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.vyiEUa_assignmentChip[data-helping=true]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 50%, transparent);outline-offset:-1px}.vyiEUa_reviewChip,.vyiEUa_helpingChip,.vyiEUa_calibrationChip,.vyiEUa_blockedChip,.vyiEUa_inputChip{box-sizing:border-box;white-space:nowrap;min-height:16px;color:inherit;background:0 0;border-radius:4px;flex:none;align-items:center;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.vyiEUa_reviewChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-state-warning) 70%, transparent);outline-offset:-1px}.vyiEUa_blockedChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 75%, transparent);outline-offset:-1px}.vyiEUa_inputChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.vyiEUa_helpingChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 65%, transparent);outline-offset:-1px}.vyiEUa_calibrationChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.vyiEUa_assignmentChip[data-timing=warn]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.vyiEUa_assignmentChip[data-timing=over]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-danger) 62%, transparent);outline-offset:-1px}.vyiEUa_timingChip{box-sizing:border-box;white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:16px;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.vyiEUa_timingChip[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 16%, transparent);color:var(--dsw-alias-state-warning)}.vyiEUa_timingChip[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 16%, transparent);color:var(--dsw-alias-state-danger)}.vyiEUa_unreadPill{color:var(--dsw-alias-state-business-primary);white-space:nowrap;flex:none;font-size:9px;font-weight:600;line-height:14px}.vyiEUa_taskEmpty{color:var(--dsw-alias-label-tertiary);font-size:9px;line-height:14px}.vyiEUa_dependencySection{border-top:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:7px;min-width:0;padding-top:10px;display:flex}.vyiEUa_sectionToggleTitle{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.vyiEUa_dagViewport{scrollbar-width:thin;min-width:0;padding:2px 0 4px;overflow-x:auto}.vyiEUa_dagCanvas{min-width:100%;position:relative}.vyiEUa_dagCanvas[data-layout=parallel]{flex-wrap:wrap;gap:8px;display:flex}.vyiEUa_dagCanvas[data-layout=parallel] .vyiEUa_dagNode{flex:92px;min-width:92px;position:relative}.vyiEUa_dagEdges{pointer-events:none;position:absolute;inset:0;overflow:visible}.vyiEUa_dagEdges path{fill:none;stroke:var(--dsw-alias-line-strong);stroke-width:1px;transition:opacity .12s,stroke .12s,stroke-width .12s}.vyiEUa_dagEdges path[data-active=true]{stroke:var(--dsw-alias-state-business-primary);stroke-width:1.6px}.vyiEUa_dagEdges path[data-dimmed=true]{opacity:.24}.vyiEUa_dagNode{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:6px;flex-direction:column;justify-content:center;gap:1px;padding:0 6px;transition:border-color .12s,background-color .12s,opacity .12s;display:flex;position:absolute}.vyiEUa_dagNode:hover,.vyiEUa_dagNode[data-focused=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.vyiEUa_dagNode[data-dimmed=true]{opacity:.3}.vyiEUa_dagNode[data-state=running][data-dimmed=true]{opacity:.58}.vyiEUa_dagNode[data-state=completed]{border-color:color-mix(in srgb, var(--dsw-alias-state-success) 48%, var(--dsw-alias-line-normal))}.vyiEUa_dagNode[data-state=blocked]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 52%, var(--dsw-alias-line-normal))}.vyiEUa_dagNode[data-review=pending]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.vyiEUa_dagNode[data-helping=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 70%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-business-primary) 38%, transparent)}.vyiEUa_dagNode[data-timing=warn]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.vyiEUa_dagNode[data-timing=over]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-danger) 46%, transparent)}.vyiEUa_dagNode[data-state=failed]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 56%, var(--dsw-alias-line-normal))}.vyiEUa_dagNodeHead{color:var(--dsw-alias-label-primary);align-items:center;gap:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:700;display:flex}.vyiEUa_dagNodeDot{background:var(--dsw-alias-line-strong);border-radius:2px;flex:none;width:5px;height:5px}.vyiEUa_dagNode[data-state=running] .vyiEUa_dagNodeDot{background:var(--dsw-alias-state-business-primary)}.vyiEUa_dagNode[data-state=running] .vyiEUa_dagNodeHead{padding-right:12px}.vyiEUa_dagRunningState{width:9px;height:9px;color:var(--dsw-alias-state-business-primary);pointer-events:none;justify-content:center;align-items:center;display:inline-flex;position:absolute;top:4px;right:5px}.vyiEUa_dagRunningState .vyiEUa_workGlyph{width:9px;height:9px}.vyiEUa_dagNode[data-state=blocked] .vyiEUa_dagNodeDot{background:var(--dsw-alias-state-warning)}.vyiEUa_dagNode[data-state=completed] .vyiEUa_dagNodeDot{background:var(--dsw-alias-state-success)}.vyiEUa_dagNode[data-state=failed] .vyiEUa_dagNodeDot{background:var(--dsw-alias-state-danger)}.vyiEUa_dagNodeLabel{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:11px;overflow:hidden}.vyiEUa_taskDetail{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:8px;flex-direction:column;gap:3px;min-width:0;padding:7px 9px;display:flex}.vyiEUa_taskDetailHead{align-items:center;gap:6px;min-width:0;display:flex}.vyiEUa_taskDetailId{color:var(--dsw-alias-state-business-primary);flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;font-weight:700}.vyiEUa_taskDetailSubject{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.vyiEUa_taskDetailBadge{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:8.5px;font-weight:600;line-height:14px}.vyiEUa_taskDetailBadge[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.vyiEUa_taskDetailBadge[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.vyiEUa_taskDetailBadge[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.vyiEUa_taskDetailBadge[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.vyiEUa_taskDetailLine,.vyiEUa_taskDetailMeta{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.vyiEUa_taskDetailMeta{color:var(--dsw-alias-label-tertiary)}.vyiEUa_archiveAction{color:var(--dsw-alias-state-danger);background:color-mix(in srgb, var(--dsw-alias-state-danger) 12%, transparent);cursor:pointer;border:0;border-radius:5px;padding:3px 6px;font-size:9px}.vyiEUa_archiveAction:disabled{opacity:.55;cursor:not-allowed}.vyiEUa_diagnosticBanner{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-warning) 10%, var(--dsw-alias-bg-module));flex-wrap:wrap;align-items:flex-start;gap:6px 8px;padding:7px 10px;font-size:11px;line-height:16px;display:flex}.vyiEUa_diagnosticBanner button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-fill-neutral);cursor:pointer;border:0;border-radius:4px;padding:2px 6px}.vyiEUa_archiveConfirm{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-danger) 10%, var(--dsw-alias-background-base));justify-content:space-between;gap:8px;padding:7px 10px;font-size:10px;display:flex}.vyiEUa_archiveConfirmActions{gap:5px;display:flex}.vyiEUa_archiveConfirmActions button{cursor:pointer;border:0;border-radius:4px;padding:3px 6px}.vyiEUa_connectionStatus{color:var(--dsw-alias-label-tertiary);margin-left:5px;font-size:9px;font-weight:400}.vyiEUa_connectionStatus[data-connection=stale],.vyiEUa_connectionStatus[data-connection=offline],.vyiEUa_connectionStatus[data-connection=auth-failed]{color:var(--dsw-alias-state-warning)}.vyiEUa_taskDetailActions{gap:6px;margin-top:3px;display:flex}.vyiEUa_taskDetailActions button{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;padding:1px 4px;font-size:9px}.vyiEUa_taskDetailTiming{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.vyiEUa_taskDetailTiming[data-timing=warn]{color:var(--dsw-alias-state-warning)}.vyiEUa_taskDetailTiming[data-timing=over]{color:var(--dsw-alias-state-danger);font-weight:600}.vyiEUa_taskDetailBudgetFact{color:var(--dsw-alias-label-secondary);font-size:11px;line-height:16px}.vyiEUa_taskDetailBudgetFact[data-budget-fact=over_budget]{color:var(--dsw-alias-state-warning);font-weight:700}.vyiEUa_taskDetailBudgetFact[data-budget-fact=within_budget]{color:var(--dsw-alias-state-success)}.vyiEUa_taskDetailSignals,.vyiEUa_taskDetailRetro{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:13px;overflow:hidden}.vyiEUa_taskDetail[data-expanded] .vyiEUa_taskDetailSignals,.vyiEUa_taskDetail[data-expanded] .vyiEUa_taskDetailRetro{overflow-wrap:anywhere;text-overflow:clip;white-space:normal;font-size:12px;line-height:18px;overflow:visible}.vyiEUa_taskDetail[data-expanded] .vyiEUa_taskDetailActions{margin-top:7px}.vyiEUa_taskDetailActions button{min-height:32px}.vyiEUa_taskDetailActions button:focus-visible,.vyiEUa_archiveAction:focus-visible,.vyiEUa_archiveConfirmActions button:focus-visible{outline:2px solid var(--dsw-alias-state-primary);outline-offset:2px}.vyiEUa_taskDetailRetro[data-cause=underestimated],.vyiEUa_taskDetailRetro[data-cause=dependency-blocked]{color:var(--dsw-alias-state-danger)}.vyiEUa_taskDetailRetro[data-cause=on_time]{color:var(--dsw-alias-state-success)}.vyiEUa_taskDetailReview{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:600;line-height:14px}.vyiEUa_taskDetailReview[data-verdict=pass]{color:var(--dsw-alias-state-success)}.vyiEUa_taskDetailReview[data-verdict=reject]{color:var(--dsw-alias-state-danger)}.vyiEUa_taskDetailCalibration{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.vyiEUa_taskDetailBlocked{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:700;line-height:14px}.vyiEUa_taskDetailInput{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.vyiEUa_emptyHint{color:var(--dsw-alias-label-tertiary);padding:10px 14px;font-size:11px;line-height:16px}.vyiEUa_modeHint{color:var(--dsw-alias-label-secondary);padding:0 14px 6px;font-size:11px;line-height:16px;display:block}.vyiEUa_modeBadge{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 7px;font-size:11px;font-weight:600;line-height:16px}.vyiEUa_modeBadge[data-mode=light]{color:var(--dsw-alias-label-secondary)}.vyiEUa_modeBadge[data-mode=standard]{color:var(--dsw-alias-state-business-primary)}.vyiEUa_modeBadge[data-mode=governed]{color:var(--dsw-alias-state-warning)}.vyiEUa_historicPill{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;margin-left:auto;padding:1px 7px;font-size:9px;font-weight:600;line-height:15px}.vyiEUa_members{flex-direction:column;gap:3px;display:flex}.vyiEUa_archiveLabel{color:var(--dsw-alias-label-tertiary);padding:5px 14px 0;font-size:9px;font-weight:600;line-height:14px;display:block}.vyiEUa_archiveFilterBar{flex-wrap:wrap;align-items:center;gap:6px 8px;padding:6px 14px 2px;display:flex}.vyiEUa_archiveFilterField{color:var(--dsw-alias-label-tertiary);align-items:center;gap:4px;font-size:9px;line-height:14px;display:inline-flex}.vyiEUa_archiveFilterCaption{white-space:nowrap;font-weight:600}.vyiEUa_archiveSelect{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:120px;color:var(--dsw-alias-label-primary);border-radius:4px;padding:1px 2px;font-size:9px;line-height:14px}.vyiEUa_archiveFilterCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;margin-left:auto;font-size:9px}.vyiEUa_archiveEmpty{color:var(--dsw-alias-label-tertiary);padding:4px 14px 2px;font-size:9px;display:block}@media (prefers-reduced-motion:reduce){.vyiEUa_panel,.vyiEUa_badge,.vyiEUa_badgeDot,.vyiEUa_panelDot,.vyiEUa_workGlyph rect,.vyiEUa_stateArt,.vyiEUa_memberAvatar[data-unread=true]:after{transition:none;animation:none}}@media (width<=960px){html[data-agent-team-web-panel-open] div[data-phase]{padding-right:0}.vyiEUa_team{padding:12px 12px 14px}.vyiEUa_delegationTree{margin-left:12px;padding-left:15px}.vyiEUa_memberBranch{width:15px}}@media (width<=640px){.vyiEUa_badge{top:56px;right:10px}.vyiEUa_teamStats span[data-stat=messages]{display:none}.vyiEUa_captainNode{grid-template-columns:48px minmax(0,1fr)}.vyiEUa_captainState{display:none}.vyiEUa_assignmentLine{padding-left:60px}}.vyiEUa_healthChip{box-sizing:border-box;background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;flex:none;align-items:center;gap:5px;padding:1px 8px;font-size:11px;line-height:16px;display:inline-flex}.vyiEUa_healthChip strong{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:11px;font-weight:700}.vyiEUa_healthChip em{color:var(--dsw-alias-label-secondary);font-style:normal}.vyiEUa_healthChip[data-level=ok] strong{color:var(--dsw-alias-state-success)}.vyiEUa_healthChip[data-level=warn] strong{color:var(--dsw-alias-state-warning)}.vyiEUa_healthChip[data-level=critical] strong,.vyiEUa_riskStat{color:var(--dsw-alias-state-danger)}.vyiEUa_prioritySection{flex-direction:column;gap:5px;min-width:0;display:flex}.vyiEUa_priorityCard{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);border-radius:8px;align-items:flex-start;gap:8px;padding:6px 8px;display:flex}.vyiEUa_priorityCard[data-severity=high]{border-color:color-mix(in srgb,var(--dsw-alias-state-danger) 45%,var(--dsw-alias-line-normal))}.vyiEUa_priorityCard[data-severity=medium]{border-color:color-mix(in srgb,var(--dsw-alias-state-warning) 40%,var(--dsw-alias-line-normal))}.vyiEUa_priorityBadge{background:var(--dsw-alias-bg-fill-business);min-width:22px;height:18px;color:var(--dsw-alias-label-on-fill);border-radius:6px;flex:none;justify-content:center;align-items:center;font-size:11px;font-weight:700;display:inline-flex}.vyiEUa_priorityBody{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.vyiEUa_priorityTitle{flex-wrap:wrap;align-items:center;gap:5px;min-width:0;display:flex}.vyiEUa_priorityTitle strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.vyiEUa_chip{background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;padding:0 6px;font-size:11px;font-style:normal;font-weight:600;line-height:16px;display:inline-flex}.vyiEUa_chip[data-readiness=blocked],.vyiEUa_chip[data-readiness=orphaned],.vyiEUa_chip[data-readiness=stalled],.vyiEUa_chip[data-readiness=failed],.vyiEUa_chip[data-severity=high]{border-color:var(--dsw-alias-state-danger);color:var(--dsw-alias-state-danger)}.vyiEUa_chip[data-severity=medium],.vyiEUa_chip[data-readiness=ready]{border-color:var(--dsw-alias-state-warning);color:var(--dsw-alias-state-warning)}.vyiEUa_chip[data-severity=low],.vyiEUa_chip[data-readiness=cancelled]{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary)}.vyiEUa_priorityReasons{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.vyiEUa_milestoneRow{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;line-height:16px;display:flex}.vyiEUa_milestoneRow strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-weight:600;overflow:hidden}.vyiEUa_loadBar{background:var(--dsw-alias-line-strong);border-radius:999px;flex:none;align-items:stretch;width:44px;min-width:0;height:6px;display:inline-flex;overflow:hidden}.vyiEUa_loadBar>span{display:block}.vyiEUa_loadActive{background:var(--dsw-alias-state-business-primary)}.vyiEUa_loadPending{background:var(--dsw-alias-state-warning)}.vyiEUa_loadStalled,.vyiEUa_loadOrphaned{background:var(--dsw-alias-state-danger)}";
		...
		var ActivityPanel_module_css_default = {
			"agentTeamsBreathe": "vyiEUa_agentTeamsBreathe",
			"agentTeamsDot": "vyiEUa_agentTeamsDot",
			"agentTeamsFloat": "vyiEUa_agentTeamsFloat",
			"agentTeamsPanelIn": "vyiEUa_agentTeamsPanelIn",
			"agentTeamsPulse": "vyiEUa_agentTeamsPulse",
			"agentTeamsThink": "vyiEUa_agentTeamsThink",
			"agentTeamsUnreadPulse": "vyiEUa_agentTeamsUnreadPulse",
			"archiveAction": "vyiEUa_archiveAction",
			"archiveConfirm": "vyiEUa_archiveConfirm",
			"archiveConfirmActions": "vyiEUa_archiveConfirmActions",
			"archiveEmpty": "vyiEUa_archiveEmpty",
			"archiveFilterBar": "vyiEUa_archiveFilterBar",
			"archiveFilterCaption": "vyiEUa_archiveFilterCaption",
			"archiveFilterCount": "vyiEUa_archiveFilterCount",
			"archiveFilterField": "vyiEUa_archiveFilterField",
			"archiveLabel": "vyiEUa_archiveLabel",
			"archiveSelect": "vyiEUa_archiveSelect",
			"assignmentChip": "vyiEUa_assignmentChip",
			"assignmentLabel": "vyiEUa_assignmentLabel",
			"assignmentLine": "vyiEUa_assignmentLine",
			"assignmentTasks": "vyiEUa_assignmentTasks",
			"badge": "vyiEUa_badge",
			"badgeCount": "vyiEUa_badgeCount",
			"badgeDot": "vyiEUa_badgeDot",
			"blockedChip": "vyiEUa_blockedChip",
			"calibrationChip": "vyiEUa_calibrationChip",
			"captainAvatar": "vyiEUa_captainAvatar",
			"captainInfo": "vyiEUa_captainInfo",
			"captainLine": "vyiEUa_captainLine",
			"captainName": "vyiEUa_captainName",
			"captainNode": "vyiEUa_captainNode",
			"captainRole": "vyiEUa_captainRole",
			"captainState": "vyiEUa_captainState",
			"captainSummary": "vyiEUa_captainSummary",
			"chevron": "vyiEUa_chevron",
			"chip": "vyiEUa_chip",
			"closeError": "vyiEUa_closeError",
			"commandLayer": "vyiEUa_commandLayer",
			"commissarNode": "vyiEUa_commissarNode",
			"commissarState": "vyiEUa_commissarState",
			"connectionStatus": "vyiEUa_connectionStatus",
			"dagCanvas": "vyiEUa_dagCanvas",
			"dagEdges": "vyiEUa_dagEdges",
			"dagNode": "vyiEUa_dagNode",
			"dagNodeDot": "vyiEUa_dagNodeDot",
			"dagNodeHead": "vyiEUa_dagNodeHead",
			"dagNodeLabel": "vyiEUa_dagNodeLabel",
			"dagRunningState": "vyiEUa_dagRunningState",
			"dagViewport": "vyiEUa_dagViewport",
			"delegationSection": "vyiEUa_delegationSection",
			"delegationTree": "vyiEUa_delegationTree",
			"dependencySection": "vyiEUa_dependencySection",
			"diagnosticBanner": "vyiEUa_diagnosticBanner",
			"emptyHint": "vyiEUa_emptyHint",
			"healthChip": "vyiEUa_healthChip",
			"helpingChip": "vyiEUa_helpingChip",
			"historicPill": "vyiEUa_historicPill",
			"historyToggle": "vyiEUa_historyToggle",
			"iconButton": "vyiEUa_iconButton",
			"inputChip": "vyiEUa_inputChip",
			"leadAvatar": "vyiEUa_leadAvatar",
			"loadActive": "vyiEUa_loadActive",
			"loadBar": "vyiEUa_loadBar",
			"loadOrphaned": "vyiEUa_loadOrphaned",
			"loadPending": "vyiEUa_loadPending",
			"loadStalled": "vyiEUa_loadStalled",
			"memberArt": "vyiEUa_memberArt",
			"memberAvatar": "vyiEUa_memberAvatar",
			"memberBlock": "vyiEUa_memberBlock",
			"memberBranch": "vyiEUa_memberBranch",
			"memberCount": "vyiEUa_memberCount",
			"memberElapsed": "vyiEUa_memberElapsed",
			"memberInfo": "vyiEUa_memberInfo",
			"memberInitial": "vyiEUa_memberInitial",
			"memberLine": "vyiEUa_memberLine",
			"memberModel": "vyiEUa_memberModel",
			"memberName": "vyiEUa_memberName",
			"memberRight": "vyiEUa_memberRight",
			"memberRole": "vyiEUa_memberRole",
			"memberRow": "vyiEUa_memberRow",
			"memberState": "vyiEUa_memberState",
			"memberStatusLine": "vyiEUa_memberStatusLine",
			"members": "vyiEUa_members",
			"membersToggle": "vyiEUa_membersToggle",
			"milestoneRow": "vyiEUa_milestoneRow",
			"modeBadge": "vyiEUa_modeBadge",
			"modeHint": "vyiEUa_modeHint",
			"panel": "vyiEUa_panel",
			"panelControls": "vyiEUa_panelControls",
			"panelDot": "vyiEUa_panelDot",
			"panelHead": "vyiEUa_panelHead",
			"panelTitle": "vyiEUa_panelTitle",
			"priorityBadge": "vyiEUa_priorityBadge",
			"priorityBody": "vyiEUa_priorityBody",
			"priorityCard": "vyiEUa_priorityCard",
			"priorityReasons": "vyiEUa_priorityReasons",
			"prioritySection": "vyiEUa_prioritySection",
			"priorityTitle": "vyiEUa_priorityTitle",
			"progressEmpty": "vyiEUa_progressEmpty",
			"progressLegend": "vyiEUa_progressLegend",
			"progressOverview": "vyiEUa_progressOverview",
			"progressSegments": "vyiEUa_progressSegments",
			"progressSummary": "vyiEUa_progressSummary",
			"progressSummaryDot": "vyiEUa_progressSummaryDot",
			"progressTitle": "vyiEUa_progressTitle",
			"resizeHandle": "vyiEUa_resizeHandle",
			"reviewChip": "vyiEUa_reviewChip",
			"riskStat": "vyiEUa_riskStat",
			"sectionHead": "vyiEUa_sectionHead",
			"sectionHint": "vyiEUa_sectionHint",
			"sectionTitle": "vyiEUa_sectionTitle",
			"sectionToggleTitle": "vyiEUa_sectionToggleTitle",
			"stageLabel": "vyiEUa_stageLabel",
			"stateArt": "vyiEUa_stateArt",
			"taskDetail": "vyiEUa_taskDetail",
			"taskDetailActions": "vyiEUa_taskDetailActions",
			"taskDetailBadge": "vyiEUa_taskDetailBadge",
			"taskDetailBlocked": "vyiEUa_taskDetailBlocked",
			"taskDetailBudgetFact": "vyiEUa_taskDetailBudgetFact",
			"taskDetailCalibration": "vyiEUa_taskDetailCalibration",
			"taskDetailHead": "vyiEUa_taskDetailHead",
			"taskDetailId": "vyiEUa_taskDetailId",
			"taskDetailInput": "vyiEUa_taskDetailInput",
			"taskDetailLine": "vyiEUa_taskDetailLine",
			"taskDetailMeta": "vyiEUa_taskDetailMeta",
			"taskDetailRetro": "vyiEUa_taskDetailRetro",
			"taskDetailReview": "vyiEUa_taskDetailReview",
			"taskDetailSignals": "vyiEUa_taskDetailSignals",
			"taskDetailSubject": "vyiEUa_taskDetailSubject",
			"taskDetailTiming": "vyiEUa_taskDetailTiming",
			"taskEmpty": "vyiEUa_taskEmpty",
			"taskId": "vyiEUa_taskId",
			"team": "vyiEUa_team",
			"teamHead": "vyiEUa_teamHead",
			"teamName": "vyiEUa_teamName",
			"teamStats": "vyiEUa_teamStats",
			"teams": "vyiEUa_teams",
			"timingChip": "vyiEUa_timingChip",
			"unreadPill": "vyiEUa_unreadPill",
			"workGlyph": "vyiEUa_workGlyph"
		};
		//#endregion
		...
		*/
		...
		const cssText = ".dlRz1q_section{flex-direction:column;gap:14px;display:flex}.dlRz1q_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:10px;padding:14px 16px;display:flex}.dlRz1q_head{align-items:center;gap:8px;display:flex}.dlRz1q_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.dlRz1q_list{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.dlRz1q_row{box-sizing:border-box;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;min-width:0;min-height:36px;padding:0 10px;display:flex}.dlRz1q_nameWrap{flex:1;align-items:center;gap:8px;min-width:0;display:flex}.dlRz1q_name{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.dlRz1q_rowSub{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;line-height:16px}.dlRz1q_pill{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.dlRz1q_switch{box-sizing:border-box;background:var(--dsw-alias-border-l2);cursor:pointer;border:none;border-radius:999px;flex:none;width:32px;height:18px;padding:0;transition:background .12s ease-in-out;position:relative}.dlRz1q_switch[data-on=true]{background:var(--dsw-alias-state-business-primary)}.dlRz1q_switch:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.dlRz1q_switchThumb{background:var(--dsw-alias-bg-layer-1);border-radius:50%;width:14px;height:14px;transition:transform .12s ease-in-out;position:absolute;top:2px;left:2px}.dlRz1q_switch[data-on=true] .dlRz1q_switchThumb{transform:translate(14px)}.dlRz1q_select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;max-width:200px;color:var(--dsw-alias-label-primary);border-radius:6px;flex:1;padding:2px 4px;font-size:11px;line-height:16px}.dlRz1q_select:disabled{opacity:.55}@media (prefers-color-scheme:dark){.dlRz1q_select{color:#e8e8e8;background:#26282b}}.dlRz1q_resetBtn{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;flex:none;margin-left:auto;padding:2px 10px;font-size:11px;line-height:16px;transition:color .12s ease-in-out,border-color .12s ease-in-out}.dlRz1q_resetBtn:hover:not(:disabled){border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.dlRz1q_resetBtn:disabled{opacity:.45;cursor:default}.dlRz1q_presetPopover{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 56%, transparent);border-radius:10px;flex-direction:column;gap:8px;margin:2px 0 10px;padding:10px;display:flex}.dlRz1q_presetTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}.dlRz1q_presetHelp{color:var(--dsw-alias-label-tertiary);margin:0;font-size:11px;line-height:16px}.dlRz1q_presetTabs{flex-wrap:wrap;gap:6px;display:flex}.dlRz1q_presetTab{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:999px;padding:3px 8px;font-size:11px;line-height:16px}.dlRz1q_presetTab[data-active=true]{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.dlRz1q_presetList{flex-direction:column;gap:6px;display:flex}.dlRz1q_presetItem{border:1px solid var(--dsw-alias-border-l2);color:inherit;text-align:left;cursor:pointer;background:0 0;border-radius:8px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.dlRz1q_presetItem[data-active=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.dlRz1q_presetItemHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.dlRz1q_presetItemName{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:600;line-height:16px}.dlRz1q_presetMetaRow{flex-wrap:wrap;gap:6px;display:flex}.dlRz1q_presetMetaChip{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 46%, transparent);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 6px;font-size:10px;line-height:15px}.dlRz1q_presetItemDesc{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.dlRz1q_presetDiffBadge{color:var(--dsw-alias-label-secondary);flex:none;font-size:10px;line-height:15px}.dlRz1q_presetActions{justify-content:flex-end;gap:8px;display:flex}.dlRz1q_presetActionGhost,.dlRz1q_presetActionPrimary{cursor:pointer;border-radius:6px;padding:3px 10px;font-size:11px;line-height:16px}.dlRz1q_presetActionGhost{color:var(--dsw-alias-label-secondary);background:0 0;border:1px solid #0000}.dlRz1q_presetActionPrimary{border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary);color:#fff}.dlRz1q_empty{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 8px;font-size:11px;line-height:16px}.dlRz1q_viewBtn{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex;position:relative}.dlRz1q_viewBtn:hover{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.dlRz1q_viewBtn:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.dlRz1q_modalMask{z-index:100;background:#00000073;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.dlRz1q_modal{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:12px;width:460px;max-width:100%;padding:16px;box-shadow:0 12px 40px #00000080}.dlRz1q_modalHead{align-items:center;gap:8px;margin-bottom:12px;display:flex}.dlRz1q_modalTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.dlRz1q_modalClose{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;margin-left:auto;padding:2px 6px;font-size:13px;line-height:16px}.dlRz1q_modalClose:hover{color:var(--dsw-alias-label-primary);background:#ffffff0f}.dlRz1q_roleSlogan{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, transparent);color:var(--dsw-alias-state-business-primary);border-radius:8px;padding:8px 10px;font-size:13px;font-weight:500;line-height:20px}.dlRz1q_modalSectionTitle{color:var(--dsw-alias-label-tertiary);margin:12px 0 6px;font-size:11px;line-height:16px}.dlRz1q_dutyRow{gap:8px;padding:6px 10px;font-size:12px;line-height:20px;display:flex}.dlRz1q_dutyRow+.dlRz1q_dutyRow{border-top:1px dashed var(--dsw-alias-border-l2)}.dlRz1q_dutyStep{color:var(--dsw-alias-label-secondary);flex:none;font-weight:500}.dlRz1q_dutyDesc{color:var(--dsw-alias-label-primary)}.dlRz1q_modalKv{align-items:center;gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.dlRz1q_modalK{width:72px;color:var(--dsw-alias-label-tertiary);flex:none}.dlRz1q_modalV{color:var(--dsw-alias-label-secondary);flex:1;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}.dlRz1q_modalEmpty{color:var(--dsw-alias-label-tertiary);padding:6px 10px;font-size:12px;line-height:20px}.dlRz1q_modalBody{max-height:min(52vh,420px);margin-right:-4px;padding-right:4px;overflow:auto}.dlRz1q_ruleRow{gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.dlRz1q_ruleBullet{color:var(--dsw-alias-state-business-primary);flex:none}.dlRz1q_growthStat{color:var(--dsw-alias-label-primary);margin:0 0 8px;padding:0 10px;font-size:12px;line-height:20px}.dlRz1q_growthList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.dlRz1q_growthItem{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 40%, transparent);border-radius:8px;flex-direction:column;gap:2px;padding:8px 10px;display:flex}.dlRz1q_growthPractice{color:var(--dsw-alias-label-primary);font-size:12px;line-height:20px}.dlRz1q_growthMeta{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}";
		...
		var ProviderGrantsSection_module_css_default = {
			"card": "dlRz1q_card",
			"dutyDesc": "dlRz1q_dutyDesc",
			"dutyRow": "dlRz1q_dutyRow",
			"dutyStep": "dlRz1q_dutyStep",
			"empty": "dlRz1q_empty",
			"growthItem": "dlRz1q_growthItem",
			"growthList": "dlRz1q_growthList",
			"growthMeta": "dlRz1q_growthMeta",
			"growthPractice": "dlRz1q_growthPractice",
			"growthStat": "dlRz1q_growthStat",
			"head": "dlRz1q_head",
			"list": "dlRz1q_list",
			"modal": "dlRz1q_modal",
			"modalBody": "dlRz1q_modalBody",
			"modalClose": "dlRz1q_modalClose",
			"modalEmpty": "dlRz1q_modalEmpty",
			"modalHead": "dlRz1q_modalHead",
			"modalK": "dlRz1q_modalK",
			"modalKv": "dlRz1q_modalKv",
			"modalMask": "dlRz1q_modalMask",
			"modalSectionTitle": "dlRz1q_modalSectionTitle",
			"modalTitle": "dlRz1q_modalTitle",
			"modalV": "dlRz1q_modalV",
			"name": "dlRz1q_name",
			"nameWrap": "dlRz1q_nameWrap",
			"pill": "dlRz1q_pill",
			"presetActionGhost": "dlRz1q_presetActionGhost",
			"presetActionPrimary": "dlRz1q_presetActionPrimary",
			"presetActions": "dlRz1q_presetActions",
			"presetDiffBadge": "dlRz1q_presetDiffBadge",
			"presetHelp": "dlRz1q_presetHelp",
			"presetItem": "dlRz1q_presetItem",
			"presetItemDesc": "dlRz1q_presetItemDesc",
			"presetItemHead": "dlRz1q_presetItemHead",
			"presetItemName": "dlRz1q_presetItemName",
			"presetList": "dlRz1q_presetList",
			"presetMetaChip": "dlRz1q_presetMetaChip",
			"presetMetaRow": "dlRz1q_presetMetaRow",
			"presetPopover": "dlRz1q_presetPopover",
			"presetTab": "dlRz1q_presetTab",
			"presetTabs": "dlRz1q_presetTabs",
			"presetTitle": "dlRz1q_presetTitle",
			"resetBtn": "dlRz1q_resetBtn",
			"roleSlogan": "dlRz1q_roleSlogan",
			"row": "dlRz1q_row",
			"rowSub": "dlRz1q_rowSub",
			"ruleBullet": "dlRz1q_ruleBullet",
			"ruleRow": "dlRz1q_ruleRow",
			"section": "dlRz1q_section",
			"select": "dlRz1q_select",
			"switch": "dlRz1q_switch",
			"switchThumb": "dlRz1q_switchThumb",
			"title": "dlRz1q_title",
			"viewBtn": "dlRz1q_viewBtn"
		};
		//#endregion
		...
		* 右上「恢复默认」;模型下拉按 provider 分组)。 */
		...
		function GrowthCard({ growth, t }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				}), growth.total === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					className: ProviderGrantsSection_module_css_default.empty,
					children: t("settings.agentTeam.growthEmpty")
				}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					className: ProviderGrantsSection_module_css_default.growthStat,
					children: t("settings.agentTeam.growthCount", {
						total: growth.total,
						calibrated: growth.calibrated
					})
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
					className: ProviderGrantsSection_module_css_default.growthList,
					children: growth.recent.map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
		...
		function ProviderGrantsSection(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [providerRows.length === 0 && roleRows.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					...
					snapshot,
					t
				})] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GrowthCard, {
					growth: center.selfGrowth,
					t
				})]
			});
		}
