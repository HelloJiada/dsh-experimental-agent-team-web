	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"settings.agentTeam.modelGrant": "模型调度授权",
		...
		const en = {
			...
			"settings.agentTeam.title": "AgentTeam",
			"settings.agentTeam.modelGrant": "Model access",
		...
		*/
		...
		const cssText$2 = ".-QcRcG_root{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:8px;width:100%;min-width:0;padding:10px 12px;display:flex}.-QcRcG_head{align-items:center;gap:8px;min-width:0;display:flex}.-QcRcG_leadAvatar{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0;flex:none;width:30px;height:30px}.-QcRcG_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.-QcRcG_memberCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;margin-left:auto;font-size:11px;line-height:16px}.-QcRcG_panelButton{border:1px solid var(--dsw-alias-line-strong);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;flex:none;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:16px;transition:border-color .12s,color .12s}.-QcRcG_panelButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.-QcRcG_panelButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.-QcRcG_members{flex-wrap:wrap;gap:6px;min-width:0;display:flex}.-QcRcG_member{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:160px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:5px;padding:3px 8px 3px 3px;font-size:11px;font-weight:500;line-height:16px;transition:border-color .12s,background-color .12s;display:inline-flex}.-QcRcG_member:hover{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-fill-neutral)}.-QcRcG_member:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.-QcRcG_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d482e);background:0 0;border:0;border-radius:0;width:24px;height:24px}.-QcRcG_memberInitial{background:var(--dsw-alias-bg-fill-business);width:20px;height:20px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:10px;font-weight:600;line-height:20px;display:inline-flex}.-QcRcG_memberName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}";
		...
		var AgentTeamsCard_module_css_default = {
			"head": "-QcRcG_head",
			"leadAvatar": "-QcRcG_leadAvatar",
			"member": "-QcRcG_member",
			"memberArt": "-QcRcG_memberArt",
			"memberCount": "-QcRcG_memberCount",
			"memberInitial": "-QcRcG_memberInitial",
			"memberName": "-QcRcG_memberName",
			"members": "-QcRcG_members",
			"panelButton": "-QcRcG_panelButton",
			"root": "-QcRcG_root",
			"teamName": "-QcRcG_teamName"
		};
		//#endregion
		...
		*/
		...
		const cssText$1 = "html{--agent-team-web-panel-shift:420px}html[data-agent-team-web-panel-open] div[data-phase]{box-sizing:border-box;padding-right:var(--agent-team-web-panel-shift)}.JDFXXG_badge,.JDFXXG_panel{--at-bg-panel:#fff;--at-bg-raised:#fafbfc;--at-bg-fill:#f4f6f9;--at-border:#e8ebf0;--at-border-strong:#d9dee8;--at-text-primary:#1b1f27;--at-text-secondary:#5a6474;--at-text-tertiary:#8f97a6;--at-accent:#2d5ca8;--at-accent-hover:#3568b8;--at-accent-strong:#244a8a;--at-success:#15875a;--at-warning:#a4681a;--at-danger:#c23b42;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #17203014;--at-shadow-panel:0 12px 32px #17203012, 0 32px 72px #1720301c;--at-shadow-active:0 16px 40px #1720301a, 0 36px 80px #17203024;--dsw-alias-bg-module:var(--at-bg-panel);--dsw-alias-bg-module-platform:var(--at-bg-raised);--dsw-alias-bg-fill-neutral:var(--at-bg-fill);--dsw-alias-bg-fill-business:var(--at-accent);--dsw-alias-bg-fill-success:var(--at-success);--dsw-alias-bg-fill-warning:var(--at-warning);--dsw-alias-bg-fill-danger:var(--at-danger);--dsw-alias-state-business-primary:var(--at-accent);--dsw-alias-state-success:var(--at-success);--dsw-alias-state-warning:var(--at-warning);--dsw-alias-state-danger:var(--at-danger);--dsw-alias-label-primary:var(--at-text-primary);--dsw-alias-label-secondary:var(--at-text-secondary);--dsw-alias-label-tertiary:var(--at-text-tertiary);--dsw-alias-label-on-fill:var(--at-on-accent);--dsw-alias-line-normal:var(--at-border);--dsw-alias-line-strong:var(--at-border-strong)}@media (prefers-color-scheme:dark){.JDFXXG_badge,.JDFXXG_panel{--at-bg-panel:#1e1f22;--at-bg-raised:#202125;--at-bg-fill:#2a2c30;--at-border:#2e3136;--at-border-strong:#3a3e45;--at-text-primary:#f5f6f8;--at-text-secondary:#b9bdc6;--at-text-tertiary:#8b90a0;--at-accent:#5b8dd9;--at-accent-hover:#6d9be0;--at-accent-strong:#4a7cc9;--at-success:#3ecf7f;--at-warning:#f0a83c;--at-danger:#f0606a;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #00000073;--at-shadow-panel:0 12px 32px #00000073, 0 32px 72px #0000008c;--at-shadow-active:0 16px 40px #00000080, 0 36px 80px #0009}.JDFXXG_stateArt{filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #00000073)}}.JDFXXG_badge{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:color-mix(in srgb, var(--dsw-alias-bg-module-platform) 92%, transparent);backdrop-filter:blur(16px);height:34px;box-shadow:var(--at-shadow-badge);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:7px;padding:0 12px;font-size:12px;font-weight:600;line-height:20px;transition:border-color .12s,transform .12s;display:inline-flex;position:absolute;top:64px;right:18px}.JDFXXG_badge:hover{border-color:var(--dsw-alias-line-strong);transform:translateY(-1px)}.JDFXXG_badge:active{transform:translateY(0)scale(.97)}.JDFXXG_badge:focus-visible,.JDFXXG_iconButton:focus-visible,.JDFXXG_memberRow:focus-visible,.JDFXXG_membersToggle:focus-visible,.JDFXXG_sectionToggleTitle:focus-visible,.JDFXXG_historyToggle:focus-visible,.JDFXXG_dagNode:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.JDFXXG_badgeDot,.JDFXXG_panelDot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:7px;height:7px}.JDFXXG_badgeDot[data-busy=true],.JDFXXG_panelDot[data-busy=true]{background:var(--dsw-alias-state-business-primary);animation:1.25s ease-in-out infinite JDFXXG_agentTeamsPulse}.JDFXXG_badgeCount,.JDFXXG_memberCount,.JDFXXG_teamStats,.JDFXXG_stageLabel,.JDFXXG_taskId{font-variant-numeric:tabular-nums}.JDFXXG_panel{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-line-strong) 58%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-module) 95%, transparent);backdrop-filter:blur(20px)saturate(1.08);box-shadow:var(--at-shadow-panel);will-change:transform;border-radius:16px;flex-direction:column;animation:.16s ease-out JDFXXG_agentTeamsPanelIn;display:flex;position:absolute;top:0;left:0;overflow:hidden}.JDFXXG_panel[data-dragging],.JDFXXG_panel[data-resizing]{user-select:none;box-shadow:var(--at-shadow-active)}@keyframes JDFXXG_agentTeamsPanelIn{0%{opacity:0}to{opacity:1}}@keyframes JDFXXG_agentTeamsPulse{0%,to{opacity:.42}50%{opacity:1}}.JDFXXG_panelHead{border-bottom:1px solid var(--dsw-alias-line-normal);cursor:grab;touch-action:none;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:0 14px;display:flex}.JDFXXG_panelHead:active,.JDFXXG_panel[data-dragging] .JDFXXG_panelHead{cursor:grabbing}.JDFXXG_panel[data-compact] .JDFXXG_panelHead{cursor:default;touch-action:auto}.JDFXXG_panelTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:8px;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}.JDFXXG_panelControls{flex:none;align-items:center;gap:2px;display:inline-flex}.JDFXXG_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,transform .12s;display:inline-flex}.JDFXXG_iconButton:hover{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-primary)}.JDFXXG_iconButton:active{transform:scale(.94)}.JDFXXG_iconButton[data-control=dock][data-mode=docked] svg{transform:scaleX(-1)}.JDFXXG_iconButton[data-control=close]:hover:not(:disabled){background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.JDFXXG_iconButton[data-control=close]:disabled{opacity:.45;cursor:not-allowed}.JDFXXG_closeError{color:var(--dsw-alias-state-danger);border-top:1px solid var(--dsw-alias-line-normal);padding:4px 14px;font-size:12px;line-height:16px}.JDFXXG_resizeHandle{z-index:1;touch-action:none;position:absolute}.JDFXXG_resizeHandle[data-resize-edge=left]{cursor:ew-resize;width:8px;top:44px;bottom:8px;left:0}.JDFXXG_resizeHandle[data-resize-edge=bottom]{cursor:ns-resize;height:8px;bottom:0;left:12px;right:12px}.JDFXXG_resizeHandle[data-resize-edge=corner]{cursor:nwse-resize;width:18px;height:18px;bottom:0;right:0}.JDFXXG_resizeHandle[data-resize-edge=corner]:after{border-right:1px solid var(--dsw-alias-label-tertiary);border-bottom:1px solid var(--dsw-alias-label-tertiary);content:\"\";opacity:.52;width:7px;height:7px;position:absolute;bottom:4px;right:4px}.JDFXXG_teams{overscroll-behavior:contain;scrollbar-color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent) transparent;scrollbar-width:thin;flex-direction:column;min-height:0;display:flex;overflow-y:auto}.JDFXXG_teams::-webkit-scrollbar{width:6px}.JDFXXG_teams::-webkit-scrollbar-track{background:0 0}.JDFXXG_teams::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent);background-clip:padding-box;border:2px solid #0000;border-radius:999px}.JDFXXG_teams:hover::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 44%, transparent);background-clip:padding-box}.JDFXXG_team{border-bottom:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:12px;padding:12px 14px 14px;display:flex}.JDFXXG_team:last-child{border-bottom:0}.JDFXXG_teamHead{align-items:center;gap:10px;min-width:0;display:flex}.JDFXXG_teamName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}.JDFXXG_teamStats{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;gap:8px;font-size:10px;line-height:16px;display:inline-flex}.JDFXXG_sectionHead{justify-content:space-between;align-items:center;gap:8px;min-width:0;display:flex}.JDFXXG_sectionTitle{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.JDFXXG_sectionHint{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.JDFXXG_delegationSection{flex-direction:column;gap:10px;min-width:0;display:flex}.JDFXXG_captainNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 32%, var(--dsw-alias-line-normal));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid}.JDFXXG_commandLayer{grid-template-columns:1fr;gap:10px;display:grid}.JDFXXG_commandLayer[data-leadership=solo]{grid-template-columns:1fr}.JDFXXG_commissarNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--at-accent) 32%, var(--at-border));background:color-mix(in srgb, var(--at-accent) 5%, var(--at-bg-panel));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid;position:relative}.JDFXXG_commissarNode:before{background:var(--at-accent);content:\"\";border-radius:2px;width:2px;position:absolute;top:8px;bottom:8px;left:0}.JDFXXG_commissarState{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;text-align:right;font-size:10px;line-height:14px;overflow:hidden}.JDFXXG_commissarState[data-activity=working]{color:var(--dsw-alias-state-business-primary);font-weight:600}.JDFXXG_captainAvatar,.JDFXXG_memberAvatar{flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}.JDFXXG_captainAvatar{width:46px;height:46px}.JDFXXG_leadAvatar,.JDFXXG_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0}.JDFXXG_leadAvatar{width:44px;height:44px}.JDFXXG_memberArt{width:40px;height:40px}.JDFXXG_captainInfo,.JDFXXG_memberInfo{flex-direction:column;min-width:0;display:flex}.JDFXXG_captainInfo{gap:2px}.JDFXXG_captainLine,.JDFXXG_memberLine{align-items:center;gap:6px;min-width:0;display:flex}.JDFXXG_captainName,.JDFXXG_memberName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:18px;overflow:hidden}.JDFXXG_captainRole,.JDFXXG_memberRole{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.JDFXXG_memberModel{color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 78%, transparent);text-overflow:ellipsis;white-space:nowrap;flex:none;margin-left:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:8px;line-height:12px;overflow:hidden}.JDFXXG_captainSummary,.JDFXXG_memberStatusLine{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:15px;overflow:hidden}.JDFXXG_memberElapsed{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:4px;flex:none;align-items:center;margin-left:6px;padding:0 4px;font-size:8.5px;font-weight:600;line-height:14px;display:inline-flex}.JDFXXG_memberElapsed[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 14%, transparent);color:var(--dsw-alias-state-warning)}.JDFXXG_memberElapsed[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 14%, transparent);color:var(--dsw-alias-state-danger)}.JDFXXG_captainState,.JDFXXG_memberState{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;align-items:center;gap:5px;font-size:10px;font-weight:500;line-height:15px;display:inline-flex}.JDFXXG_captainState[data-busy=true],.JDFXXG_memberState[data-activity=working]{color:var(--dsw-alias-state-business-primary)}.JDFXXG_workGlyph rect{opacity:.5}.JDFXXG_workGlyph[data-active=true] rect{animation:1.1s ease-in-out infinite JDFXXG_agentTeamsDot}@keyframes JDFXXG_agentTeamsDot{0%,to{opacity:.25}50%{opacity:1}}.JDFXXG_progressOverview{flex-direction:column;gap:7px;display:flex}.JDFXXG_progressTitle{color:var(--dsw-alias-label-secondary);font-size:11px;font-weight:600;line-height:16px}.JDFXXG_progressSegments{gap:3px;display:flex}.JDFXXG_progressSegments>span,.JDFXXG_progressEmpty{background:var(--dsw-alias-line-strong);border-radius:2px;flex:1;height:5px}.JDFXXG_progressEmpty{width:100%;display:block}.JDFXXG_progressSegments>span[data-state=running]{background:var(--dsw-alias-state-business-primary)}.JDFXXG_progressSegments>span[data-state=blocked]{background:var(--dsw-alias-state-warning)}.JDFXXG_progressSegments>span[data-state=completed]{background:var(--dsw-alias-state-success)}.JDFXXG_progressSegments>span[data-state=failed]{background:var(--dsw-alias-state-danger)}.JDFXXG_progressSegments>span[data-state=cancelled]{opacity:.55}.JDFXXG_progressLegend{color:var(--dsw-alias-label-tertiary);gap:10px;font-size:9px;line-height:14px;display:flex}.JDFXXG_progressLegend>span[data-state=running]{color:var(--dsw-alias-state-business-primary)}.JDFXXG_progressLegend>span[data-state=blocked]{color:var(--dsw-alias-state-warning)}.JDFXXG_progressLegend>span[data-state=completed]{color:var(--dsw-alias-state-success)}.JDFXXG_progressSummary{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));min-width:0;color:var(--dsw-alias-label-secondary);border-radius:8px;align-items:center;gap:6px;padding:5px 8px;font-size:10px;font-weight:600;line-height:15px;display:flex}.JDFXXG_progressSummary[data-state=warning]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 8%, var(--dsw-alias-bg-module))}.JDFXXG_progressSummary[data-state=completed]{background:color-mix(in srgb, var(--dsw-alias-state-success) 8%, var(--dsw-alias-bg-module))}.JDFXXG_progressSummary>span:last-child{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.JDFXXG_progressSummaryDot{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:5px;height:5px}.JDFXXG_progressSummary[data-state=warning] .JDFXXG_progressSummaryDot{background:var(--dsw-alias-state-warning)}.JDFXXG_progressSummary[data-state=completed] .JDFXXG_progressSummaryDot{background:var(--dsw-alias-state-success)}.JDFXXG_membersToggle{background:var(--dsw-alias-bg-module-platform);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.JDFXXG_membersToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.JDFXXG_membersToggle>span{align-items:center;gap:5px;display:inline-flex}.JDFXXG_membersToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.JDFXXG_historyToggle{background:var(--dsw-alias-bg-module);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.JDFXXG_historyToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.JDFXXG_historyToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.JDFXXG_chevron{flex:none;transition:transform .12s}.JDFXXG_chevron[data-open=true]{transform:rotate(90deg)}.JDFXXG_delegationTree{flex-direction:column;gap:2px;margin-left:18px;padding:0 0 0 20px;display:flex;position:relative}.JDFXXG_delegationTree:before{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));content:\"\";width:1px;position:absolute;top:0;bottom:22px;left:0}.JDFXXG_memberBlock{flex-direction:column;min-width:0;padding:3px 0 7px;display:flex;position:relative}.JDFXXG_memberBranch{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));width:20px;height:1px;display:block;position:absolute;top:27px;right:100%}.JDFXXG_memberBranch:before{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:5px;height:5px;position:absolute;top:-2px;right:-1px}.JDFXXG_memberRow{box-sizing:border-box;width:100%;min-width:0;min-height:48px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:46px minmax(0,1fr) auto;align-items:center;gap:8px;padding:4px 6px;transition:background-color .12s,transform .12s;display:grid}.JDFXXG_memberRow:hover,.JDFXXG_memberRow[data-activity=working]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.JDFXXG_memberRow:active{transform:scale(.99)}.JDFXXG_memberAvatar{width:42px;height:42px}.JDFXXG_memberAvatar[data-unread=true]:after{box-sizing:border-box;border:1px solid var(--dsw-alias-bg-module);background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:6px;height:6px;animation:1.8s ease-in-out infinite JDFXXG_agentTeamsUnreadPulse;position:absolute;top:0;right:-1px}@keyframes JDFXXG_agentTeamsUnreadPulse{0%,to{opacity:.78;transform:scale(.92)}50%{opacity:1;transform:scale(1.16)}}.JDFXXG_memberInitial{background:var(--dsw-alias-bg-fill-business);width:38px;height:38px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:15px;font-weight:600;line-height:20px;display:inline-flex}.JDFXXG_stateArt{box-sizing:border-box;object-fit:contain;width:22px;height:22px;filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #122d483d);background:0 0;border:0;border-radius:0;position:absolute;bottom:-3px;right:-5px}.JDFXXG_stateArt[data-activity=working]{animation:2.4s ease-in-out infinite JDFXXG_agentTeamsFloat}.JDFXXG_stateArt[data-activity=idle]{animation:4.2s ease-in-out infinite JDFXXG_agentTeamsBreathe}.JDFXXG_stateArt[data-activity=unknown]{animation:2.8s ease-in-out infinite JDFXXG_agentTeamsThink}@keyframes JDFXXG_agentTeamsFloat{0%,to{transform:translateY(0)rotate(-4deg)}50%{transform:translateY(-2px)rotate(4deg)}}@keyframes JDFXXG_agentTeamsBreathe{0%,to{opacity:.82;transform:scale(1)}50%{opacity:1;transform:scale(1.06)}}@keyframes JDFXXG_agentTeamsThink{0%,to{transform:rotate(-7deg)}50%{transform:rotate(7deg)}}.JDFXXG_memberRight{flex:none;align-items:center;gap:8px;display:inline-flex}.JDFXXG_memberCount{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}.JDFXXG_assignmentLine{align-items:center;gap:7px;min-width:0;padding:0 6px 0 60px;display:flex}.JDFXXG_assignmentLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:9px;line-height:14px}.JDFXXG_assignmentTasks{flex-wrap:wrap;flex:1;gap:4px;min-width:0;display:flex}.JDFXXG_assignmentChip{background:var(--dsw-alias-bg-fill-neutral);min-height:16px;color:var(--dsw-alias-label-secondary);border-radius:4px;align-items:center;padding:0 5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:600;line-height:14px;display:inline-flex}.JDFXXG_assignmentChip[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.JDFXXG_assignmentChip[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.JDFXXG_assignmentChip[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.JDFXXG_assignmentChip[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.JDFXXG_assignmentChip[data-state=cancelled]{color:var(--dsw-alias-label-tertiary);text-decoration:line-through}.JDFXXG_assignmentChip[data-review=pending]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.JDFXXG_assignmentChip[data-helping=true]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 50%, transparent);outline-offset:-1px}.JDFXXG_reviewChip,.JDFXXG_helpingChip,.JDFXXG_calibrationChip,.JDFXXG_blockedChip,.JDFXXG_inputChip{box-sizing:border-box;white-space:nowrap;min-height:16px;color:inherit;background:0 0;border-radius:4px;flex:none;align-items:center;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.JDFXXG_reviewChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-state-warning) 70%, transparent);outline-offset:-1px}.JDFXXG_blockedChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 75%, transparent);outline-offset:-1px}.JDFXXG_inputChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.JDFXXG_helpingChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 65%, transparent);outline-offset:-1px}.JDFXXG_calibrationChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.JDFXXG_assignmentChip[data-timing=warn]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.JDFXXG_assignmentChip[data-timing=over]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-danger) 62%, transparent);outline-offset:-1px}.JDFXXG_timingChip{box-sizing:border-box;white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:16px;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.JDFXXG_timingChip[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 16%, transparent);color:var(--dsw-alias-state-warning)}.JDFXXG_timingChip[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 16%, transparent);color:var(--dsw-alias-state-danger)}.JDFXXG_unreadPill{color:var(--dsw-alias-state-business-primary);white-space:nowrap;flex:none;font-size:9px;font-weight:600;line-height:14px}.JDFXXG_taskEmpty{color:var(--dsw-alias-label-tertiary);font-size:9px;line-height:14px}.JDFXXG_dependencySection{border-top:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:7px;min-width:0;padding-top:10px;display:flex}.JDFXXG_sectionToggleTitle{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.JDFXXG_dagViewport{scrollbar-width:thin;min-width:0;padding:2px 0 4px;overflow-x:auto}.JDFXXG_dagCanvas{min-width:100%;position:relative}.JDFXXG_dagCanvas[data-layout=parallel]{flex-wrap:wrap;gap:8px;display:flex}.JDFXXG_dagCanvas[data-layout=parallel] .JDFXXG_dagNode{flex:92px;min-width:92px;position:relative}.JDFXXG_dagEdges{pointer-events:none;position:absolute;inset:0;overflow:visible}.JDFXXG_dagEdges path{fill:none;stroke:var(--dsw-alias-line-strong);stroke-width:1px;transition:opacity .12s,stroke .12s,stroke-width .12s}.JDFXXG_dagEdges path[data-active=true]{stroke:var(--dsw-alias-state-business-primary);stroke-width:1.6px}.JDFXXG_dagEdges path[data-dimmed=true]{opacity:.24}.JDFXXG_dagNode{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:6px;flex-direction:column;justify-content:center;gap:1px;padding:0 6px;transition:border-color .12s,background-color .12s,opacity .12s;display:flex;position:absolute}.JDFXXG_dagNode:hover,.JDFXXG_dagNode[data-focused=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.JDFXXG_dagNode[data-dimmed=true]{opacity:.3}.JDFXXG_dagNode[data-state=running][data-dimmed=true]{opacity:.58}.JDFXXG_dagNode[data-state=completed]{border-color:color-mix(in srgb, var(--dsw-alias-state-success) 48%, var(--dsw-alias-line-normal))}.JDFXXG_dagNode[data-state=blocked]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 52%, var(--dsw-alias-line-normal))}.JDFXXG_dagNode[data-review=pending]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.JDFXXG_dagNode[data-helping=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 70%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-business-primary) 38%, transparent)}.JDFXXG_dagNode[data-timing=warn]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.JDFXXG_dagNode[data-timing=over]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-danger) 46%, transparent)}.JDFXXG_dagNode[data-state=failed]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 56%, var(--dsw-alias-line-normal))}.JDFXXG_dagNodeHead{color:var(--dsw-alias-label-primary);align-items:center;gap:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:700;display:flex}.JDFXXG_dagNodeDot{background:var(--dsw-alias-line-strong);border-radius:2px;flex:none;width:5px;height:5px}.JDFXXG_dagNode[data-state=running] .JDFXXG_dagNodeDot{background:var(--dsw-alias-state-business-primary)}.JDFXXG_dagNode[data-state=running] .JDFXXG_dagNodeHead{padding-right:12px}.JDFXXG_dagRunningState{width:9px;height:9px;color:var(--dsw-alias-state-business-primary);pointer-events:none;justify-content:center;align-items:center;display:inline-flex;position:absolute;top:4px;right:5px}.JDFXXG_dagRunningState .JDFXXG_workGlyph{width:9px;height:9px}.JDFXXG_dagNode[data-state=blocked] .JDFXXG_dagNodeDot{background:var(--dsw-alias-state-warning)}.JDFXXG_dagNode[data-state=completed] .JDFXXG_dagNodeDot{background:var(--dsw-alias-state-success)}.JDFXXG_dagNode[data-state=failed] .JDFXXG_dagNodeDot{background:var(--dsw-alias-state-danger)}.JDFXXG_dagNodeLabel{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:11px;overflow:hidden}.JDFXXG_taskDetail{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:8px;flex-direction:column;gap:3px;min-width:0;padding:7px 9px;display:flex}.JDFXXG_taskDetailHead{align-items:center;gap:6px;min-width:0;display:flex}.JDFXXG_taskDetailId{color:var(--dsw-alias-state-business-primary);flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;font-weight:700}.JDFXXG_taskDetailSubject{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.JDFXXG_taskDetailBadge{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:8.5px;font-weight:600;line-height:14px}.JDFXXG_taskDetailBadge[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.JDFXXG_taskDetailBadge[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.JDFXXG_taskDetailBadge[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.JDFXXG_taskDetailBadge[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.JDFXXG_taskDetailLine,.JDFXXG_taskDetailMeta{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.JDFXXG_taskDetailMeta{color:var(--dsw-alias-label-tertiary)}.JDFXXG_archiveAction{color:var(--dsw-alias-state-danger);background:color-mix(in srgb, var(--dsw-alias-state-danger) 12%, transparent);cursor:pointer;border:0;border-radius:5px;padding:3px 6px;font-size:9px}.JDFXXG_archiveAction:disabled{opacity:.55;cursor:not-allowed}.JDFXXG_diagnosticBanner{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-warning) 10%, var(--dsw-alias-bg-module));flex-wrap:wrap;align-items:flex-start;gap:6px 8px;padding:7px 10px;font-size:11px;line-height:16px;display:flex}.JDFXXG_diagnosticBanner button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-fill-neutral);cursor:pointer;border:0;border-radius:4px;padding:2px 6px}.JDFXXG_archiveConfirm{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-danger) 10%, var(--dsw-alias-background-base));justify-content:space-between;gap:8px;padding:7px 10px;font-size:10px;display:flex}.JDFXXG_archiveConfirmActions{gap:5px;display:flex}.JDFXXG_archiveConfirmActions button{cursor:pointer;border:0;border-radius:4px;padding:3px 6px}.JDFXXG_connectionStatus{color:var(--dsw-alias-label-tertiary);margin-left:5px;font-size:9px;font-weight:400}.JDFXXG_connectionStatus[data-connection=stale],.JDFXXG_connectionStatus[data-connection=offline],.JDFXXG_connectionStatus[data-connection=auth-failed]{color:var(--dsw-alias-state-warning)}.JDFXXG_taskDetailActions{gap:6px;margin-top:3px;display:flex}.JDFXXG_taskDetailActions button{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;padding:1px 4px;font-size:9px}.JDFXXG_taskDetailTiming{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.JDFXXG_taskDetailTiming[data-timing=warn]{color:var(--dsw-alias-state-warning)}.JDFXXG_taskDetailTiming[data-timing=over]{color:var(--dsw-alias-state-danger);font-weight:600}.JDFXXG_taskDetailBudgetFact{color:var(--dsw-alias-label-secondary);font-size:11px;line-height:16px}.JDFXXG_taskDetailBudgetFact[data-budget-fact=over_budget]{color:var(--dsw-alias-state-warning);font-weight:700}.JDFXXG_taskDetailBudgetFact[data-budget-fact=within_budget]{color:var(--dsw-alias-state-success)}.JDFXXG_taskDetailSignals,.JDFXXG_taskDetailRetro{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:13px;overflow:hidden}.JDFXXG_taskDetail[data-expanded] .JDFXXG_taskDetailSignals,.JDFXXG_taskDetail[data-expanded] .JDFXXG_taskDetailRetro{overflow-wrap:anywhere;text-overflow:clip;white-space:normal;font-size:12px;line-height:18px;overflow:visible}.JDFXXG_taskDetail[data-expanded] .JDFXXG_taskDetailActions{margin-top:7px}.JDFXXG_taskDetailActions button{min-height:32px}.JDFXXG_taskDetailActions button:focus-visible,.JDFXXG_archiveAction:focus-visible,.JDFXXG_archiveConfirmActions button:focus-visible{outline:2px solid var(--dsw-alias-state-primary);outline-offset:2px}.JDFXXG_taskDetailRetro[data-cause=underestimated],.JDFXXG_taskDetailRetro[data-cause=dependency-blocked]{color:var(--dsw-alias-state-danger)}.JDFXXG_taskDetailRetro[data-cause=on_time]{color:var(--dsw-alias-state-success)}.JDFXXG_taskDetailReview{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:600;line-height:14px}.JDFXXG_taskDetailReview[data-verdict=pass]{color:var(--dsw-alias-state-success)}.JDFXXG_taskDetailReview[data-verdict=reject]{color:var(--dsw-alias-state-danger)}.JDFXXG_taskDetailCalibration{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.JDFXXG_taskDetailBlocked{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:700;line-height:14px}.JDFXXG_taskDetailInput{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.JDFXXG_emptyHint{color:var(--dsw-alias-label-tertiary);padding:10px 14px;font-size:11px;line-height:16px}.JDFXXG_modeHint{color:var(--dsw-alias-label-secondary);padding:0 14px 6px;font-size:11px;line-height:16px;display:block}.JDFXXG_modeBadge{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 7px;font-size:11px;font-weight:600;line-height:16px}.JDFXXG_modeBadge[data-mode=light]{color:var(--dsw-alias-label-secondary)}.JDFXXG_modeBadge[data-mode=standard]{color:var(--dsw-alias-state-business-primary)}.JDFXXG_modeBadge[data-mode=governed]{color:var(--dsw-alias-state-warning)}.JDFXXG_historicPill{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;margin-left:auto;padding:1px 7px;font-size:9px;font-weight:600;line-height:15px}.JDFXXG_members{flex-direction:column;gap:3px;display:flex}.JDFXXG_archiveLabel{color:var(--dsw-alias-label-tertiary);padding:5px 14px 0;font-size:9px;font-weight:600;line-height:14px;display:block}.JDFXXG_archiveFilterBar{flex-wrap:wrap;align-items:center;gap:6px 8px;padding:6px 14px 2px;display:flex}.JDFXXG_archiveFilterField{color:var(--dsw-alias-label-tertiary);align-items:center;gap:4px;font-size:9px;line-height:14px;display:inline-flex}.JDFXXG_archiveFilterCaption{white-space:nowrap;font-weight:600}.JDFXXG_archiveSelect{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:120px;color:var(--dsw-alias-label-primary);border-radius:4px;padding:1px 2px;font-size:9px;line-height:14px}.JDFXXG_archiveFilterCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;margin-left:auto;font-size:9px}.JDFXXG_archiveEmpty{color:var(--dsw-alias-label-tertiary);padding:4px 14px 2px;font-size:9px;display:block}@media (prefers-reduced-motion:reduce){.JDFXXG_panel,.JDFXXG_badge,.JDFXXG_badgeDot,.JDFXXG_panelDot,.JDFXXG_workGlyph rect,.JDFXXG_stateArt,.JDFXXG_memberAvatar[data-unread=true]:after{transition:none;animation:none}}@media (width<=960px){html[data-agent-team-web-panel-open] div[data-phase]{padding-right:0}.JDFXXG_team{padding:12px 12px 14px}.JDFXXG_delegationTree{margin-left:12px;padding-left:15px}.JDFXXG_memberBranch{width:15px}}@media (width<=640px){.JDFXXG_badge{top:56px;right:10px}.JDFXXG_teamStats span[data-stat=messages]{display:none}.JDFXXG_captainNode{grid-template-columns:48px minmax(0,1fr)}.JDFXXG_captainState{display:none}.JDFXXG_assignmentLine{padding-left:60px}}.JDFXXG_healthChip{box-sizing:border-box;background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;flex:none;align-items:center;gap:5px;padding:1px 8px;font-size:11px;line-height:16px;display:inline-flex}.JDFXXG_healthChip strong{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:11px;font-weight:700}.JDFXXG_healthChip em{color:var(--dsw-alias-label-secondary);font-style:normal}.JDFXXG_healthChip[data-level=ok] strong{color:var(--dsw-alias-state-success)}.JDFXXG_healthChip[data-level=warn] strong{color:var(--dsw-alias-state-warning)}.JDFXXG_healthChip[data-level=critical] strong,.JDFXXG_riskStat{color:var(--dsw-alias-state-danger)}.JDFXXG_prioritySection{flex-direction:column;gap:5px;min-width:0;display:flex}.JDFXXG_priorityCard{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);border-radius:8px;align-items:flex-start;gap:8px;padding:6px 8px;display:flex}.JDFXXG_priorityCard[data-severity=high]{border-color:color-mix(in srgb,var(--dsw-alias-state-danger) 45%,var(--dsw-alias-line-normal))}.JDFXXG_priorityCard[data-severity=medium]{border-color:color-mix(in srgb,var(--dsw-alias-state-warning) 40%,var(--dsw-alias-line-normal))}.JDFXXG_priorityBadge{background:var(--dsw-alias-bg-fill-business);min-width:22px;height:18px;color:var(--dsw-alias-label-on-fill);border-radius:6px;flex:none;justify-content:center;align-items:center;font-size:11px;font-weight:700;display:inline-flex}.JDFXXG_priorityBody{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.JDFXXG_priorityTitle{flex-wrap:wrap;align-items:center;gap:5px;min-width:0;display:flex}.JDFXXG_priorityTitle strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.JDFXXG_chip{background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;padding:0 6px;font-size:11px;font-style:normal;font-weight:600;line-height:16px;display:inline-flex}.JDFXXG_chip[data-readiness=blocked],.JDFXXG_chip[data-readiness=orphaned],.JDFXXG_chip[data-readiness=stalled],.JDFXXG_chip[data-readiness=failed],.JDFXXG_chip[data-severity=high]{border-color:var(--dsw-alias-state-danger);color:var(--dsw-alias-state-danger)}.JDFXXG_chip[data-severity=medium],.JDFXXG_chip[data-readiness=ready]{border-color:var(--dsw-alias-state-warning);color:var(--dsw-alias-state-warning)}.JDFXXG_chip[data-severity=low],.JDFXXG_chip[data-readiness=cancelled]{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary)}.JDFXXG_priorityReasons{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.JDFXXG_milestoneRow{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;line-height:16px;display:flex}.JDFXXG_milestoneRow strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-weight:600;overflow:hidden}.JDFXXG_loadBar{background:var(--dsw-alias-line-strong);border-radius:999px;flex:none;align-items:stretch;width:44px;min-width:0;height:6px;display:inline-flex;overflow:hidden}.JDFXXG_loadBar>span{display:block}.JDFXXG_loadActive{background:var(--dsw-alias-state-business-primary)}.JDFXXG_loadPending{background:var(--dsw-alias-state-warning)}.JDFXXG_loadStalled,.JDFXXG_loadOrphaned{background:var(--dsw-alias-state-danger)}";
		...
		var ActivityPanel_module_css_default = {
			"agentTeamsBreathe": "JDFXXG_agentTeamsBreathe",
			"agentTeamsDot": "JDFXXG_agentTeamsDot",
			"agentTeamsFloat": "JDFXXG_agentTeamsFloat",
			"agentTeamsPanelIn": "JDFXXG_agentTeamsPanelIn",
			"agentTeamsPulse": "JDFXXG_agentTeamsPulse",
			"agentTeamsThink": "JDFXXG_agentTeamsThink",
			"agentTeamsUnreadPulse": "JDFXXG_agentTeamsUnreadPulse",
			"archiveAction": "JDFXXG_archiveAction",
			"archiveConfirm": "JDFXXG_archiveConfirm",
			"archiveConfirmActions": "JDFXXG_archiveConfirmActions",
			"archiveEmpty": "JDFXXG_archiveEmpty",
			"archiveFilterBar": "JDFXXG_archiveFilterBar",
			"archiveFilterCaption": "JDFXXG_archiveFilterCaption",
			"archiveFilterCount": "JDFXXG_archiveFilterCount",
			"archiveFilterField": "JDFXXG_archiveFilterField",
			"archiveLabel": "JDFXXG_archiveLabel",
			"archiveSelect": "JDFXXG_archiveSelect",
			"assignmentChip": "JDFXXG_assignmentChip",
			"assignmentLabel": "JDFXXG_assignmentLabel",
			"assignmentLine": "JDFXXG_assignmentLine",
			"assignmentTasks": "JDFXXG_assignmentTasks",
			"badge": "JDFXXG_badge",
			"badgeCount": "JDFXXG_badgeCount",
			"badgeDot": "JDFXXG_badgeDot",
			"blockedChip": "JDFXXG_blockedChip",
			"calibrationChip": "JDFXXG_calibrationChip",
			"captainAvatar": "JDFXXG_captainAvatar",
			"captainInfo": "JDFXXG_captainInfo",
			"captainLine": "JDFXXG_captainLine",
			"captainName": "JDFXXG_captainName",
			"captainNode": "JDFXXG_captainNode",
			"captainRole": "JDFXXG_captainRole",
			"captainState": "JDFXXG_captainState",
			"captainSummary": "JDFXXG_captainSummary",
			"chevron": "JDFXXG_chevron",
			"chip": "JDFXXG_chip",
			"closeError": "JDFXXG_closeError",
			"commandLayer": "JDFXXG_commandLayer",
			"commissarNode": "JDFXXG_commissarNode",
			"commissarState": "JDFXXG_commissarState",
			"connectionStatus": "JDFXXG_connectionStatus",
			"dagCanvas": "JDFXXG_dagCanvas",
			"dagEdges": "JDFXXG_dagEdges",
			"dagNode": "JDFXXG_dagNode",
			"dagNodeDot": "JDFXXG_dagNodeDot",
			"dagNodeHead": "JDFXXG_dagNodeHead",
			"dagNodeLabel": "JDFXXG_dagNodeLabel",
			"dagRunningState": "JDFXXG_dagRunningState",
			"dagViewport": "JDFXXG_dagViewport",
			"delegationSection": "JDFXXG_delegationSection",
			"delegationTree": "JDFXXG_delegationTree",
			"dependencySection": "JDFXXG_dependencySection",
			"diagnosticBanner": "JDFXXG_diagnosticBanner",
			"emptyHint": "JDFXXG_emptyHint",
			"healthChip": "JDFXXG_healthChip",
			"helpingChip": "JDFXXG_helpingChip",
			"historicPill": "JDFXXG_historicPill",
			"historyToggle": "JDFXXG_historyToggle",
			"iconButton": "JDFXXG_iconButton",
			"inputChip": "JDFXXG_inputChip",
			"leadAvatar": "JDFXXG_leadAvatar",
			"loadActive": "JDFXXG_loadActive",
			"loadBar": "JDFXXG_loadBar",
			"loadOrphaned": "JDFXXG_loadOrphaned",
			"loadPending": "JDFXXG_loadPending",
			"loadStalled": "JDFXXG_loadStalled",
			"memberArt": "JDFXXG_memberArt",
			"memberAvatar": "JDFXXG_memberAvatar",
			"memberBlock": "JDFXXG_memberBlock",
			"memberBranch": "JDFXXG_memberBranch",
			"memberCount": "JDFXXG_memberCount",
			"memberElapsed": "JDFXXG_memberElapsed",
			"memberInfo": "JDFXXG_memberInfo",
			"memberInitial": "JDFXXG_memberInitial",
			"memberLine": "JDFXXG_memberLine",
			"memberModel": "JDFXXG_memberModel",
			"memberName": "JDFXXG_memberName",
			"memberRight": "JDFXXG_memberRight",
			"memberRole": "JDFXXG_memberRole",
			"memberRow": "JDFXXG_memberRow",
			"memberState": "JDFXXG_memberState",
			"memberStatusLine": "JDFXXG_memberStatusLine",
			"members": "JDFXXG_members",
			"membersToggle": "JDFXXG_membersToggle",
			"milestoneRow": "JDFXXG_milestoneRow",
			"modeBadge": "JDFXXG_modeBadge",
			"modeHint": "JDFXXG_modeHint",
			"panel": "JDFXXG_panel",
			"panelControls": "JDFXXG_panelControls",
			"panelDot": "JDFXXG_panelDot",
			"panelHead": "JDFXXG_panelHead",
			"panelTitle": "JDFXXG_panelTitle",
			"priorityBadge": "JDFXXG_priorityBadge",
			"priorityBody": "JDFXXG_priorityBody",
			"priorityCard": "JDFXXG_priorityCard",
			"priorityReasons": "JDFXXG_priorityReasons",
			"prioritySection": "JDFXXG_prioritySection",
			"priorityTitle": "JDFXXG_priorityTitle",
			"progressEmpty": "JDFXXG_progressEmpty",
			"progressLegend": "JDFXXG_progressLegend",
			"progressOverview": "JDFXXG_progressOverview",
			"progressSegments": "JDFXXG_progressSegments",
			"progressSummary": "JDFXXG_progressSummary",
			"progressSummaryDot": "JDFXXG_progressSummaryDot",
			"progressTitle": "JDFXXG_progressTitle",
			"resizeHandle": "JDFXXG_resizeHandle",
			"reviewChip": "JDFXXG_reviewChip",
			"riskStat": "JDFXXG_riskStat",
			"sectionHead": "JDFXXG_sectionHead",
			"sectionHint": "JDFXXG_sectionHint",
			"sectionTitle": "JDFXXG_sectionTitle",
			"sectionToggleTitle": "JDFXXG_sectionToggleTitle",
			"stageLabel": "JDFXXG_stageLabel",
			"stateArt": "JDFXXG_stateArt",
			"taskDetail": "JDFXXG_taskDetail",
			"taskDetailActions": "JDFXXG_taskDetailActions",
			"taskDetailBadge": "JDFXXG_taskDetailBadge",
			"taskDetailBlocked": "JDFXXG_taskDetailBlocked",
			"taskDetailBudgetFact": "JDFXXG_taskDetailBudgetFact",
			"taskDetailCalibration": "JDFXXG_taskDetailCalibration",
			"taskDetailHead": "JDFXXG_taskDetailHead",
			"taskDetailId": "JDFXXG_taskDetailId",
			"taskDetailInput": "JDFXXG_taskDetailInput",
			"taskDetailLine": "JDFXXG_taskDetailLine",
			"taskDetailMeta": "JDFXXG_taskDetailMeta",
			"taskDetailRetro": "JDFXXG_taskDetailRetro",
			"taskDetailReview": "JDFXXG_taskDetailReview",
			"taskDetailSignals": "JDFXXG_taskDetailSignals",
			"taskDetailSubject": "JDFXXG_taskDetailSubject",
			"taskDetailTiming": "JDFXXG_taskDetailTiming",
			"taskEmpty": "JDFXXG_taskEmpty",
			"taskId": "JDFXXG_taskId",
			"team": "JDFXXG_team",
			"teamHead": "JDFXXG_teamHead",
			"teamName": "JDFXXG_teamName",
			"teamStats": "JDFXXG_teamStats",
			"teams": "JDFXXG_teams",
			"timingChip": "JDFXXG_timingChip",
			"unreadPill": "JDFXXG_unreadPill",
			"workGlyph": "JDFXXG_workGlyph"
		};
		//#endregion
		...
		*/
		...
		const cssText = ".N02Oya_section{flex-direction:column;gap:14px;display:flex}.N02Oya_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:10px;padding:14px 16px;display:flex}.N02Oya_head{align-items:center;gap:8px;display:flex}.N02Oya_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.N02Oya_list{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.N02Oya_row{box-sizing:border-box;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;min-width:0;min-height:36px;padding:0 10px;display:flex}.N02Oya_nameWrap{flex:1;align-items:center;gap:8px;min-width:0;display:flex}.N02Oya_name{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.N02Oya_rowSub{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;line-height:16px}.N02Oya_pill{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.N02Oya_switch{box-sizing:border-box;background:var(--dsw-alias-border-l2);cursor:pointer;border:none;border-radius:999px;flex:none;width:32px;height:18px;padding:0;transition:background .12s ease-in-out;position:relative}.N02Oya_switch[data-on=true]{background:var(--dsw-alias-state-business-primary)}.N02Oya_switch:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.N02Oya_switchThumb{background:var(--dsw-alias-bg-layer-1);border-radius:50%;width:14px;height:14px;transition:transform .12s ease-in-out;position:absolute;top:2px;left:2px}.N02Oya_switch[data-on=true] .N02Oya_switchThumb{transform:translate(14px)}.N02Oya_select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;max-width:200px;color:var(--dsw-alias-label-primary);border-radius:6px;flex:1;padding:2px 4px;font-size:11px;line-height:16px}.N02Oya_select:disabled{opacity:.55}@media (prefers-color-scheme:dark){.N02Oya_select{color:#e8e8e8;background:#26282b}}.N02Oya_resetBtn{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;flex:none;margin-left:auto;padding:2px 10px;font-size:11px;line-height:16px;transition:color .12s ease-in-out,border-color .12s ease-in-out}.N02Oya_resetBtn:hover:not(:disabled){border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.N02Oya_resetBtn:disabled{opacity:.45;cursor:default}.N02Oya_presetPopover{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 56%, transparent);border-radius:10px;flex-direction:column;gap:8px;margin:2px 0 10px;padding:10px;display:flex}.N02Oya_presetTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}.N02Oya_presetHelp{color:var(--dsw-alias-label-tertiary);margin:0;font-size:11px;line-height:16px}.N02Oya_presetTabs{flex-wrap:wrap;gap:6px;display:flex}.N02Oya_presetTab{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:999px;padding:3px 8px;font-size:11px;line-height:16px}.N02Oya_presetTab[data-active=true]{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.N02Oya_presetList{flex-direction:column;gap:6px;display:flex}.N02Oya_presetItem{border:1px solid var(--dsw-alias-border-l2);color:inherit;text-align:left;cursor:pointer;background:0 0;border-radius:8px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.N02Oya_presetItem[data-active=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.N02Oya_presetItemHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.N02Oya_presetItemName{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:600;line-height:16px}.N02Oya_presetMetaRow{flex-wrap:wrap;gap:6px;display:flex}.N02Oya_presetMetaChip{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 46%, transparent);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 6px;font-size:10px;line-height:15px}.N02Oya_presetItemDesc{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.N02Oya_presetDiffBadge{color:var(--dsw-alias-label-secondary);flex:none;font-size:10px;line-height:15px}.N02Oya_presetActions{justify-content:flex-end;gap:8px;display:flex}.N02Oya_presetActionGhost,.N02Oya_presetActionPrimary{cursor:pointer;border-radius:6px;padding:3px 10px;font-size:11px;line-height:16px}.N02Oya_presetActionGhost{color:var(--dsw-alias-label-secondary);background:0 0;border:1px solid #0000}.N02Oya_presetActionPrimary{border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary);color:#fff}.N02Oya_empty{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 8px;font-size:11px;line-height:16px}.N02Oya_viewBtn{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex;position:relative}.N02Oya_viewBtn:hover{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.N02Oya_viewBtn:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.N02Oya_modalMask{z-index:100;background:#00000073;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.N02Oya_modal{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:12px;width:460px;max-width:100%;padding:16px;box-shadow:0 12px 40px #00000080}.N02Oya_modalHead{align-items:center;gap:8px;margin-bottom:12px;display:flex}.N02Oya_modalTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.N02Oya_modalClose{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;margin-left:auto;padding:2px 6px;font-size:13px;line-height:16px}.N02Oya_modalClose:hover{color:var(--dsw-alias-label-primary);background:#ffffff0f}.N02Oya_roleSlogan{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, transparent);color:var(--dsw-alias-state-business-primary);border-radius:8px;padding:8px 10px;font-size:13px;font-weight:500;line-height:20px}.N02Oya_modalSectionTitle{color:var(--dsw-alias-label-tertiary);margin:12px 0 6px;font-size:11px;line-height:16px}.N02Oya_dutyRow{gap:8px;padding:6px 10px;font-size:12px;line-height:20px;display:flex}.N02Oya_dutyRow+.N02Oya_dutyRow{border-top:1px dashed var(--dsw-alias-border-l2)}.N02Oya_dutyStep{color:var(--dsw-alias-label-secondary);flex:none;font-weight:500}.N02Oya_dutyDesc{color:var(--dsw-alias-label-primary)}.N02Oya_modalKv{align-items:center;gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.N02Oya_modalK{width:72px;color:var(--dsw-alias-label-tertiary);flex:none}.N02Oya_modalV{color:var(--dsw-alias-label-secondary);flex:1;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}.N02Oya_modalEmpty{color:var(--dsw-alias-label-tertiary);padding:6px 10px;font-size:12px;line-height:20px}.N02Oya_modalBody{max-height:min(52vh,420px);margin-right:-4px;padding-right:4px;overflow:auto}.N02Oya_ruleRow{gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.N02Oya_ruleBullet{color:var(--dsw-alias-state-business-primary);flex:none}.N02Oya_growthStat{color:var(--dsw-alias-label-primary);margin:0 0 8px;padding:0 10px;font-size:12px;line-height:20px}.N02Oya_growthList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.N02Oya_growthItem{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 40%, transparent);border-radius:8px;flex-direction:column;gap:2px;padding:8px 10px;display:flex}.N02Oya_growthPractice{color:var(--dsw-alias-label-primary);font-size:12px;line-height:20px}.N02Oya_growthMeta{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}";
		...
		var ProviderGrantsSection_module_css_default = {
			"card": "N02Oya_card",
			"dutyDesc": "N02Oya_dutyDesc",
			"dutyRow": "N02Oya_dutyRow",
			"dutyStep": "N02Oya_dutyStep",
			"empty": "N02Oya_empty",
			"growthItem": "N02Oya_growthItem",
			"growthList": "N02Oya_growthList",
			"growthMeta": "N02Oya_growthMeta",
			"growthPractice": "N02Oya_growthPractice",
			"growthStat": "N02Oya_growthStat",
			"head": "N02Oya_head",
			"list": "N02Oya_list",
			"modal": "N02Oya_modal",
			"modalBody": "N02Oya_modalBody",
			"modalClose": "N02Oya_modalClose",
			"modalEmpty": "N02Oya_modalEmpty",
			"modalHead": "N02Oya_modalHead",
			"modalK": "N02Oya_modalK",
			"modalKv": "N02Oya_modalKv",
			"modalMask": "N02Oya_modalMask",
			"modalSectionTitle": "N02Oya_modalSectionTitle",
			"modalTitle": "N02Oya_modalTitle",
			"modalV": "N02Oya_modalV",
			"name": "N02Oya_name",
			"nameWrap": "N02Oya_nameWrap",
			"pill": "N02Oya_pill",
			"presetActionGhost": "N02Oya_presetActionGhost",
			"presetActionPrimary": "N02Oya_presetActionPrimary",
			"presetActions": "N02Oya_presetActions",
			"presetDiffBadge": "N02Oya_presetDiffBadge",
			"presetHelp": "N02Oya_presetHelp",
			"presetItem": "N02Oya_presetItem",
			"presetItemDesc": "N02Oya_presetItemDesc",
			"presetItemHead": "N02Oya_presetItemHead",
			"presetItemName": "N02Oya_presetItemName",
			"presetList": "N02Oya_presetList",
			"presetMetaChip": "N02Oya_presetMetaChip",
			"presetMetaRow": "N02Oya_presetMetaRow",
			"presetPopover": "N02Oya_presetPopover",
			"presetTab": "N02Oya_presetTab",
			"presetTabs": "N02Oya_presetTabs",
			"presetTitle": "N02Oya_presetTitle",
			"resetBtn": "N02Oya_resetBtn",
			"roleSlogan": "N02Oya_roleSlogan",
			"row": "N02Oya_row",
			"rowSub": "N02Oya_rowSub",
			"ruleBullet": "N02Oya_ruleBullet",
			"ruleRow": "N02Oya_ruleRow",
			"section": "N02Oya_section",
			"select": "N02Oya_select",
			"switch": "N02Oya_switch",
			"switchThumb": "N02Oya_switchThumb",
			"title": "N02Oya_title",
			"viewBtn": "N02Oya_viewBtn"
		};
		//#endregion
		...
		*/
		const NO_REASONING_EFFORT_PROVIDERS = [];
		/**
		...
		*/
		function supportsReasoningEffort(provider) {
			return provider !== void 0 && !NO_REASONING_EFFORT_PROVIDERS.includes(provider);
		}
		...
		* deepseek-official 恒锁定恒启用(「默认」徽,无 switch)。 */
		function providerGrantRows(providers, enabledModels) {
			return providers.map((provider) => ({
				id: provider.id,
				name: provider.name,
				enabled: provider.id === "deepseek-official" || (provider.models?.length ?? 0) > 0 && (provider.models ?? []).every((model) => enabledModels?.[modelKeyOf(provider.id, model)] === true),
		...
		* 模型粒度(enabledModels 复合 key)不变。 */
		function toggleProviderModels(current, provider, models, nextEnabled) {
			const next = { ...current ?? {} };
		...
		*/
		function autoAssignRoleDefaults(current, enabledModels, table = ROLE_AUTO_ASSIGN_TABLE) {
			const next = { ...current ?? {} };
			for (const [role, entry] of Object.entries(table)) {
				const existing = next[role];
				if (existing !== void 0 && existing.auto !== true) continue;
				if (enabledModels?.[modelKeyOf(entry.provider, entry.model)] === true) next[role] = {
					provider: entry.provider,
					model: entry.model,
					...entry.reasoningEffort !== void 0 && supportsReasoningEffort(entry.provider) ? { reasoningEffort: entry.reasoningEffort } : {},
					auto: true
				};
				else next[role] = {
					...entry.fallback,
		...
		* 判定(驱动「恢复默认」disabled 态与选中回显)。 */
		function mergeRoleDefaults(base, overrides) {
			return [.../* @__PURE__ */ new Set([...Object.keys(base ?? {}), ...Object.keys(overrides ?? {})])].map((role) => ({
				role,
		...
		* 有目标可分配才写,避免无谓覆盖/写入)。 */
		function autoAssignHasTarget(enabledModels, table = ROLE_AUTO_ASSIGN_TABLE) {
			if (enabledModels === void 0) return false;
		...
		* (无变更则不写 scope,避免无谓写入/触发 uSES 重渲染循环)。 */
		function autoAssignDiffers(current, enabledModels, table = ROLE_AUTO_ASSIGN_TABLE) {
			const next = autoAssignRoleDefaults(current, enabledModels, table);
			const cur = current ?? {};
			const keys = /* @__PURE__ */ new Set([...Object.keys(cur), ...Object.keys(next)]);
			for (const key of keys) {
				const a = cur[key];
				const b = next[key];
				if (a === void 0 !== (b === void 0)) return true;
				if (a === void 0 || b === void 0) continue;
				if (a.provider !== b.provider || a.model !== b.model || a.reasoningEffort !== b.reasoningEffort || (a.auto ?? false) !== (b.auto ?? false)) return true;
			}
			return false;
		}
		/** 纯函数:角色档位覆盖写后的 roleDefaults map(value=undefined → 删覆盖)。 */
		function roleDefaultsMap(current, roleKey, value) {
			const next = { ...current ?? {} };
			if (value === void 0) delete next[roleKey];
		...
		* 不过滤(兼容旧行为/快照缺省);过滤后空组剔除。 */
		function rolePresetModelGroups(providers, enabledModels) {
			const groups = [];
			for (const provider of providers) {
				const models = provider.models ?? [];
				if (models.length === 0) continue;
				if (!(enabledModels === void 0 || provider.id === "deepseek-official" || models.every((model) => enabledModels[modelKeyOf(provider.id, model)] === true))) continue;
				groups.push({
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: t("settings.agentTeam.reset")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: ProviderGrantsSection_module_css_default.resetBtn,
								onClick: () => {
									...
									if (nextOpen) {
										...
										if (first !== void 0) setSelectedPresetId(first.id);
									}
								},
								children: t("settings.agentTeam.applyPreset")
							})
						]
					}),
					presetOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: ProviderGrantsSection_module_css_default.presetTitle,
								children: t("settings.agentTeam.presetTitle")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: ProviderGrantsSection_module_css_default.presetHelp,
								children: t("settings.agentTeam.presetHelp")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: ProviderGrantsSection_module_css_default.presetHelp,
								children: "成本、速度、质量为未实测参考分级；Astra 待评估。套用预设不改变队长模型。"
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: [
									...
									children: group === "ds" ? t("settings.agentTeam.presetGroup.ds") : group === "gpt" ? t("settings.agentTeam.presetGroup.gpt") : t("settings.agentTeam.presetGroup.mixed")
								}, group))
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: ProviderGrantsSection_module_css_default.presetList,
								children: presetTemplates.map((template) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									type: "button",
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												...
												children: `${t("settings.agentTeam.preset.diff")} ${presetDiffCount(rows, template)}`
											})]
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: ProviderGrantsSection_module_css_default.presetActions,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: ProviderGrantsSection_module_css_default.presetActionGhost,
									onClick: () => {
										setPresetOpen(false);
									},
									children: t("settings.agentTeam.preset.cancel")
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: ProviderGrantsSection_module_css_default.presetActionPrimary,
									onClick: () => {
										applyPreset();
									},
									children: t("settings.agentTeam.preset.apply")
								})]
							})
						]
					}),
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
									...
									onChange: (event) => {
										...
										write(row.role, {
											...
											model,
											...group?.providerId !== void 0 && supportsReasoningEffort(group.providerId) ? { reasoningEffort: row.reasoningEffort } : {}
										});
									},
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: "",
											children: t("settings.agentTeam.inherit")
										}),
										groups.map((group) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("optgroup", {
											label: group.providerId,
											children: group.models.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: model,
												children: model
											}, `${group.providerId}/${model}`))
										}, group.providerId)),
										row.model !== void 0 && row.model !== "" && !groups.some((group) => group.models.includes(row.model)) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: row.model,
											children: `${row.model}（${t("settings.agentTeam.unauthorized")}）`
										})
									]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
									...
									value: EFFORT_OPTIONS.includes(row.reasoningEffort) ? row.reasoningEffort : EFFORT_OPTIONS[0],
									onChange: (event) => {
									...
									children: EFFORT_OPTIONS.map((effort) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
										value: effort,
										children: effort
									}, effort))
								}),
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									...
									children: t("settings.agentTeam.viewCurrent")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: ProviderGrantsSection_module_css_default.modalKv,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: ProviderGrantsSection_module_css_default.modalK,
										children: t("settings.agentTeam.modelAria")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: ProviderGrantsSection_module_css_default.modalV,
										children: [
											viewing.provider ?? "",
											viewing.provider !== void 0 && viewing.model !== void 0 ? " / " : "",
											viewing.model ?? ""
										]
									})]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: ProviderGrantsSection_module_css_default.modalK,
										children: t("settings.agentTeam.effortAria")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: ProviderGrantsSection_module_css_default.modalV,
										children: viewing.reasoningEffort ?? t("settings.agentTeam.modelDefault")
									})]
								})
							]
						})
		...
		*/
		function ProviderGrantsSection(props) {
			...
			const initAssignRef = (0, react.useRef)(false);
			(0, react.useEffect)(() => {
				...
				if (scope === void 0) return;
				if (!autoAssignHasTarget(value.enabledModels)) return;
				if (!autoAssignDiffers(value.roleDefaults, value.enabledModels)) return;
				scope.set("roleDefaults", autoAssignRoleDefaults(value.roleDefaults, value.enabledModels));
			}, [
				loading,
				snapshot.value,
				scope
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [providerRows.length === 0 && roleRows.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					className: ProviderGrantsSection_module_css_default.empty,
					children: t(loading ? "settings.agentTeam.loading" : "settings.agentTeam.empty")
				}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ModelGrantCard, {
					rows: providerRows,
					providers: center.providers,
					scope,
					snapshot,
					t
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RolePresetCard, {
					rows: roleRows,
					groups: modelGroups,
					scope,
					snapshot,
