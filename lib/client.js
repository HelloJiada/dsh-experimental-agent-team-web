window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const cssText$2 = "._4I4sWG_root{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:8px;width:100%;min-width:0;padding:10px 12px;display:flex}._4I4sWG_head{align-items:center;gap:8px;min-width:0;display:flex}._4I4sWG_leadAvatar{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0;flex:none;width:30px;height:30px}._4I4sWG_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}._4I4sWG_memberCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;margin-left:auto;font-size:11px;line-height:16px}._4I4sWG_panelButton{border:1px solid var(--dsw-alias-line-strong);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;flex:none;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:16px;transition:border-color .12s,color .12s}._4I4sWG_panelButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}._4I4sWG_panelButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._4I4sWG_members{flex-wrap:wrap;gap:6px;min-width:0;display:flex}._4I4sWG_member{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:160px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:5px;padding:3px 8px 3px 3px;font-size:11px;font-weight:500;line-height:16px;transition:border-color .12s,background-color .12s;display:inline-flex}._4I4sWG_member:hover{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-fill-neutral)}._4I4sWG_member:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._4I4sWG_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d482e);background:0 0;border:0;border-radius:0;width:24px;height:24px}._4I4sWG_memberInitial{background:var(--dsw-alias-bg-fill-business);width:20px;height:20px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:10px;font-weight:600;line-height:20px;display:inline-flex}._4I4sWG_memberName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}";
		...
		var AgentTeamsCard_module_css_default = {
			"head": "_4I4sWG_head",
			"leadAvatar": "_4I4sWG_leadAvatar",
			"member": "_4I4sWG_member",
			"memberArt": "_4I4sWG_memberArt",
			"memberCount": "_4I4sWG_memberCount",
			"memberInitial": "_4I4sWG_memberInitial",
			"memberName": "_4I4sWG_memberName",
			"members": "_4I4sWG_members",
			"panelButton": "_4I4sWG_panelButton",
			"root": "_4I4sWG_root",
			"teamName": "_4I4sWG_teamName"
		};
		//#endregion
		...
		*/
		...
		const cssText$1 = "html{--agent-team-web-panel-shift:420px}html[data-agent-team-web-panel-open] div[data-phase]{box-sizing:border-box;padding-right:var(--agent-team-web-panel-shift)}._7CYAVW_badge,._7CYAVW_panel{--at-bg-panel:#fff;--at-bg-raised:#fafbfc;--at-bg-fill:#f4f6f9;--at-border:#e8ebf0;--at-border-strong:#d9dee8;--at-text-primary:#1b1f27;--at-text-secondary:#5a6474;--at-text-tertiary:#8f97a6;--at-accent:#2d5ca8;--at-accent-hover:#3568b8;--at-accent-strong:#244a8a;--at-success:#15875a;--at-warning:#a4681a;--at-danger:#c23b42;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #17203014;--at-shadow-panel:0 12px 32px #17203012, 0 32px 72px #1720301c;--at-shadow-active:0 16px 40px #1720301a, 0 36px 80px #17203024;--dsw-alias-bg-module:var(--at-bg-panel);--dsw-alias-bg-module-platform:var(--at-bg-raised);--dsw-alias-bg-fill-neutral:var(--at-bg-fill);--dsw-alias-bg-fill-business:var(--at-accent);--dsw-alias-bg-fill-success:var(--at-success);--dsw-alias-bg-fill-warning:var(--at-warning);--dsw-alias-bg-fill-danger:var(--at-danger);--dsw-alias-state-business-primary:var(--at-accent);--dsw-alias-state-success:var(--at-success);--dsw-alias-state-warning:var(--at-warning);--dsw-alias-state-danger:var(--at-danger);--dsw-alias-label-primary:var(--at-text-primary);--dsw-alias-label-secondary:var(--at-text-secondary);--dsw-alias-label-tertiary:var(--at-text-tertiary);--dsw-alias-label-on-fill:var(--at-on-accent);--dsw-alias-line-normal:var(--at-border);--dsw-alias-line-strong:var(--at-border-strong)}@media (prefers-color-scheme:dark){._7CYAVW_badge,._7CYAVW_panel{--at-bg-panel:#1e1f22;--at-bg-raised:#202125;--at-bg-fill:#2a2c30;--at-border:#2e3136;--at-border-strong:#3a3e45;--at-text-primary:#f5f6f8;--at-text-secondary:#b9bdc6;--at-text-tertiary:#8b90a0;--at-accent:#5b8dd9;--at-accent-hover:#6d9be0;--at-accent-strong:#4a7cc9;--at-success:#3ecf7f;--at-warning:#f0a83c;--at-danger:#f0606a;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #00000073;--at-shadow-panel:0 12px 32px #00000073, 0 32px 72px #0000008c;--at-shadow-active:0 16px 40px #00000080, 0 36px 80px #0009}._7CYAVW_stateArt{filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #00000073)}}._7CYAVW_badge{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:color-mix(in srgb, var(--dsw-alias-bg-module-platform) 92%, transparent);backdrop-filter:blur(16px);height:34px;box-shadow:var(--at-shadow-badge);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:7px;padding:0 12px;font-size:12px;font-weight:600;line-height:20px;transition:border-color .12s,transform .12s;display:inline-flex;position:absolute;top:64px;right:18px}._7CYAVW_badge:hover{border-color:var(--dsw-alias-line-strong);transform:translateY(-1px)}._7CYAVW_badge:active{transform:translateY(0)scale(.97)}._7CYAVW_badge:focus-visible,._7CYAVW_iconButton:focus-visible,._7CYAVW_memberRow:focus-visible,._7CYAVW_membersToggle:focus-visible,._7CYAVW_sectionToggleTitle:focus-visible,._7CYAVW_historyToggle:focus-visible,._7CYAVW_dagNode:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._7CYAVW_badgeDot,._7CYAVW_panelDot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:7px;height:7px}._7CYAVW_badgeDot[data-busy=true],._7CYAVW_panelDot[data-busy=true]{background:var(--dsw-alias-state-business-primary);animation:1.25s ease-in-out infinite _7CYAVW_agentTeamsPulse}._7CYAVW_badgeCount,._7CYAVW_memberCount,._7CYAVW_teamStats,._7CYAVW_stageLabel,._7CYAVW_taskId{font-variant-numeric:tabular-nums}._7CYAVW_panel{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-line-strong) 58%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-module) 95%, transparent);backdrop-filter:blur(20px)saturate(1.08);box-shadow:var(--at-shadow-panel);will-change:transform;border-radius:16px;flex-direction:column;animation:.16s ease-out _7CYAVW_agentTeamsPanelIn;display:flex;position:absolute;top:0;left:0;overflow:hidden}._7CYAVW_panel[data-dragging],._7CYAVW_panel[data-resizing]{user-select:none;box-shadow:var(--at-shadow-active)}@keyframes _7CYAVW_agentTeamsPanelIn{0%{opacity:0}to{opacity:1}}@keyframes _7CYAVW_agentTeamsPulse{0%,to{opacity:.42}50%{opacity:1}}._7CYAVW_panelHead{border-bottom:1px solid var(--dsw-alias-line-normal);cursor:grab;touch-action:none;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:0 14px;display:flex}._7CYAVW_panelHead:active,._7CYAVW_panel[data-dragging] ._7CYAVW_panelHead{cursor:grabbing}._7CYAVW_panel[data-compact] ._7CYAVW_panelHead{cursor:default;touch-action:auto}._7CYAVW_panelTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:8px;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}._7CYAVW_panelControls{flex:none;align-items:center;gap:2px;display:inline-flex}._7CYAVW_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,transform .12s;display:inline-flex}._7CYAVW_iconButton:hover{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-primary)}._7CYAVW_iconButton:active{transform:scale(.94)}._7CYAVW_iconButton[data-control=dock][data-mode=docked] svg{transform:scaleX(-1)}._7CYAVW_iconButton[data-control=close]:hover:not(:disabled){background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}._7CYAVW_iconButton[data-control=close]:disabled{opacity:.45;cursor:not-allowed}._7CYAVW_closeError{color:var(--dsw-alias-state-danger);border-top:1px solid var(--dsw-alias-line-normal);padding:4px 14px;font-size:12px;line-height:16px}._7CYAVW_resizeHandle{z-index:1;touch-action:none;position:absolute}._7CYAVW_resizeHandle[data-resize-edge=left]{cursor:ew-resize;width:8px;top:44px;bottom:8px;left:0}._7CYAVW_resizeHandle[data-resize-edge=bottom]{cursor:ns-resize;height:8px;bottom:0;left:12px;right:12px}._7CYAVW_resizeHandle[data-resize-edge=corner]{cursor:nwse-resize;width:18px;height:18px;bottom:0;right:0}._7CYAVW_resizeHandle[data-resize-edge=corner]:after{border-right:1px solid var(--dsw-alias-label-tertiary);border-bottom:1px solid var(--dsw-alias-label-tertiary);content:\"\";opacity:.52;width:7px;height:7px;position:absolute;bottom:4px;right:4px}._7CYAVW_teams{overscroll-behavior:contain;scrollbar-color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent) transparent;scrollbar-width:thin;flex-direction:column;min-height:0;display:flex;overflow-y:auto}._7CYAVW_teams::-webkit-scrollbar{width:6px}._7CYAVW_teams::-webkit-scrollbar-track{background:0 0}._7CYAVW_teams::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent);background-clip:padding-box;border:2px solid #0000;border-radius:999px}._7CYAVW_teams:hover::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 44%, transparent);background-clip:padding-box}._7CYAVW_team{border-bottom:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:12px;padding:12px 14px 14px;display:flex}._7CYAVW_team:last-child{border-bottom:0}._7CYAVW_teamHead{align-items:center;gap:10px;min-width:0;display:flex}._7CYAVW_teamName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}._7CYAVW_teamStats{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;gap:8px;font-size:10px;line-height:16px;display:inline-flex}._7CYAVW_sectionHead{justify-content:space-between;align-items:center;gap:8px;min-width:0;display:flex}._7CYAVW_sectionTitle{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}._7CYAVW_sectionHint{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}._7CYAVW_delegationSection{flex-direction:column;gap:10px;min-width:0;display:flex}._7CYAVW_captainNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 32%, var(--dsw-alias-line-normal));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid}._7CYAVW_commandLayer{grid-template-columns:1fr;gap:10px;display:grid}._7CYAVW_commandLayer[data-leadership=solo]{grid-template-columns:1fr}._7CYAVW_commissarNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--at-accent) 32%, var(--at-border));background:color-mix(in srgb, var(--at-accent) 5%, var(--at-bg-panel));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid;position:relative}._7CYAVW_commissarNode:before{background:var(--at-accent);content:\"\";border-radius:2px;width:2px;position:absolute;top:8px;bottom:8px;left:0}._7CYAVW_commissarState{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;text-align:right;font-size:10px;line-height:14px;overflow:hidden}._7CYAVW_commissarState[data-activity=working]{color:var(--dsw-alias-state-business-primary);font-weight:600}._7CYAVW_captainAvatar,._7CYAVW_memberAvatar{flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}._7CYAVW_captainAvatar{width:46px;height:46px}._7CYAVW_leadAvatar,._7CYAVW_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0}._7CYAVW_leadAvatar{width:44px;height:44px}._7CYAVW_memberArt{width:40px;height:40px}._7CYAVW_captainInfo,._7CYAVW_memberInfo{flex-direction:column;min-width:0;display:flex}._7CYAVW_captainInfo{gap:2px}._7CYAVW_captainLine,._7CYAVW_memberLine{align-items:center;gap:6px;min-width:0;display:flex}._7CYAVW_captainName,._7CYAVW_memberName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:18px;overflow:hidden}._7CYAVW_captainRole,._7CYAVW_memberRole{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}._7CYAVW_memberModel{color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 78%, transparent);text-overflow:ellipsis;white-space:nowrap;flex:none;margin-left:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:8px;line-height:12px;overflow:hidden}._7CYAVW_captainSummary,._7CYAVW_memberStatusLine{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:15px;overflow:hidden}._7CYAVW_memberElapsed{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:4px;flex:none;align-items:center;margin-left:6px;padding:0 4px;font-size:8.5px;font-weight:600;line-height:14px;display:inline-flex}._7CYAVW_memberElapsed[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 14%, transparent);color:var(--dsw-alias-state-warning)}._7CYAVW_memberElapsed[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 14%, transparent);color:var(--dsw-alias-state-danger)}._7CYAVW_captainState,._7CYAVW_memberState{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;align-items:center;gap:5px;font-size:10px;font-weight:500;line-height:15px;display:inline-flex}._7CYAVW_captainState[data-busy=true],._7CYAVW_memberState[data-activity=working]{color:var(--dsw-alias-state-business-primary)}._7CYAVW_workGlyph rect{opacity:.5}._7CYAVW_workGlyph[data-active=true] rect{animation:1.1s ease-in-out infinite _7CYAVW_agentTeamsDot}@keyframes _7CYAVW_agentTeamsDot{0%,to{opacity:.25}50%{opacity:1}}._7CYAVW_progressOverview{flex-direction:column;gap:7px;display:flex}._7CYAVW_progressTitle{color:var(--dsw-alias-label-secondary);font-size:11px;font-weight:600;line-height:16px}._7CYAVW_progressSegments{gap:3px;display:flex}._7CYAVW_progressSegments>span,._7CYAVW_progressEmpty{background:var(--dsw-alias-line-strong);border-radius:2px;flex:1;height:5px}._7CYAVW_progressEmpty{width:100%;display:block}._7CYAVW_progressSegments>span[data-state=running]{background:var(--dsw-alias-state-business-primary)}._7CYAVW_progressSegments>span[data-state=blocked]{background:var(--dsw-alias-state-warning)}._7CYAVW_progressSegments>span[data-state=completed]{background:var(--dsw-alias-state-success)}._7CYAVW_progressSegments>span[data-state=failed]{background:var(--dsw-alias-state-danger)}._7CYAVW_progressSegments>span[data-state=cancelled]{opacity:.55}._7CYAVW_progressLegend{color:var(--dsw-alias-label-tertiary);gap:10px;font-size:9px;line-height:14px;display:flex}._7CYAVW_progressLegend>span[data-state=running]{color:var(--dsw-alias-state-business-primary)}._7CYAVW_progressLegend>span[data-state=blocked]{color:var(--dsw-alias-state-warning)}._7CYAVW_progressLegend>span[data-state=completed]{color:var(--dsw-alias-state-success)}._7CYAVW_progressSummary{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));min-width:0;color:var(--dsw-alias-label-secondary);border-radius:8px;align-items:center;gap:6px;padding:5px 8px;font-size:10px;font-weight:600;line-height:15px;display:flex}._7CYAVW_progressSummary[data-state=warning]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 8%, var(--dsw-alias-bg-module))}._7CYAVW_progressSummary[data-state=completed]{background:color-mix(in srgb, var(--dsw-alias-state-success) 8%, var(--dsw-alias-bg-module))}._7CYAVW_progressSummary>span:last-child{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._7CYAVW_progressSummaryDot{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:5px;height:5px}._7CYAVW_progressSummary[data-state=warning] ._7CYAVW_progressSummaryDot{background:var(--dsw-alias-state-warning)}._7CYAVW_progressSummary[data-state=completed] ._7CYAVW_progressSummaryDot{background:var(--dsw-alias-state-success)}._7CYAVW_membersToggle{background:var(--dsw-alias-bg-module-platform);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}._7CYAVW_membersToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}._7CYAVW_membersToggle>span{align-items:center;gap:5px;display:inline-flex}._7CYAVW_membersToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}._7CYAVW_historyToggle{background:var(--dsw-alias-bg-module);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}._7CYAVW_historyToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}._7CYAVW_historyToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}._7CYAVW_chevron{flex:none;transition:transform .12s}._7CYAVW_chevron[data-open=true]{transform:rotate(90deg)}._7CYAVW_delegationTree{flex-direction:column;gap:2px;margin-left:18px;padding:0 0 0 20px;display:flex;position:relative}._7CYAVW_delegationTree:before{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));content:\"\";width:1px;position:absolute;top:0;bottom:22px;left:0}._7CYAVW_memberBlock{flex-direction:column;min-width:0;padding:3px 0 7px;display:flex;position:relative}._7CYAVW_memberBranch{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));width:20px;height:1px;display:block;position:absolute;top:27px;right:100%}._7CYAVW_memberBranch:before{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:5px;height:5px;position:absolute;top:-2px;right:-1px}._7CYAVW_memberRow{box-sizing:border-box;width:100%;min-width:0;min-height:48px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:46px minmax(0,1fr) auto;align-items:center;gap:8px;padding:4px 6px;transition:background-color .12s,transform .12s;display:grid}._7CYAVW_memberRow:hover,._7CYAVW_memberRow[data-activity=working]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}._7CYAVW_memberRow:active{transform:scale(.99)}._7CYAVW_memberAvatar{width:42px;height:42px}._7CYAVW_memberAvatar[data-unread=true]:after{box-sizing:border-box;border:1px solid var(--dsw-alias-bg-module);background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:6px;height:6px;animation:1.8s ease-in-out infinite _7CYAVW_agentTeamsUnreadPulse;position:absolute;top:0;right:-1px}@keyframes _7CYAVW_agentTeamsUnreadPulse{0%,to{opacity:.78;transform:scale(.92)}50%{opacity:1;transform:scale(1.16)}}._7CYAVW_memberInitial{background:var(--dsw-alias-bg-fill-business);width:38px;height:38px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:15px;font-weight:600;line-height:20px;display:inline-flex}._7CYAVW_stateArt{box-sizing:border-box;object-fit:contain;width:22px;height:22px;filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #122d483d);background:0 0;border:0;border-radius:0;position:absolute;bottom:-3px;right:-5px}._7CYAVW_stateArt[data-activity=working]{animation:2.4s ease-in-out infinite _7CYAVW_agentTeamsFloat}._7CYAVW_stateArt[data-activity=idle]{animation:4.2s ease-in-out infinite _7CYAVW_agentTeamsBreathe}._7CYAVW_stateArt[data-activity=unknown]{animation:2.8s ease-in-out infinite _7CYAVW_agentTeamsThink}@keyframes _7CYAVW_agentTeamsFloat{0%,to{transform:translateY(0)rotate(-4deg)}50%{transform:translateY(-2px)rotate(4deg)}}@keyframes _7CYAVW_agentTeamsBreathe{0%,to{opacity:.82;transform:scale(1)}50%{opacity:1;transform:scale(1.06)}}@keyframes _7CYAVW_agentTeamsThink{0%,to{transform:rotate(-7deg)}50%{transform:rotate(7deg)}}._7CYAVW_memberRight{flex:none;align-items:center;gap:8px;display:inline-flex}._7CYAVW_memberCount{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}._7CYAVW_assignmentLine{align-items:center;gap:7px;min-width:0;padding:0 6px 0 60px;display:flex}._7CYAVW_assignmentLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:9px;line-height:14px}._7CYAVW_assignmentTasks{flex-wrap:wrap;flex:1;gap:4px;min-width:0;display:flex}._7CYAVW_assignmentChip{background:var(--dsw-alias-bg-fill-neutral);min-height:16px;color:var(--dsw-alias-label-secondary);border-radius:4px;align-items:center;padding:0 5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:600;line-height:14px;display:inline-flex}._7CYAVW_assignmentChip[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}._7CYAVW_assignmentChip[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}._7CYAVW_assignmentChip[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}._7CYAVW_assignmentChip[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}._7CYAVW_assignmentChip[data-state=cancelled]{color:var(--dsw-alias-label-tertiary);text-decoration:line-through}._7CYAVW_assignmentChip[data-review=pending]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}._7CYAVW_assignmentChip[data-helping=true]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 50%, transparent);outline-offset:-1px}._7CYAVW_reviewChip,._7CYAVW_helpingChip,._7CYAVW_calibrationChip,._7CYAVW_blockedChip,._7CYAVW_inputChip{box-sizing:border-box;white-space:nowrap;min-height:16px;color:inherit;background:0 0;border-radius:4px;flex:none;align-items:center;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}._7CYAVW_reviewChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-state-warning) 70%, transparent);outline-offset:-1px}._7CYAVW_blockedChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 75%, transparent);outline-offset:-1px}._7CYAVW_inputChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}._7CYAVW_helpingChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 65%, transparent);outline-offset:-1px}._7CYAVW_calibrationChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}._7CYAVW_assignmentChip[data-timing=warn]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}._7CYAVW_assignmentChip[data-timing=over]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-danger) 62%, transparent);outline-offset:-1px}._7CYAVW_timingChip{box-sizing:border-box;white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:16px;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}._7CYAVW_timingChip[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 16%, transparent);color:var(--dsw-alias-state-warning)}._7CYAVW_timingChip[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 16%, transparent);color:var(--dsw-alias-state-danger)}._7CYAVW_unreadPill{color:var(--dsw-alias-state-business-primary);white-space:nowrap;flex:none;font-size:9px;font-weight:600;line-height:14px}._7CYAVW_taskEmpty{color:var(--dsw-alias-label-tertiary);font-size:9px;line-height:14px}._7CYAVW_dependencySection{border-top:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:7px;min-width:0;padding-top:10px;display:flex}._7CYAVW_sectionToggleTitle{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}._7CYAVW_dagViewport{scrollbar-width:thin;min-width:0;padding:2px 0 4px;overflow-x:auto}._7CYAVW_dagCanvas{min-width:100%;position:relative}._7CYAVW_dagCanvas[data-layout=parallel]{flex-wrap:wrap;gap:8px;display:flex}._7CYAVW_dagCanvas[data-layout=parallel] ._7CYAVW_dagNode{flex:92px;min-width:92px;position:relative}._7CYAVW_dagEdges{pointer-events:none;position:absolute;inset:0;overflow:visible}._7CYAVW_dagEdges path{fill:none;stroke:var(--dsw-alias-line-strong);stroke-width:1px;transition:opacity .12s,stroke .12s,stroke-width .12s}._7CYAVW_dagEdges path[data-active=true]{stroke:var(--dsw-alias-state-business-primary);stroke-width:1.6px}._7CYAVW_dagEdges path[data-dimmed=true]{opacity:.24}._7CYAVW_dagNode{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:6px;flex-direction:column;justify-content:center;gap:1px;padding:0 6px;transition:border-color .12s,background-color .12s,opacity .12s;display:flex;position:absolute}._7CYAVW_dagNode:hover,._7CYAVW_dagNode[data-focused=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}._7CYAVW_dagNode[data-dimmed=true]{opacity:.3}._7CYAVW_dagNode[data-state=running][data-dimmed=true]{opacity:.58}._7CYAVW_dagNode[data-state=completed]{border-color:color-mix(in srgb, var(--dsw-alias-state-success) 48%, var(--dsw-alias-line-normal))}._7CYAVW_dagNode[data-state=blocked]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 52%, var(--dsw-alias-line-normal))}._7CYAVW_dagNode[data-review=pending]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}._7CYAVW_dagNode[data-helping=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 70%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-business-primary) 38%, transparent)}._7CYAVW_dagNode[data-timing=warn]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}._7CYAVW_dagNode[data-timing=over]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-danger) 46%, transparent)}._7CYAVW_dagNode[data-state=failed]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 56%, var(--dsw-alias-line-normal))}._7CYAVW_dagNodeHead{color:var(--dsw-alias-label-primary);align-items:center;gap:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:700;display:flex}._7CYAVW_dagNodeDot{background:var(--dsw-alias-line-strong);border-radius:2px;flex:none;width:5px;height:5px}._7CYAVW_dagNode[data-state=running] ._7CYAVW_dagNodeDot{background:var(--dsw-alias-state-business-primary)}._7CYAVW_dagNode[data-state=running] ._7CYAVW_dagNodeHead{padding-right:12px}._7CYAVW_dagRunningState{width:9px;height:9px;color:var(--dsw-alias-state-business-primary);pointer-events:none;justify-content:center;align-items:center;display:inline-flex;position:absolute;top:4px;right:5px}._7CYAVW_dagRunningState ._7CYAVW_workGlyph{width:9px;height:9px}._7CYAVW_dagNode[data-state=blocked] ._7CYAVW_dagNodeDot{background:var(--dsw-alias-state-warning)}._7CYAVW_dagNode[data-state=completed] ._7CYAVW_dagNodeDot{background:var(--dsw-alias-state-success)}._7CYAVW_dagNode[data-state=failed] ._7CYAVW_dagNodeDot{background:var(--dsw-alias-state-danger)}._7CYAVW_dagNodeLabel{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:11px;overflow:hidden}._7CYAVW_taskDetail{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:8px;flex-direction:column;gap:3px;min-width:0;padding:7px 9px;display:flex}._7CYAVW_taskDetailHead{align-items:center;gap:6px;min-width:0;display:flex}._7CYAVW_taskDetailId{color:var(--dsw-alias-state-business-primary);flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;font-weight:700}._7CYAVW_taskDetailSubject{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}._7CYAVW_taskDetailBadge{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:8.5px;font-weight:600;line-height:14px}._7CYAVW_taskDetailBadge[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}._7CYAVW_taskDetailBadge[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}._7CYAVW_taskDetailBadge[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}._7CYAVW_taskDetailBadge[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}._7CYAVW_taskDetailLine,._7CYAVW_taskDetailMeta{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}._7CYAVW_taskDetailMeta{color:var(--dsw-alias-label-tertiary)}._7CYAVW_archiveAction{color:var(--dsw-alias-state-danger);background:color-mix(in srgb, var(--dsw-alias-state-danger) 12%, transparent);cursor:pointer;border:0;border-radius:5px;padding:3px 6px;font-size:9px}._7CYAVW_archiveAction:disabled{opacity:.55;cursor:not-allowed}._7CYAVW_diagnosticBanner{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-warning) 10%, var(--dsw-alias-bg-module));flex-wrap:wrap;align-items:flex-start;gap:6px 8px;padding:7px 10px;font-size:11px;line-height:16px;display:flex}._7CYAVW_diagnosticBanner button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-fill-neutral);cursor:pointer;border:0;border-radius:4px;padding:2px 6px}._7CYAVW_archiveConfirm{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-danger) 10%, var(--dsw-alias-background-base));justify-content:space-between;gap:8px;padding:7px 10px;font-size:10px;display:flex}._7CYAVW_archiveConfirmActions{gap:5px;display:flex}._7CYAVW_archiveConfirmActions button{cursor:pointer;border:0;border-radius:4px;padding:3px 6px}._7CYAVW_connectionStatus{color:var(--dsw-alias-label-tertiary);margin-left:5px;font-size:9px;font-weight:400}._7CYAVW_connectionStatus[data-connection=stale],._7CYAVW_connectionStatus[data-connection=offline],._7CYAVW_connectionStatus[data-connection=auth-failed]{color:var(--dsw-alias-state-warning)}._7CYAVW_taskDetailActions{gap:6px;margin-top:3px;display:flex}._7CYAVW_taskDetailActions button{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;padding:1px 4px;font-size:9px}._7CYAVW_taskDetailTiming{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}._7CYAVW_taskDetailTiming[data-timing=warn]{color:var(--dsw-alias-state-warning)}._7CYAVW_taskDetailTiming[data-timing=over]{color:var(--dsw-alias-state-danger);font-weight:600}._7CYAVW_taskDetailBudgetFact{color:var(--dsw-alias-label-secondary);font-size:11px;line-height:16px}._7CYAVW_taskDetailBudgetFact[data-budget-fact=over_budget]{color:var(--dsw-alias-state-warning);font-weight:700}._7CYAVW_taskDetailBudgetFact[data-budget-fact=within_budget]{color:var(--dsw-alias-state-success)}._7CYAVW_taskDetailSignals,._7CYAVW_taskDetailRetro{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:13px;overflow:hidden}._7CYAVW_taskDetail[data-expanded] ._7CYAVW_taskDetailSignals,._7CYAVW_taskDetail[data-expanded] ._7CYAVW_taskDetailRetro{overflow-wrap:anywhere;text-overflow:clip;white-space:normal;font-size:12px;line-height:18px;overflow:visible}._7CYAVW_taskDetail[data-expanded] ._7CYAVW_taskDetailActions{margin-top:7px}._7CYAVW_taskDetailActions button{min-height:32px}._7CYAVW_taskDetailActions button:focus-visible,._7CYAVW_archiveAction:focus-visible,._7CYAVW_archiveConfirmActions button:focus-visible{outline:2px solid var(--dsw-alias-state-primary);outline-offset:2px}._7CYAVW_taskDetailRetro[data-cause=underestimated],._7CYAVW_taskDetailRetro[data-cause=dependency-blocked]{color:var(--dsw-alias-state-danger)}._7CYAVW_taskDetailRetro[data-cause=on_time]{color:var(--dsw-alias-state-success)}._7CYAVW_taskDetailReview{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:600;line-height:14px}._7CYAVW_taskDetailReview[data-verdict=pass]{color:var(--dsw-alias-state-success)}._7CYAVW_taskDetailReview[data-verdict=reject]{color:var(--dsw-alias-state-danger)}._7CYAVW_taskDetailCalibration{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}._7CYAVW_taskDetailBlocked{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:700;line-height:14px}._7CYAVW_taskDetailInput{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}._7CYAVW_emptyHint{color:var(--dsw-alias-label-tertiary);padding:10px 14px;font-size:11px;line-height:16px}._7CYAVW_modeHint{color:var(--dsw-alias-label-secondary);padding:0 14px 6px;font-size:11px;line-height:16px;display:block}._7CYAVW_modeBadge{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 7px;font-size:11px;font-weight:600;line-height:16px}._7CYAVW_modeBadge[data-mode=light]{color:var(--dsw-alias-label-secondary)}._7CYAVW_modeBadge[data-mode=standard]{color:var(--dsw-alias-state-business-primary)}._7CYAVW_modeBadge[data-mode=governed]{color:var(--dsw-alias-state-warning)}._7CYAVW_historicPill{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;margin-left:auto;padding:1px 7px;font-size:9px;font-weight:600;line-height:15px}._7CYAVW_members{flex-direction:column;gap:3px;display:flex}._7CYAVW_archiveLabel{color:var(--dsw-alias-label-tertiary);padding:5px 14px 0;font-size:9px;font-weight:600;line-height:14px;display:block}._7CYAVW_archiveFilterBar{flex-wrap:wrap;align-items:center;gap:6px 8px;padding:6px 14px 2px;display:flex}._7CYAVW_archiveFilterField{color:var(--dsw-alias-label-tertiary);align-items:center;gap:4px;font-size:9px;line-height:14px;display:inline-flex}._7CYAVW_archiveFilterCaption{white-space:nowrap;font-weight:600}._7CYAVW_archiveSelect{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:120px;color:var(--dsw-alias-label-primary);border-radius:4px;padding:1px 2px;font-size:9px;line-height:14px}._7CYAVW_archiveFilterCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;margin-left:auto;font-size:9px}._7CYAVW_archiveEmpty{color:var(--dsw-alias-label-tertiary);padding:4px 14px 2px;font-size:9px;display:block}@media (prefers-reduced-motion:reduce){._7CYAVW_panel,._7CYAVW_badge,._7CYAVW_badgeDot,._7CYAVW_panelDot,._7CYAVW_workGlyph rect,._7CYAVW_stateArt,._7CYAVW_memberAvatar[data-unread=true]:after{transition:none;animation:none}}@media (width<=960px){html[data-agent-team-web-panel-open] div[data-phase]{padding-right:0}._7CYAVW_team{padding:12px 12px 14px}._7CYAVW_delegationTree{margin-left:12px;padding-left:15px}._7CYAVW_memberBranch{width:15px}}@media (width<=640px){._7CYAVW_badge{top:56px;right:10px}._7CYAVW_teamStats span[data-stat=messages]{display:none}._7CYAVW_captainNode{grid-template-columns:48px minmax(0,1fr)}._7CYAVW_captainState{display:none}._7CYAVW_assignmentLine{padding-left:60px}}._7CYAVW_healthChip{box-sizing:border-box;background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;flex:none;align-items:center;gap:5px;padding:1px 8px;font-size:11px;line-height:16px;display:inline-flex}._7CYAVW_healthChip strong{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:11px;font-weight:700}._7CYAVW_healthChip em{color:var(--dsw-alias-label-secondary);font-style:normal}._7CYAVW_healthChip[data-level=ok] strong{color:var(--dsw-alias-state-success)}._7CYAVW_healthChip[data-level=warn] strong{color:var(--dsw-alias-state-warning)}._7CYAVW_healthChip[data-level=critical] strong,._7CYAVW_riskStat{color:var(--dsw-alias-state-danger)}._7CYAVW_prioritySection{flex-direction:column;gap:5px;min-width:0;display:flex}._7CYAVW_priorityCard{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);border-radius:8px;align-items:flex-start;gap:8px;padding:6px 8px;display:flex}._7CYAVW_priorityCard[data-severity=high]{border-color:color-mix(in srgb,var(--dsw-alias-state-danger) 45%,var(--dsw-alias-line-normal))}._7CYAVW_priorityCard[data-severity=medium]{border-color:color-mix(in srgb,var(--dsw-alias-state-warning) 40%,var(--dsw-alias-line-normal))}._7CYAVW_priorityBadge{background:var(--dsw-alias-bg-fill-business);min-width:22px;height:18px;color:var(--dsw-alias-label-on-fill);border-radius:6px;flex:none;justify-content:center;align-items:center;font-size:11px;font-weight:700;display:inline-flex}._7CYAVW_priorityBody{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}._7CYAVW_priorityTitle{flex-wrap:wrap;align-items:center;gap:5px;min-width:0;display:flex}._7CYAVW_priorityTitle strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}._7CYAVW_chip{background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;padding:0 6px;font-size:11px;font-style:normal;font-weight:600;line-height:16px;display:inline-flex}._7CYAVW_chip[data-readiness=blocked],._7CYAVW_chip[data-readiness=orphaned],._7CYAVW_chip[data-readiness=stalled],._7CYAVW_chip[data-readiness=failed],._7CYAVW_chip[data-severity=high]{border-color:var(--dsw-alias-state-danger);color:var(--dsw-alias-state-danger)}._7CYAVW_chip[data-severity=medium],._7CYAVW_chip[data-readiness=ready]{border-color:var(--dsw-alias-state-warning);color:var(--dsw-alias-state-warning)}._7CYAVW_chip[data-severity=low],._7CYAVW_chip[data-readiness=cancelled]{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary)}._7CYAVW_priorityReasons{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}._7CYAVW_milestoneRow{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;line-height:16px;display:flex}._7CYAVW_milestoneRow strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-weight:600;overflow:hidden}._7CYAVW_loadBar{background:var(--dsw-alias-line-strong);border-radius:999px;flex:none;align-items:stretch;width:44px;min-width:0;height:6px;display:inline-flex;overflow:hidden}._7CYAVW_loadBar>span{display:block}._7CYAVW_loadActive{background:var(--dsw-alias-state-business-primary)}._7CYAVW_loadPending{background:var(--dsw-alias-state-warning)}._7CYAVW_loadStalled,._7CYAVW_loadOrphaned{background:var(--dsw-alias-state-danger)}";
		...
		var ActivityPanel_module_css_default = {
			"agentTeamsBreathe": "_7CYAVW_agentTeamsBreathe",
			"agentTeamsDot": "_7CYAVW_agentTeamsDot",
			"agentTeamsFloat": "_7CYAVW_agentTeamsFloat",
			"agentTeamsPanelIn": "_7CYAVW_agentTeamsPanelIn",
			"agentTeamsPulse": "_7CYAVW_agentTeamsPulse",
			"agentTeamsThink": "_7CYAVW_agentTeamsThink",
			"agentTeamsUnreadPulse": "_7CYAVW_agentTeamsUnreadPulse",
			"archiveAction": "_7CYAVW_archiveAction",
			"archiveConfirm": "_7CYAVW_archiveConfirm",
			"archiveConfirmActions": "_7CYAVW_archiveConfirmActions",
			"archiveEmpty": "_7CYAVW_archiveEmpty",
			"archiveFilterBar": "_7CYAVW_archiveFilterBar",
			"archiveFilterCaption": "_7CYAVW_archiveFilterCaption",
			"archiveFilterCount": "_7CYAVW_archiveFilterCount",
			"archiveFilterField": "_7CYAVW_archiveFilterField",
			"archiveLabel": "_7CYAVW_archiveLabel",
			"archiveSelect": "_7CYAVW_archiveSelect",
			"assignmentChip": "_7CYAVW_assignmentChip",
			"assignmentLabel": "_7CYAVW_assignmentLabel",
			"assignmentLine": "_7CYAVW_assignmentLine",
			"assignmentTasks": "_7CYAVW_assignmentTasks",
			"badge": "_7CYAVW_badge",
			"badgeCount": "_7CYAVW_badgeCount",
			"badgeDot": "_7CYAVW_badgeDot",
			"blockedChip": "_7CYAVW_blockedChip",
			"calibrationChip": "_7CYAVW_calibrationChip",
			"captainAvatar": "_7CYAVW_captainAvatar",
			"captainInfo": "_7CYAVW_captainInfo",
			"captainLine": "_7CYAVW_captainLine",
			"captainName": "_7CYAVW_captainName",
			"captainNode": "_7CYAVW_captainNode",
			"captainRole": "_7CYAVW_captainRole",
			"captainState": "_7CYAVW_captainState",
			"captainSummary": "_7CYAVW_captainSummary",
			"chevron": "_7CYAVW_chevron",
			"chip": "_7CYAVW_chip",
			"closeError": "_7CYAVW_closeError",
			"commandLayer": "_7CYAVW_commandLayer",
			"commissarNode": "_7CYAVW_commissarNode",
			"commissarState": "_7CYAVW_commissarState",
			"connectionStatus": "_7CYAVW_connectionStatus",
			"dagCanvas": "_7CYAVW_dagCanvas",
			"dagEdges": "_7CYAVW_dagEdges",
			"dagNode": "_7CYAVW_dagNode",
			"dagNodeDot": "_7CYAVW_dagNodeDot",
			"dagNodeHead": "_7CYAVW_dagNodeHead",
			"dagNodeLabel": "_7CYAVW_dagNodeLabel",
			"dagRunningState": "_7CYAVW_dagRunningState",
			"dagViewport": "_7CYAVW_dagViewport",
			"delegationSection": "_7CYAVW_delegationSection",
			"delegationTree": "_7CYAVW_delegationTree",
			"dependencySection": "_7CYAVW_dependencySection",
			"diagnosticBanner": "_7CYAVW_diagnosticBanner",
			"emptyHint": "_7CYAVW_emptyHint",
			"healthChip": "_7CYAVW_healthChip",
			"helpingChip": "_7CYAVW_helpingChip",
			"historicPill": "_7CYAVW_historicPill",
			"historyToggle": "_7CYAVW_historyToggle",
			"iconButton": "_7CYAVW_iconButton",
			"inputChip": "_7CYAVW_inputChip",
			"leadAvatar": "_7CYAVW_leadAvatar",
			"loadActive": "_7CYAVW_loadActive",
			"loadBar": "_7CYAVW_loadBar",
			"loadOrphaned": "_7CYAVW_loadOrphaned",
			"loadPending": "_7CYAVW_loadPending",
			"loadStalled": "_7CYAVW_loadStalled",
			"memberArt": "_7CYAVW_memberArt",
			"memberAvatar": "_7CYAVW_memberAvatar",
			"memberBlock": "_7CYAVW_memberBlock",
			"memberBranch": "_7CYAVW_memberBranch",
			"memberCount": "_7CYAVW_memberCount",
			"memberElapsed": "_7CYAVW_memberElapsed",
			"memberInfo": "_7CYAVW_memberInfo",
			"memberInitial": "_7CYAVW_memberInitial",
			"memberLine": "_7CYAVW_memberLine",
			"memberModel": "_7CYAVW_memberModel",
			"memberName": "_7CYAVW_memberName",
			"memberRight": "_7CYAVW_memberRight",
			"memberRole": "_7CYAVW_memberRole",
			"memberRow": "_7CYAVW_memberRow",
			"memberState": "_7CYAVW_memberState",
			"memberStatusLine": "_7CYAVW_memberStatusLine",
			"members": "_7CYAVW_members",
			"membersToggle": "_7CYAVW_membersToggle",
			"milestoneRow": "_7CYAVW_milestoneRow",
			"modeBadge": "_7CYAVW_modeBadge",
			"modeHint": "_7CYAVW_modeHint",
			"panel": "_7CYAVW_panel",
			"panelControls": "_7CYAVW_panelControls",
			"panelDot": "_7CYAVW_panelDot",
			"panelHead": "_7CYAVW_panelHead",
			"panelTitle": "_7CYAVW_panelTitle",
			"priorityBadge": "_7CYAVW_priorityBadge",
			"priorityBody": "_7CYAVW_priorityBody",
			"priorityCard": "_7CYAVW_priorityCard",
			"priorityReasons": "_7CYAVW_priorityReasons",
			"prioritySection": "_7CYAVW_prioritySection",
			"priorityTitle": "_7CYAVW_priorityTitle",
			"progressEmpty": "_7CYAVW_progressEmpty",
			"progressLegend": "_7CYAVW_progressLegend",
			"progressOverview": "_7CYAVW_progressOverview",
			"progressSegments": "_7CYAVW_progressSegments",
			"progressSummary": "_7CYAVW_progressSummary",
			"progressSummaryDot": "_7CYAVW_progressSummaryDot",
			"progressTitle": "_7CYAVW_progressTitle",
			"resizeHandle": "_7CYAVW_resizeHandle",
			"reviewChip": "_7CYAVW_reviewChip",
			"riskStat": "_7CYAVW_riskStat",
			"sectionHead": "_7CYAVW_sectionHead",
			"sectionHint": "_7CYAVW_sectionHint",
			"sectionTitle": "_7CYAVW_sectionTitle",
			"sectionToggleTitle": "_7CYAVW_sectionToggleTitle",
			"stageLabel": "_7CYAVW_stageLabel",
			"stateArt": "_7CYAVW_stateArt",
			"taskDetail": "_7CYAVW_taskDetail",
			"taskDetailActions": "_7CYAVW_taskDetailActions",
			"taskDetailBadge": "_7CYAVW_taskDetailBadge",
			"taskDetailBlocked": "_7CYAVW_taskDetailBlocked",
			"taskDetailBudgetFact": "_7CYAVW_taskDetailBudgetFact",
			"taskDetailCalibration": "_7CYAVW_taskDetailCalibration",
			"taskDetailHead": "_7CYAVW_taskDetailHead",
			"taskDetailId": "_7CYAVW_taskDetailId",
			"taskDetailInput": "_7CYAVW_taskDetailInput",
			"taskDetailLine": "_7CYAVW_taskDetailLine",
			"taskDetailMeta": "_7CYAVW_taskDetailMeta",
			"taskDetailRetro": "_7CYAVW_taskDetailRetro",
			"taskDetailReview": "_7CYAVW_taskDetailReview",
			"taskDetailSignals": "_7CYAVW_taskDetailSignals",
			"taskDetailSubject": "_7CYAVW_taskDetailSubject",
			"taskDetailTiming": "_7CYAVW_taskDetailTiming",
			"taskEmpty": "_7CYAVW_taskEmpty",
			"taskId": "_7CYAVW_taskId",
			"team": "_7CYAVW_team",
			"teamHead": "_7CYAVW_teamHead",
			"teamName": "_7CYAVW_teamName",
			"teamStats": "_7CYAVW_teamStats",
			"teams": "_7CYAVW_teams",
			"timingChip": "_7CYAVW_timingChip",
			"unreadPill": "_7CYAVW_unreadPill",
			"workGlyph": "_7CYAVW_workGlyph"
		};
		//#endregion
		...
		*/
		...
		const cssText = ".QeF5Wq_section{flex-direction:column;gap:14px;display:flex}.QeF5Wq_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:10px;padding:14px 16px;display:flex}.QeF5Wq_head{align-items:center;gap:8px;display:flex}.QeF5Wq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.QeF5Wq_list{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.QeF5Wq_row{box-sizing:border-box;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;min-width:0;min-height:36px;padding:0 10px;display:flex}.QeF5Wq_nameWrap{flex:1;align-items:center;gap:8px;min-width:0;display:flex}.QeF5Wq_name{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.QeF5Wq_rowSub{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;line-height:16px}.QeF5Wq_pill{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.QeF5Wq_switch{box-sizing:border-box;background:var(--dsw-alias-border-l2);cursor:pointer;border:none;border-radius:999px;flex:none;width:32px;height:18px;padding:0;transition:background .12s ease-in-out;position:relative}.QeF5Wq_switch[data-on=true]{background:var(--dsw-alias-state-business-primary)}.QeF5Wq_switch:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.QeF5Wq_switchThumb{background:var(--dsw-alias-bg-layer-1);border-radius:50%;width:14px;height:14px;transition:transform .12s ease-in-out;position:absolute;top:2px;left:2px}.QeF5Wq_switch[data-on=true] .QeF5Wq_switchThumb{transform:translate(14px)}.QeF5Wq_select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;max-width:200px;color:var(--dsw-alias-label-primary);border-radius:6px;flex:1;padding:2px 4px;font-size:11px;line-height:16px}.QeF5Wq_select:disabled{opacity:.55}@media (prefers-color-scheme:dark){.QeF5Wq_select{color:#e8e8e8;background:#26282b}}.QeF5Wq_resetBtn{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;flex:none;margin-left:auto;padding:2px 10px;font-size:11px;line-height:16px;transition:color .12s ease-in-out,border-color .12s ease-in-out}.QeF5Wq_resetBtn:hover:not(:disabled){border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.QeF5Wq_resetBtn:disabled{opacity:.45;cursor:default}.QeF5Wq_presetPopover{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 56%, transparent);border-radius:10px;flex-direction:column;gap:8px;margin:2px 0 10px;padding:10px;display:flex}.QeF5Wq_presetTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}.QeF5Wq_presetHelp{color:var(--dsw-alias-label-tertiary);margin:0;font-size:11px;line-height:16px}.QeF5Wq_presetTabs{flex-wrap:wrap;gap:6px;display:flex}.QeF5Wq_presetTab{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:999px;padding:3px 8px;font-size:11px;line-height:16px}.QeF5Wq_presetTab[data-active=true]{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.QeF5Wq_presetList{flex-direction:column;gap:6px;display:flex}.QeF5Wq_presetItem{border:1px solid var(--dsw-alias-border-l2);color:inherit;text-align:left;cursor:pointer;background:0 0;border-radius:8px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.QeF5Wq_presetItem[data-active=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.QeF5Wq_presetItemHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.QeF5Wq_presetItemName{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:600;line-height:16px}.QeF5Wq_presetMetaRow{flex-wrap:wrap;gap:6px;display:flex}.QeF5Wq_presetMetaChip{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 46%, transparent);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 6px;font-size:10px;line-height:15px}.QeF5Wq_presetItemDesc{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.QeF5Wq_presetDiffBadge{color:var(--dsw-alias-label-secondary);flex:none;font-size:10px;line-height:15px}.QeF5Wq_presetActions{justify-content:flex-end;gap:8px;display:flex}.QeF5Wq_presetActionGhost,.QeF5Wq_presetActionPrimary{cursor:pointer;border-radius:6px;padding:3px 10px;font-size:11px;line-height:16px}.QeF5Wq_presetActionGhost{color:var(--dsw-alias-label-secondary);background:0 0;border:1px solid #0000}.QeF5Wq_presetActionPrimary{border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary);color:#fff}.QeF5Wq_empty{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 8px;font-size:11px;line-height:16px}.QeF5Wq_viewBtn{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex;position:relative}.QeF5Wq_viewBtn:hover{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.QeF5Wq_viewBtn:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.QeF5Wq_modalMask{z-index:100;background:#00000073;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.QeF5Wq_modal{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:12px;width:460px;max-width:100%;padding:16px;box-shadow:0 12px 40px #00000080}.QeF5Wq_modalHead{align-items:center;gap:8px;margin-bottom:12px;display:flex}.QeF5Wq_modalTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.QeF5Wq_modalClose{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;margin-left:auto;padding:2px 6px;font-size:13px;line-height:16px}.QeF5Wq_modalClose:hover{color:var(--dsw-alias-label-primary);background:#ffffff0f}.QeF5Wq_roleSlogan{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, transparent);color:var(--dsw-alias-state-business-primary);border-radius:8px;padding:8px 10px;font-size:13px;font-weight:500;line-height:20px}.QeF5Wq_modalSectionTitle{color:var(--dsw-alias-label-tertiary);margin:12px 0 6px;font-size:11px;line-height:16px}.QeF5Wq_dutyRow{gap:8px;padding:6px 10px;font-size:12px;line-height:20px;display:flex}.QeF5Wq_dutyRow+.QeF5Wq_dutyRow{border-top:1px dashed var(--dsw-alias-border-l2)}.QeF5Wq_dutyStep{color:var(--dsw-alias-label-secondary);flex:none;font-weight:500}.QeF5Wq_dutyDesc{color:var(--dsw-alias-label-primary)}.QeF5Wq_modalKv{align-items:center;gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.QeF5Wq_modalK{width:72px;color:var(--dsw-alias-label-tertiary);flex:none}.QeF5Wq_modalV{color:var(--dsw-alias-label-secondary);flex:1;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}.QeF5Wq_modalEmpty{color:var(--dsw-alias-label-tertiary);padding:6px 10px;font-size:12px;line-height:20px}.QeF5Wq_modalBody{max-height:min(52vh,420px);margin-right:-4px;padding-right:4px;overflow:auto}.QeF5Wq_ruleRow{gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.QeF5Wq_ruleBullet{color:var(--dsw-alias-state-business-primary);flex:none}.QeF5Wq_growthStat{color:var(--dsw-alias-label-primary);margin:0 0 8px;padding:0 10px;font-size:12px;line-height:20px}.QeF5Wq_growthList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.QeF5Wq_growthItem{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 40%, transparent);border-radius:8px;flex-direction:column;gap:2px;padding:8px 10px;display:flex}.QeF5Wq_growthPractice{color:var(--dsw-alias-label-primary);font-size:12px;line-height:20px}.QeF5Wq_growthMeta{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}";
		...
		var ProviderGrantsSection_module_css_default = {
			"card": "QeF5Wq_card",
			"dutyDesc": "QeF5Wq_dutyDesc",
			"dutyRow": "QeF5Wq_dutyRow",
			"dutyStep": "QeF5Wq_dutyStep",
			"empty": "QeF5Wq_empty",
			"growthItem": "QeF5Wq_growthItem",
			"growthList": "QeF5Wq_growthList",
			"growthMeta": "QeF5Wq_growthMeta",
			"growthPractice": "QeF5Wq_growthPractice",
			"growthStat": "QeF5Wq_growthStat",
			"head": "QeF5Wq_head",
			"list": "QeF5Wq_list",
			"modal": "QeF5Wq_modal",
			"modalBody": "QeF5Wq_modalBody",
			"modalClose": "QeF5Wq_modalClose",
			"modalEmpty": "QeF5Wq_modalEmpty",
			"modalHead": "QeF5Wq_modalHead",
			"modalK": "QeF5Wq_modalK",
			"modalKv": "QeF5Wq_modalKv",
			"modalMask": "QeF5Wq_modalMask",
			"modalSectionTitle": "QeF5Wq_modalSectionTitle",
			"modalTitle": "QeF5Wq_modalTitle",
			"modalV": "QeF5Wq_modalV",
			"name": "QeF5Wq_name",
			"nameWrap": "QeF5Wq_nameWrap",
			"pill": "QeF5Wq_pill",
			"presetActionGhost": "QeF5Wq_presetActionGhost",
			"presetActionPrimary": "QeF5Wq_presetActionPrimary",
			"presetActions": "QeF5Wq_presetActions",
			"presetDiffBadge": "QeF5Wq_presetDiffBadge",
			"presetHelp": "QeF5Wq_presetHelp",
			"presetItem": "QeF5Wq_presetItem",
			"presetItemDesc": "QeF5Wq_presetItemDesc",
			"presetItemHead": "QeF5Wq_presetItemHead",
			"presetItemName": "QeF5Wq_presetItemName",
			"presetList": "QeF5Wq_presetList",
			"presetMetaChip": "QeF5Wq_presetMetaChip",
			"presetMetaRow": "QeF5Wq_presetMetaRow",
			"presetPopover": "QeF5Wq_presetPopover",
			"presetTab": "QeF5Wq_presetTab",
			"presetTabs": "QeF5Wq_presetTabs",
			"presetTitle": "QeF5Wq_presetTitle",
			"resetBtn": "QeF5Wq_resetBtn",
			"roleSlogan": "QeF5Wq_roleSlogan",
			"row": "QeF5Wq_row",
			"rowSub": "QeF5Wq_rowSub",
			"ruleBullet": "QeF5Wq_ruleBullet",
			"ruleRow": "QeF5Wq_ruleRow",
			"section": "QeF5Wq_section",
			"select": "QeF5Wq_select",
			"switch": "QeF5Wq_switch",
			"switchThumb": "QeF5Wq_switchThumb",
			"title": "QeF5Wq_title",
			"viewBtn": "QeF5Wq_viewBtn"
		};
		//#endregion
