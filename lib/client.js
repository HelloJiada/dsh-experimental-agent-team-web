window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		const NO_REASONING_EFFORT_PROVIDERS = ["cc-switch"];
		/**
						...
						children: rows.map((row) => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
								...
								children: [
									...
									!isCaptain && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
