window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const cssText$2 = "._8bJKxa_root{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:8px;width:100%;min-width:0;padding:10px 12px;display:flex}._8bJKxa_head{align-items:center;gap:8px;min-width:0;display:flex}._8bJKxa_leadAvatar{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0;flex:none;width:30px;height:30px}._8bJKxa_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}._8bJKxa_memberCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;margin-left:auto;font-size:11px;line-height:16px}._8bJKxa_panelButton{border:1px solid var(--dsw-alias-line-strong);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;flex:none;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:16px;transition:border-color .12s,color .12s}._8bJKxa_panelButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}._8bJKxa_panelButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._8bJKxa_members{flex-wrap:wrap;gap:6px;min-width:0;display:flex}._8bJKxa_member{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:160px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:5px;padding:3px 8px 3px 3px;font-size:11px;font-weight:500;line-height:16px;transition:border-color .12s,background-color .12s;display:inline-flex}._8bJKxa_member:hover{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-fill-neutral)}._8bJKxa_member:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._8bJKxa_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d482e);background:0 0;border:0;border-radius:0;width:24px;height:24px}._8bJKxa_memberInitial{background:var(--dsw-alias-bg-fill-business);width:20px;height:20px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:10px;font-weight:600;line-height:20px;display:inline-flex}._8bJKxa_memberName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}";
		...
		var AgentTeamsCard_module_css_default = {
			"head": "_8bJKxa_head",
			"leadAvatar": "_8bJKxa_leadAvatar",
			"member": "_8bJKxa_member",
			"memberArt": "_8bJKxa_memberArt",
			"memberCount": "_8bJKxa_memberCount",
			"memberInitial": "_8bJKxa_memberInitial",
			"memberName": "_8bJKxa_memberName",
			"members": "_8bJKxa_members",
			"panelButton": "_8bJKxa_panelButton",
			"root": "_8bJKxa_root",
			"teamName": "_8bJKxa_teamName"
		};
		//#endregion
		...
		*/
		...
		const cssText$1 = "html{--agent-team-web-panel-shift:420px}html[data-agent-team-web-panel-open] div[data-phase]{box-sizing:border-box;padding-right:var(--agent-team-web-panel-shift)}.bhMr7a_badge,.bhMr7a_panel{--at-bg-panel:#fff;--at-bg-raised:#fafbfc;--at-bg-fill:#f4f6f9;--at-border:#e8ebf0;--at-border-strong:#d9dee8;--at-text-primary:#1b1f27;--at-text-secondary:#5a6474;--at-text-tertiary:#8f97a6;--at-accent:#2d5ca8;--at-accent-hover:#3568b8;--at-accent-strong:#244a8a;--at-success:#15875a;--at-warning:#a4681a;--at-danger:#c23b42;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #17203014;--at-shadow-panel:0 12px 32px #17203012, 0 32px 72px #1720301c;--at-shadow-active:0 16px 40px #1720301a, 0 36px 80px #17203024;--dsw-alias-bg-module:var(--at-bg-panel);--dsw-alias-bg-module-platform:var(--at-bg-raised);--dsw-alias-bg-fill-neutral:var(--at-bg-fill);--dsw-alias-bg-fill-business:var(--at-accent);--dsw-alias-bg-fill-success:var(--at-success);--dsw-alias-bg-fill-warning:var(--at-warning);--dsw-alias-bg-fill-danger:var(--at-danger);--dsw-alias-state-business-primary:var(--at-accent);--dsw-alias-state-success:var(--at-success);--dsw-alias-state-warning:var(--at-warning);--dsw-alias-state-danger:var(--at-danger);--dsw-alias-label-primary:var(--at-text-primary);--dsw-alias-label-secondary:var(--at-text-secondary);--dsw-alias-label-tertiary:var(--at-text-tertiary);--dsw-alias-label-on-fill:var(--at-on-accent);--dsw-alias-line-normal:var(--at-border);--dsw-alias-line-strong:var(--at-border-strong)}@media (prefers-color-scheme:dark){.bhMr7a_badge,.bhMr7a_panel{--at-bg-panel:#1e1f22;--at-bg-raised:#202125;--at-bg-fill:#2a2c30;--at-border:#2e3136;--at-border-strong:#3a3e45;--at-text-primary:#f5f6f8;--at-text-secondary:#b9bdc6;--at-text-tertiary:#8b90a0;--at-accent:#5b8dd9;--at-accent-hover:#6d9be0;--at-accent-strong:#4a7cc9;--at-success:#3ecf7f;--at-warning:#f0a83c;--at-danger:#f0606a;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #00000073;--at-shadow-panel:0 12px 32px #00000073, 0 32px 72px #0000008c;--at-shadow-active:0 16px 40px #00000080, 0 36px 80px #0009}.bhMr7a_stateArt{filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #00000073)}}.bhMr7a_badge{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:color-mix(in srgb, var(--dsw-alias-bg-module-platform) 92%, transparent);backdrop-filter:blur(16px);height:34px;box-shadow:var(--at-shadow-badge);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:7px;padding:0 12px;font-size:12px;font-weight:600;line-height:20px;transition:border-color .12s,transform .12s;display:inline-flex;position:absolute;top:64px;right:18px}.bhMr7a_badge:hover{border-color:var(--dsw-alias-line-strong);transform:translateY(-1px)}.bhMr7a_badge:active{transform:translateY(0)scale(.97)}.bhMr7a_badge:focus-visible,.bhMr7a_iconButton:focus-visible,.bhMr7a_memberRow:focus-visible,.bhMr7a_membersToggle:focus-visible,.bhMr7a_sectionToggleTitle:focus-visible,.bhMr7a_historyToggle:focus-visible,.bhMr7a_dagNode:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.bhMr7a_badgeDot,.bhMr7a_panelDot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:7px;height:7px}.bhMr7a_badgeDot[data-busy=true],.bhMr7a_panelDot[data-busy=true]{background:var(--dsw-alias-state-business-primary);animation:1.25s ease-in-out infinite bhMr7a_agentTeamsPulse}.bhMr7a_badgeCount,.bhMr7a_memberCount,.bhMr7a_teamStats,.bhMr7a_stageLabel,.bhMr7a_taskId{font-variant-numeric:tabular-nums}.bhMr7a_panel{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-line-strong) 58%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-module) 95%, transparent);backdrop-filter:blur(20px)saturate(1.08);box-shadow:var(--at-shadow-panel);will-change:transform;border-radius:16px;flex-direction:column;animation:.16s ease-out bhMr7a_agentTeamsPanelIn;display:flex;position:absolute;top:0;left:0;overflow:hidden}.bhMr7a_panel[data-dragging],.bhMr7a_panel[data-resizing]{user-select:none;box-shadow:var(--at-shadow-active)}@keyframes bhMr7a_agentTeamsPanelIn{0%{opacity:0}to{opacity:1}}@keyframes bhMr7a_agentTeamsPulse{0%,to{opacity:.42}50%{opacity:1}}.bhMr7a_panelHead{border-bottom:1px solid var(--dsw-alias-line-normal);cursor:grab;touch-action:none;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:0 14px;display:flex}.bhMr7a_panelHead:active,.bhMr7a_panel[data-dragging] .bhMr7a_panelHead{cursor:grabbing}.bhMr7a_panel[data-compact] .bhMr7a_panelHead{cursor:default;touch-action:auto}.bhMr7a_panelTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:8px;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}.bhMr7a_panelControls{flex:none;align-items:center;gap:2px;display:inline-flex}.bhMr7a_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,transform .12s;display:inline-flex}.bhMr7a_iconButton:hover{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-primary)}.bhMr7a_iconButton:active{transform:scale(.94)}.bhMr7a_iconButton[data-control=dock][data-mode=docked] svg{transform:scaleX(-1)}.bhMr7a_iconButton[data-control=close]:hover:not(:disabled){background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.bhMr7a_iconButton[data-control=close]:disabled{opacity:.45;cursor:not-allowed}.bhMr7a_closeError{color:var(--dsw-alias-state-danger);border-top:1px solid var(--dsw-alias-line-normal);padding:4px 14px;font-size:12px;line-height:16px}.bhMr7a_resizeHandle{z-index:1;touch-action:none;position:absolute}.bhMr7a_resizeHandle[data-resize-edge=left]{cursor:ew-resize;width:8px;top:44px;bottom:8px;left:0}.bhMr7a_resizeHandle[data-resize-edge=bottom]{cursor:ns-resize;height:8px;bottom:0;left:12px;right:12px}.bhMr7a_resizeHandle[data-resize-edge=corner]{cursor:nwse-resize;width:18px;height:18px;bottom:0;right:0}.bhMr7a_resizeHandle[data-resize-edge=corner]:after{border-right:1px solid var(--dsw-alias-label-tertiary);border-bottom:1px solid var(--dsw-alias-label-tertiary);content:\"\";opacity:.52;width:7px;height:7px;position:absolute;bottom:4px;right:4px}.bhMr7a_teams{overscroll-behavior:contain;scrollbar-color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent) transparent;scrollbar-width:thin;flex-direction:column;min-height:0;display:flex;overflow-y:auto}.bhMr7a_teams::-webkit-scrollbar{width:6px}.bhMr7a_teams::-webkit-scrollbar-track{background:0 0}.bhMr7a_teams::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent);background-clip:padding-box;border:2px solid #0000;border-radius:999px}.bhMr7a_teams:hover::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 44%, transparent);background-clip:padding-box}.bhMr7a_team{border-bottom:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:12px;padding:12px 14px 14px;display:flex}.bhMr7a_team:last-child{border-bottom:0}.bhMr7a_teamHead{align-items:center;gap:10px;min-width:0;display:flex}.bhMr7a_teamName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}.bhMr7a_teamStats{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;gap:8px;font-size:10px;line-height:16px;display:inline-flex}.bhMr7a_sectionHead{justify-content:space-between;align-items:center;gap:8px;min-width:0;display:flex}.bhMr7a_sectionTitle{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.bhMr7a_sectionHint{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.bhMr7a_delegationSection{flex-direction:column;gap:10px;min-width:0;display:flex}.bhMr7a_captainNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 32%, var(--dsw-alias-line-normal));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid}.bhMr7a_commandLayer{grid-template-columns:1fr;gap:10px;display:grid}.bhMr7a_commandLayer[data-leadership=solo]{grid-template-columns:1fr}.bhMr7a_commissarNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--at-accent) 32%, var(--at-border));background:color-mix(in srgb, var(--at-accent) 5%, var(--at-bg-panel));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid;position:relative}.bhMr7a_commissarNode:before{background:var(--at-accent);content:\"\";border-radius:2px;width:2px;position:absolute;top:8px;bottom:8px;left:0}.bhMr7a_commissarState{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;text-align:right;font-size:10px;line-height:14px;overflow:hidden}.bhMr7a_commissarState[data-activity=working]{color:var(--dsw-alias-state-business-primary);font-weight:600}.bhMr7a_captainAvatar,.bhMr7a_memberAvatar{flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}.bhMr7a_captainAvatar{width:46px;height:46px}.bhMr7a_leadAvatar,.bhMr7a_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0}.bhMr7a_leadAvatar{width:44px;height:44px}.bhMr7a_memberArt{width:40px;height:40px}.bhMr7a_captainInfo,.bhMr7a_memberInfo{flex-direction:column;min-width:0;display:flex}.bhMr7a_captainInfo{gap:2px}.bhMr7a_captainLine,.bhMr7a_memberLine{align-items:center;gap:6px;min-width:0;display:flex}.bhMr7a_captainName,.bhMr7a_memberName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:18px;overflow:hidden}.bhMr7a_captainRole,.bhMr7a_memberRole{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.bhMr7a_memberModel{color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 78%, transparent);text-overflow:ellipsis;white-space:nowrap;flex:none;margin-left:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:8px;line-height:12px;overflow:hidden}.bhMr7a_captainSummary,.bhMr7a_memberStatusLine{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:15px;overflow:hidden}.bhMr7a_memberElapsed{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:4px;flex:none;align-items:center;margin-left:6px;padding:0 4px;font-size:8.5px;font-weight:600;line-height:14px;display:inline-flex}.bhMr7a_memberElapsed[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 14%, transparent);color:var(--dsw-alias-state-warning)}.bhMr7a_memberElapsed[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 14%, transparent);color:var(--dsw-alias-state-danger)}.bhMr7a_captainState,.bhMr7a_memberState{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;align-items:center;gap:5px;font-size:10px;font-weight:500;line-height:15px;display:inline-flex}.bhMr7a_captainState[data-busy=true],.bhMr7a_memberState[data-activity=working]{color:var(--dsw-alias-state-business-primary)}.bhMr7a_workGlyph rect{opacity:.5}.bhMr7a_workGlyph[data-active=true] rect{animation:1.1s ease-in-out infinite bhMr7a_agentTeamsDot}@keyframes bhMr7a_agentTeamsDot{0%,to{opacity:.25}50%{opacity:1}}.bhMr7a_progressOverview{flex-direction:column;gap:7px;display:flex}.bhMr7a_progressTitle{color:var(--dsw-alias-label-secondary);font-size:11px;font-weight:600;line-height:16px}.bhMr7a_progressSegments{gap:3px;display:flex}.bhMr7a_progressSegments>span,.bhMr7a_progressEmpty{background:var(--dsw-alias-line-strong);border-radius:2px;flex:1;height:5px}.bhMr7a_progressEmpty{width:100%;display:block}.bhMr7a_progressSegments>span[data-state=running]{background:var(--dsw-alias-state-business-primary)}.bhMr7a_progressSegments>span[data-state=blocked]{background:var(--dsw-alias-state-warning)}.bhMr7a_progressSegments>span[data-state=completed]{background:var(--dsw-alias-state-success)}.bhMr7a_progressSegments>span[data-state=failed]{background:var(--dsw-alias-state-danger)}.bhMr7a_progressSegments>span[data-state=cancelled]{opacity:.55}.bhMr7a_progressLegend{color:var(--dsw-alias-label-tertiary);gap:10px;font-size:9px;line-height:14px;display:flex}.bhMr7a_progressLegend>span[data-state=running]{color:var(--dsw-alias-state-business-primary)}.bhMr7a_progressLegend>span[data-state=blocked]{color:var(--dsw-alias-state-warning)}.bhMr7a_progressLegend>span[data-state=completed]{color:var(--dsw-alias-state-success)}.bhMr7a_progressSummary{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));min-width:0;color:var(--dsw-alias-label-secondary);border-radius:8px;align-items:center;gap:6px;padding:5px 8px;font-size:10px;font-weight:600;line-height:15px;display:flex}.bhMr7a_progressSummary[data-state=warning]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 8%, var(--dsw-alias-bg-module))}.bhMr7a_progressSummary[data-state=completed]{background:color-mix(in srgb, var(--dsw-alias-state-success) 8%, var(--dsw-alias-bg-module))}.bhMr7a_progressSummary>span:last-child{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.bhMr7a_progressSummaryDot{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:5px;height:5px}.bhMr7a_progressSummary[data-state=warning] .bhMr7a_progressSummaryDot{background:var(--dsw-alias-state-warning)}.bhMr7a_progressSummary[data-state=completed] .bhMr7a_progressSummaryDot{background:var(--dsw-alias-state-success)}.bhMr7a_membersToggle{background:var(--dsw-alias-bg-module-platform);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.bhMr7a_membersToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.bhMr7a_membersToggle>span{align-items:center;gap:5px;display:inline-flex}.bhMr7a_membersToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.bhMr7a_historyToggle{background:var(--dsw-alias-bg-module);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.bhMr7a_historyToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.bhMr7a_historyToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.bhMr7a_chevron{flex:none;transition:transform .12s}.bhMr7a_chevron[data-open=true]{transform:rotate(90deg)}.bhMr7a_delegationTree{flex-direction:column;gap:2px;margin-left:18px;padding:0 0 0 20px;display:flex;position:relative}.bhMr7a_delegationTree:before{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));content:\"\";width:1px;position:absolute;top:0;bottom:22px;left:0}.bhMr7a_memberBlock{flex-direction:column;min-width:0;padding:3px 0 7px;display:flex;position:relative}.bhMr7a_memberBranch{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));width:20px;height:1px;display:block;position:absolute;top:27px;right:100%}.bhMr7a_memberBranch:before{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:5px;height:5px;position:absolute;top:-2px;right:-1px}.bhMr7a_memberRow{box-sizing:border-box;width:100%;min-width:0;min-height:48px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:46px minmax(0,1fr) auto;align-items:center;gap:8px;padding:4px 6px;transition:background-color .12s,transform .12s;display:grid}.bhMr7a_memberRow:hover,.bhMr7a_memberRow[data-activity=working]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.bhMr7a_memberRow:active{transform:scale(.99)}.bhMr7a_memberAvatar{width:42px;height:42px}.bhMr7a_memberAvatar[data-unread=true]:after{box-sizing:border-box;border:1px solid var(--dsw-alias-bg-module);background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:6px;height:6px;animation:1.8s ease-in-out infinite bhMr7a_agentTeamsUnreadPulse;position:absolute;top:0;right:-1px}@keyframes bhMr7a_agentTeamsUnreadPulse{0%,to{opacity:.78;transform:scale(.92)}50%{opacity:1;transform:scale(1.16)}}.bhMr7a_memberInitial{background:var(--dsw-alias-bg-fill-business);width:38px;height:38px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:15px;font-weight:600;line-height:20px;display:inline-flex}.bhMr7a_stateArt{box-sizing:border-box;object-fit:contain;width:22px;height:22px;filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #122d483d);background:0 0;border:0;border-radius:0;position:absolute;bottom:-3px;right:-5px}.bhMr7a_stateArt[data-activity=working]{animation:2.4s ease-in-out infinite bhMr7a_agentTeamsFloat}.bhMr7a_stateArt[data-activity=idle]{animation:4.2s ease-in-out infinite bhMr7a_agentTeamsBreathe}.bhMr7a_stateArt[data-activity=unknown]{animation:2.8s ease-in-out infinite bhMr7a_agentTeamsThink}@keyframes bhMr7a_agentTeamsFloat{0%,to{transform:translateY(0)rotate(-4deg)}50%{transform:translateY(-2px)rotate(4deg)}}@keyframes bhMr7a_agentTeamsBreathe{0%,to{opacity:.82;transform:scale(1)}50%{opacity:1;transform:scale(1.06)}}@keyframes bhMr7a_agentTeamsThink{0%,to{transform:rotate(-7deg)}50%{transform:rotate(7deg)}}.bhMr7a_memberRight{flex:none;align-items:center;gap:8px;display:inline-flex}.bhMr7a_memberCount{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}.bhMr7a_assignmentLine{align-items:center;gap:7px;min-width:0;padding:0 6px 0 60px;display:flex}.bhMr7a_assignmentLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:9px;line-height:14px}.bhMr7a_assignmentTasks{flex-wrap:wrap;flex:1;gap:4px;min-width:0;display:flex}.bhMr7a_assignmentChip{background:var(--dsw-alias-bg-fill-neutral);min-height:16px;color:var(--dsw-alias-label-secondary);border-radius:4px;align-items:center;padding:0 5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:600;line-height:14px;display:inline-flex}.bhMr7a_assignmentChip[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.bhMr7a_assignmentChip[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.bhMr7a_assignmentChip[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.bhMr7a_assignmentChip[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.bhMr7a_assignmentChip[data-state=cancelled]{color:var(--dsw-alias-label-tertiary);text-decoration:line-through}.bhMr7a_assignmentChip[data-review=pending]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.bhMr7a_assignmentChip[data-helping=true]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 50%, transparent);outline-offset:-1px}.bhMr7a_reviewChip,.bhMr7a_helpingChip,.bhMr7a_calibrationChip,.bhMr7a_blockedChip,.bhMr7a_inputChip{box-sizing:border-box;white-space:nowrap;min-height:16px;color:inherit;background:0 0;border-radius:4px;flex:none;align-items:center;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.bhMr7a_reviewChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-state-warning) 70%, transparent);outline-offset:-1px}.bhMr7a_blockedChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 75%, transparent);outline-offset:-1px}.bhMr7a_inputChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.bhMr7a_helpingChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 65%, transparent);outline-offset:-1px}.bhMr7a_calibrationChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.bhMr7a_assignmentChip[data-timing=warn]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.bhMr7a_assignmentChip[data-timing=over]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-danger) 62%, transparent);outline-offset:-1px}.bhMr7a_timingChip{box-sizing:border-box;white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:16px;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.bhMr7a_timingChip[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 16%, transparent);color:var(--dsw-alias-state-warning)}.bhMr7a_timingChip[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 16%, transparent);color:var(--dsw-alias-state-danger)}.bhMr7a_unreadPill{color:var(--dsw-alias-state-business-primary);white-space:nowrap;flex:none;font-size:9px;font-weight:600;line-height:14px}.bhMr7a_taskEmpty{color:var(--dsw-alias-label-tertiary);font-size:9px;line-height:14px}.bhMr7a_dependencySection{border-top:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:7px;min-width:0;padding-top:10px;display:flex}.bhMr7a_sectionToggleTitle{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.bhMr7a_dagViewport{scrollbar-width:thin;min-width:0;padding:2px 0 4px;overflow-x:auto}.bhMr7a_dagCanvas{min-width:100%;position:relative}.bhMr7a_dagCanvas[data-layout=parallel]{flex-wrap:wrap;gap:8px;display:flex}.bhMr7a_dagCanvas[data-layout=parallel] .bhMr7a_dagNode{flex:92px;min-width:92px;position:relative}.bhMr7a_dagEdges{pointer-events:none;position:absolute;inset:0;overflow:visible}.bhMr7a_dagEdges path{fill:none;stroke:var(--dsw-alias-line-strong);stroke-width:1px;transition:opacity .12s,stroke .12s,stroke-width .12s}.bhMr7a_dagEdges path[data-active=true]{stroke:var(--dsw-alias-state-business-primary);stroke-width:1.6px}.bhMr7a_dagEdges path[data-dimmed=true]{opacity:.24}.bhMr7a_dagNode{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:6px;flex-direction:column;justify-content:center;gap:1px;padding:0 6px;transition:border-color .12s,background-color .12s,opacity .12s;display:flex;position:absolute}.bhMr7a_dagNode:hover,.bhMr7a_dagNode[data-focused=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.bhMr7a_dagNode[data-dimmed=true]{opacity:.3}.bhMr7a_dagNode[data-state=running][data-dimmed=true]{opacity:.58}.bhMr7a_dagNode[data-state=completed]{border-color:color-mix(in srgb, var(--dsw-alias-state-success) 48%, var(--dsw-alias-line-normal))}.bhMr7a_dagNode[data-state=blocked]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 52%, var(--dsw-alias-line-normal))}.bhMr7a_dagNode[data-review=pending]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.bhMr7a_dagNode[data-helping=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 70%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-business-primary) 38%, transparent)}.bhMr7a_dagNode[data-timing=warn]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.bhMr7a_dagNode[data-timing=over]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-danger) 46%, transparent)}.bhMr7a_dagNode[data-state=failed]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 56%, var(--dsw-alias-line-normal))}.bhMr7a_dagNodeHead{color:var(--dsw-alias-label-primary);align-items:center;gap:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:700;display:flex}.bhMr7a_dagNodeDot{background:var(--dsw-alias-line-strong);border-radius:2px;flex:none;width:5px;height:5px}.bhMr7a_dagNode[data-state=running] .bhMr7a_dagNodeDot{background:var(--dsw-alias-state-business-primary)}.bhMr7a_dagNode[data-state=running] .bhMr7a_dagNodeHead{padding-right:12px}.bhMr7a_dagRunningState{width:9px;height:9px;color:var(--dsw-alias-state-business-primary);pointer-events:none;justify-content:center;align-items:center;display:inline-flex;position:absolute;top:4px;right:5px}.bhMr7a_dagRunningState .bhMr7a_workGlyph{width:9px;height:9px}.bhMr7a_dagNode[data-state=blocked] .bhMr7a_dagNodeDot{background:var(--dsw-alias-state-warning)}.bhMr7a_dagNode[data-state=completed] .bhMr7a_dagNodeDot{background:var(--dsw-alias-state-success)}.bhMr7a_dagNode[data-state=failed] .bhMr7a_dagNodeDot{background:var(--dsw-alias-state-danger)}.bhMr7a_dagNodeLabel{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:11px;overflow:hidden}.bhMr7a_taskDetail{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:8px;flex-direction:column;gap:3px;min-width:0;padding:7px 9px;display:flex}.bhMr7a_taskDetailHead{align-items:center;gap:6px;min-width:0;display:flex}.bhMr7a_taskDetailId{color:var(--dsw-alias-state-business-primary);flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;font-weight:700}.bhMr7a_taskDetailSubject{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.bhMr7a_taskDetailBadge{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:8.5px;font-weight:600;line-height:14px}.bhMr7a_taskDetailBadge[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.bhMr7a_taskDetailBadge[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.bhMr7a_taskDetailBadge[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.bhMr7a_taskDetailBadge[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.bhMr7a_taskDetailLine,.bhMr7a_taskDetailMeta{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.bhMr7a_taskDetailMeta{color:var(--dsw-alias-label-tertiary)}.bhMr7a_archiveAction{color:var(--dsw-alias-state-danger);background:color-mix(in srgb, var(--dsw-alias-state-danger) 12%, transparent);cursor:pointer;border:0;border-radius:5px;padding:3px 6px;font-size:9px}.bhMr7a_archiveAction:disabled{opacity:.55;cursor:not-allowed}.bhMr7a_diagnosticBanner{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-warning) 10%, var(--dsw-alias-bg-module));flex-wrap:wrap;align-items:flex-start;gap:6px 8px;padding:7px 10px;font-size:11px;line-height:16px;display:flex}.bhMr7a_diagnosticBanner button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-fill-neutral);cursor:pointer;border:0;border-radius:4px;padding:2px 6px}.bhMr7a_archiveConfirm{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-danger) 10%, var(--dsw-alias-background-base));justify-content:space-between;gap:8px;padding:7px 10px;font-size:10px;display:flex}.bhMr7a_archiveConfirmActions{gap:5px;display:flex}.bhMr7a_archiveConfirmActions button{cursor:pointer;border:0;border-radius:4px;padding:3px 6px}.bhMr7a_connectionStatus{color:var(--dsw-alias-label-tertiary);margin-left:5px;font-size:9px;font-weight:400}.bhMr7a_connectionStatus[data-connection=stale],.bhMr7a_connectionStatus[data-connection=offline],.bhMr7a_connectionStatus[data-connection=auth-failed]{color:var(--dsw-alias-state-warning)}.bhMr7a_taskDetailActions{gap:6px;margin-top:3px;display:flex}.bhMr7a_taskDetailActions button{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;padding:1px 4px;font-size:9px}.bhMr7a_taskDetailTiming{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.bhMr7a_taskDetailTiming[data-timing=warn]{color:var(--dsw-alias-state-warning)}.bhMr7a_taskDetailTiming[data-timing=over]{color:var(--dsw-alias-state-danger);font-weight:600}.bhMr7a_taskDetailBudgetFact{color:var(--dsw-alias-label-secondary);font-size:11px;line-height:16px}.bhMr7a_taskDetailBudgetFact[data-budget-fact=over_budget]{color:var(--dsw-alias-state-warning);font-weight:700}.bhMr7a_taskDetailBudgetFact[data-budget-fact=within_budget]{color:var(--dsw-alias-state-success)}.bhMr7a_taskDetailSignals,.bhMr7a_taskDetailRetro{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:13px;overflow:hidden}.bhMr7a_taskDetail[data-expanded] .bhMr7a_taskDetailSignals,.bhMr7a_taskDetail[data-expanded] .bhMr7a_taskDetailRetro{overflow-wrap:anywhere;text-overflow:clip;white-space:normal;font-size:12px;line-height:18px;overflow:visible}.bhMr7a_taskDetail[data-expanded] .bhMr7a_taskDetailActions{margin-top:7px}.bhMr7a_taskDetailActions button{min-height:32px}.bhMr7a_taskDetailActions button:focus-visible,.bhMr7a_archiveAction:focus-visible,.bhMr7a_archiveConfirmActions button:focus-visible{outline:2px solid var(--dsw-alias-state-primary);outline-offset:2px}.bhMr7a_taskDetailRetro[data-cause=underestimated],.bhMr7a_taskDetailRetro[data-cause=dependency-blocked]{color:var(--dsw-alias-state-danger)}.bhMr7a_taskDetailRetro[data-cause=on_time]{color:var(--dsw-alias-state-success)}.bhMr7a_taskDetailReview{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:600;line-height:14px}.bhMr7a_taskDetailReview[data-verdict=pass]{color:var(--dsw-alias-state-success)}.bhMr7a_taskDetailReview[data-verdict=reject]{color:var(--dsw-alias-state-danger)}.bhMr7a_taskDetailCalibration{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.bhMr7a_taskDetailBlocked{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:700;line-height:14px}.bhMr7a_taskDetailInput{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.bhMr7a_emptyHint{color:var(--dsw-alias-label-tertiary);padding:10px 14px;font-size:11px;line-height:16px}.bhMr7a_modeHint{color:var(--dsw-alias-label-secondary);padding:0 14px 6px;font-size:11px;line-height:16px;display:block}.bhMr7a_modeBadge{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 7px;font-size:11px;font-weight:600;line-height:16px}.bhMr7a_modeBadge[data-mode=light]{color:var(--dsw-alias-label-secondary)}.bhMr7a_modeBadge[data-mode=standard]{color:var(--dsw-alias-state-business-primary)}.bhMr7a_modeBadge[data-mode=governed]{color:var(--dsw-alias-state-warning)}.bhMr7a_historicPill{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;margin-left:auto;padding:1px 7px;font-size:9px;font-weight:600;line-height:15px}.bhMr7a_members{flex-direction:column;gap:3px;display:flex}.bhMr7a_archiveLabel{color:var(--dsw-alias-label-tertiary);padding:5px 14px 0;font-size:9px;font-weight:600;line-height:14px;display:block}.bhMr7a_archiveFilterBar{flex-wrap:wrap;align-items:center;gap:6px 8px;padding:6px 14px 2px;display:flex}.bhMr7a_archiveFilterField{color:var(--dsw-alias-label-tertiary);align-items:center;gap:4px;font-size:9px;line-height:14px;display:inline-flex}.bhMr7a_archiveFilterCaption{white-space:nowrap;font-weight:600}.bhMr7a_archiveSelect{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:120px;color:var(--dsw-alias-label-primary);border-radius:4px;padding:1px 2px;font-size:9px;line-height:14px}.bhMr7a_archiveFilterCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;margin-left:auto;font-size:9px}.bhMr7a_archiveEmpty{color:var(--dsw-alias-label-tertiary);padding:4px 14px 2px;font-size:9px;display:block}@media (prefers-reduced-motion:reduce){.bhMr7a_panel,.bhMr7a_badge,.bhMr7a_badgeDot,.bhMr7a_panelDot,.bhMr7a_workGlyph rect,.bhMr7a_stateArt,.bhMr7a_memberAvatar[data-unread=true]:after{transition:none;animation:none}}@media (width<=960px){html[data-agent-team-web-panel-open] div[data-phase]{padding-right:0}.bhMr7a_team{padding:12px 12px 14px}.bhMr7a_delegationTree{margin-left:12px;padding-left:15px}.bhMr7a_memberBranch{width:15px}}@media (width<=640px){.bhMr7a_badge{top:56px;right:10px}.bhMr7a_teamStats span[data-stat=messages]{display:none}.bhMr7a_captainNode{grid-template-columns:48px minmax(0,1fr)}.bhMr7a_captainState{display:none}.bhMr7a_assignmentLine{padding-left:60px}}.bhMr7a_healthChip{box-sizing:border-box;background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;flex:none;align-items:center;gap:5px;padding:1px 8px;font-size:11px;line-height:16px;display:inline-flex}.bhMr7a_healthChip strong{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:11px;font-weight:700}.bhMr7a_healthChip em{color:var(--dsw-alias-label-secondary);font-style:normal}.bhMr7a_healthChip[data-level=ok] strong{color:var(--dsw-alias-state-success)}.bhMr7a_healthChip[data-level=warn] strong{color:var(--dsw-alias-state-warning)}.bhMr7a_healthChip[data-level=critical] strong,.bhMr7a_riskStat{color:var(--dsw-alias-state-danger)}.bhMr7a_prioritySection{flex-direction:column;gap:5px;min-width:0;display:flex}.bhMr7a_priorityCard{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);border-radius:8px;align-items:flex-start;gap:8px;padding:6px 8px;display:flex}.bhMr7a_priorityCard[data-severity=high]{border-color:color-mix(in srgb,var(--dsw-alias-state-danger) 45%,var(--dsw-alias-line-normal))}.bhMr7a_priorityCard[data-severity=medium]{border-color:color-mix(in srgb,var(--dsw-alias-state-warning) 40%,var(--dsw-alias-line-normal))}.bhMr7a_priorityBadge{background:var(--dsw-alias-bg-fill-business);min-width:22px;height:18px;color:var(--dsw-alias-label-on-fill);border-radius:6px;flex:none;justify-content:center;align-items:center;font-size:11px;font-weight:700;display:inline-flex}.bhMr7a_priorityBody{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.bhMr7a_priorityTitle{flex-wrap:wrap;align-items:center;gap:5px;min-width:0;display:flex}.bhMr7a_priorityTitle strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.bhMr7a_chip{background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;padding:0 6px;font-size:11px;font-style:normal;font-weight:600;line-height:16px;display:inline-flex}.bhMr7a_chip[data-readiness=blocked],.bhMr7a_chip[data-readiness=orphaned],.bhMr7a_chip[data-readiness=stalled],.bhMr7a_chip[data-readiness=failed],.bhMr7a_chip[data-severity=high]{border-color:var(--dsw-alias-state-danger);color:var(--dsw-alias-state-danger)}.bhMr7a_chip[data-severity=medium],.bhMr7a_chip[data-readiness=ready]{border-color:var(--dsw-alias-state-warning);color:var(--dsw-alias-state-warning)}.bhMr7a_chip[data-severity=low],.bhMr7a_chip[data-readiness=cancelled]{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary)}.bhMr7a_priorityReasons{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.bhMr7a_milestoneRow{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;line-height:16px;display:flex}.bhMr7a_milestoneRow strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-weight:600;overflow:hidden}.bhMr7a_loadBar{background:var(--dsw-alias-line-strong);border-radius:999px;flex:none;align-items:stretch;width:44px;min-width:0;height:6px;display:inline-flex;overflow:hidden}.bhMr7a_loadBar>span{display:block}.bhMr7a_loadActive{background:var(--dsw-alias-state-business-primary)}.bhMr7a_loadPending{background:var(--dsw-alias-state-warning)}.bhMr7a_loadStalled,.bhMr7a_loadOrphaned{background:var(--dsw-alias-state-danger)}";
		...
		var ActivityPanel_module_css_default = {
			"agentTeamsBreathe": "bhMr7a_agentTeamsBreathe",
			"agentTeamsDot": "bhMr7a_agentTeamsDot",
			"agentTeamsFloat": "bhMr7a_agentTeamsFloat",
			"agentTeamsPanelIn": "bhMr7a_agentTeamsPanelIn",
			"agentTeamsPulse": "bhMr7a_agentTeamsPulse",
			"agentTeamsThink": "bhMr7a_agentTeamsThink",
			"agentTeamsUnreadPulse": "bhMr7a_agentTeamsUnreadPulse",
			"archiveAction": "bhMr7a_archiveAction",
			"archiveConfirm": "bhMr7a_archiveConfirm",
			"archiveConfirmActions": "bhMr7a_archiveConfirmActions",
			"archiveEmpty": "bhMr7a_archiveEmpty",
			"archiveFilterBar": "bhMr7a_archiveFilterBar",
			"archiveFilterCaption": "bhMr7a_archiveFilterCaption",
			"archiveFilterCount": "bhMr7a_archiveFilterCount",
			"archiveFilterField": "bhMr7a_archiveFilterField",
			"archiveLabel": "bhMr7a_archiveLabel",
			"archiveSelect": "bhMr7a_archiveSelect",
			"assignmentChip": "bhMr7a_assignmentChip",
			"assignmentLabel": "bhMr7a_assignmentLabel",
			"assignmentLine": "bhMr7a_assignmentLine",
			"assignmentTasks": "bhMr7a_assignmentTasks",
			"badge": "bhMr7a_badge",
			"badgeCount": "bhMr7a_badgeCount",
			"badgeDot": "bhMr7a_badgeDot",
			"blockedChip": "bhMr7a_blockedChip",
			"calibrationChip": "bhMr7a_calibrationChip",
			"captainAvatar": "bhMr7a_captainAvatar",
			"captainInfo": "bhMr7a_captainInfo",
			"captainLine": "bhMr7a_captainLine",
			"captainName": "bhMr7a_captainName",
			"captainNode": "bhMr7a_captainNode",
			"captainRole": "bhMr7a_captainRole",
			"captainState": "bhMr7a_captainState",
			"captainSummary": "bhMr7a_captainSummary",
			"chevron": "bhMr7a_chevron",
			"chip": "bhMr7a_chip",
			"closeError": "bhMr7a_closeError",
			"commandLayer": "bhMr7a_commandLayer",
			"commissarNode": "bhMr7a_commissarNode",
			"commissarState": "bhMr7a_commissarState",
			"connectionStatus": "bhMr7a_connectionStatus",
			"dagCanvas": "bhMr7a_dagCanvas",
			"dagEdges": "bhMr7a_dagEdges",
			"dagNode": "bhMr7a_dagNode",
			"dagNodeDot": "bhMr7a_dagNodeDot",
			"dagNodeHead": "bhMr7a_dagNodeHead",
			"dagNodeLabel": "bhMr7a_dagNodeLabel",
			"dagRunningState": "bhMr7a_dagRunningState",
			"dagViewport": "bhMr7a_dagViewport",
			"delegationSection": "bhMr7a_delegationSection",
			"delegationTree": "bhMr7a_delegationTree",
			"dependencySection": "bhMr7a_dependencySection",
			"diagnosticBanner": "bhMr7a_diagnosticBanner",
			"emptyHint": "bhMr7a_emptyHint",
			"healthChip": "bhMr7a_healthChip",
			"helpingChip": "bhMr7a_helpingChip",
			"historicPill": "bhMr7a_historicPill",
			"historyToggle": "bhMr7a_historyToggle",
			"iconButton": "bhMr7a_iconButton",
			"inputChip": "bhMr7a_inputChip",
			"leadAvatar": "bhMr7a_leadAvatar",
			"loadActive": "bhMr7a_loadActive",
			"loadBar": "bhMr7a_loadBar",
			"loadOrphaned": "bhMr7a_loadOrphaned",
			"loadPending": "bhMr7a_loadPending",
			"loadStalled": "bhMr7a_loadStalled",
			"memberArt": "bhMr7a_memberArt",
			"memberAvatar": "bhMr7a_memberAvatar",
			"memberBlock": "bhMr7a_memberBlock",
			"memberBranch": "bhMr7a_memberBranch",
			"memberCount": "bhMr7a_memberCount",
			"memberElapsed": "bhMr7a_memberElapsed",
			"memberInfo": "bhMr7a_memberInfo",
			"memberInitial": "bhMr7a_memberInitial",
			"memberLine": "bhMr7a_memberLine",
			"memberModel": "bhMr7a_memberModel",
			"memberName": "bhMr7a_memberName",
			"memberRight": "bhMr7a_memberRight",
			"memberRole": "bhMr7a_memberRole",
			"memberRow": "bhMr7a_memberRow",
			"memberState": "bhMr7a_memberState",
			"memberStatusLine": "bhMr7a_memberStatusLine",
			"members": "bhMr7a_members",
			"membersToggle": "bhMr7a_membersToggle",
			"milestoneRow": "bhMr7a_milestoneRow",
			"modeBadge": "bhMr7a_modeBadge",
			"modeHint": "bhMr7a_modeHint",
			"panel": "bhMr7a_panel",
			"panelControls": "bhMr7a_panelControls",
			"panelDot": "bhMr7a_panelDot",
			"panelHead": "bhMr7a_panelHead",
			"panelTitle": "bhMr7a_panelTitle",
			"priorityBadge": "bhMr7a_priorityBadge",
			"priorityBody": "bhMr7a_priorityBody",
			"priorityCard": "bhMr7a_priorityCard",
			"priorityReasons": "bhMr7a_priorityReasons",
			"prioritySection": "bhMr7a_prioritySection",
			"priorityTitle": "bhMr7a_priorityTitle",
			"progressEmpty": "bhMr7a_progressEmpty",
			"progressLegend": "bhMr7a_progressLegend",
			"progressOverview": "bhMr7a_progressOverview",
			"progressSegments": "bhMr7a_progressSegments",
			"progressSummary": "bhMr7a_progressSummary",
			"progressSummaryDot": "bhMr7a_progressSummaryDot",
			"progressTitle": "bhMr7a_progressTitle",
			"resizeHandle": "bhMr7a_resizeHandle",
			"reviewChip": "bhMr7a_reviewChip",
			"riskStat": "bhMr7a_riskStat",
			"sectionHead": "bhMr7a_sectionHead",
			"sectionHint": "bhMr7a_sectionHint",
			"sectionTitle": "bhMr7a_sectionTitle",
			"sectionToggleTitle": "bhMr7a_sectionToggleTitle",
			"stageLabel": "bhMr7a_stageLabel",
			"stateArt": "bhMr7a_stateArt",
			"taskDetail": "bhMr7a_taskDetail",
			"taskDetailActions": "bhMr7a_taskDetailActions",
			"taskDetailBadge": "bhMr7a_taskDetailBadge",
			"taskDetailBlocked": "bhMr7a_taskDetailBlocked",
			"taskDetailBudgetFact": "bhMr7a_taskDetailBudgetFact",
			"taskDetailCalibration": "bhMr7a_taskDetailCalibration",
			"taskDetailHead": "bhMr7a_taskDetailHead",
			"taskDetailId": "bhMr7a_taskDetailId",
			"taskDetailInput": "bhMr7a_taskDetailInput",
			"taskDetailLine": "bhMr7a_taskDetailLine",
			"taskDetailMeta": "bhMr7a_taskDetailMeta",
			"taskDetailRetro": "bhMr7a_taskDetailRetro",
			"taskDetailReview": "bhMr7a_taskDetailReview",
			"taskDetailSignals": "bhMr7a_taskDetailSignals",
			"taskDetailSubject": "bhMr7a_taskDetailSubject",
			"taskDetailTiming": "bhMr7a_taskDetailTiming",
			"taskEmpty": "bhMr7a_taskEmpty",
			"taskId": "bhMr7a_taskId",
			"team": "bhMr7a_team",
			"teamHead": "bhMr7a_teamHead",
			"teamName": "bhMr7a_teamName",
			"teamStats": "bhMr7a_teamStats",
			"teams": "bhMr7a_teams",
			"timingChip": "bhMr7a_timingChip",
			"unreadPill": "bhMr7a_unreadPill",
			"workGlyph": "bhMr7a_workGlyph"
		};
		//#endregion
		...
		*/
		...
		const cssText = ".FLE8Ga_section{flex-direction:column;gap:14px;display:flex}.FLE8Ga_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:10px;padding:14px 16px;display:flex}.FLE8Ga_head{align-items:center;gap:8px;display:flex}.FLE8Ga_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.FLE8Ga_list{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.FLE8Ga_row{box-sizing:border-box;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;min-width:0;min-height:36px;padding:0 10px;display:flex}.FLE8Ga_nameWrap{flex:1;align-items:center;gap:8px;min-width:0;display:flex}.FLE8Ga_name{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.FLE8Ga_rowSub{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;line-height:16px}.FLE8Ga_pill{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.FLE8Ga_switch{box-sizing:border-box;background:var(--dsw-alias-border-l2);cursor:pointer;border:none;border-radius:999px;flex:none;width:32px;height:18px;padding:0;transition:background .12s ease-in-out;position:relative}.FLE8Ga_switch[data-on=true]{background:var(--dsw-alias-state-business-primary)}.FLE8Ga_switch:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.FLE8Ga_switchThumb{background:var(--dsw-alias-bg-layer-1);border-radius:50%;width:14px;height:14px;transition:transform .12s ease-in-out;position:absolute;top:2px;left:2px}.FLE8Ga_switch[data-on=true] .FLE8Ga_switchThumb{transform:translate(14px)}.FLE8Ga_select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;max-width:200px;color:var(--dsw-alias-label-primary);border-radius:6px;flex:1;padding:2px 4px;font-size:11px;line-height:16px}.FLE8Ga_select:disabled{opacity:.55}@media (prefers-color-scheme:dark){.FLE8Ga_select{color:#e8e8e8;background:#26282b}}.FLE8Ga_resetBtn{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;flex:none;margin-left:auto;padding:2px 10px;font-size:11px;line-height:16px;transition:color .12s ease-in-out,border-color .12s ease-in-out}.FLE8Ga_resetBtn:hover:not(:disabled){border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.FLE8Ga_resetBtn:disabled{opacity:.45;cursor:default}.FLE8Ga_presetPopover{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 56%, transparent);border-radius:10px;flex-direction:column;gap:8px;margin:2px 0 10px;padding:10px;display:flex}.FLE8Ga_presetTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}.FLE8Ga_presetHelp{color:var(--dsw-alias-label-tertiary);margin:0;font-size:11px;line-height:16px}.FLE8Ga_presetTabs{flex-wrap:wrap;gap:6px;display:flex}.FLE8Ga_presetTab{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:999px;padding:3px 8px;font-size:11px;line-height:16px}.FLE8Ga_presetTab[data-active=true]{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.FLE8Ga_presetList{flex-direction:column;gap:6px;display:flex}.FLE8Ga_presetItem{border:1px solid var(--dsw-alias-border-l2);color:inherit;text-align:left;cursor:pointer;background:0 0;border-radius:8px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.FLE8Ga_presetItem[data-active=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.FLE8Ga_presetItemHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.FLE8Ga_presetItemName{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:600;line-height:16px}.FLE8Ga_presetMetaRow{flex-wrap:wrap;gap:6px;display:flex}.FLE8Ga_presetMetaChip{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 46%, transparent);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 6px;font-size:10px;line-height:15px}.FLE8Ga_presetItemDesc{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.FLE8Ga_presetDiffBadge{color:var(--dsw-alias-label-secondary);flex:none;font-size:10px;line-height:15px}.FLE8Ga_presetActions{justify-content:flex-end;gap:8px;display:flex}.FLE8Ga_presetActionGhost,.FLE8Ga_presetActionPrimary{cursor:pointer;border-radius:6px;padding:3px 10px;font-size:11px;line-height:16px}.FLE8Ga_presetActionGhost{color:var(--dsw-alias-label-secondary);background:0 0;border:1px solid #0000}.FLE8Ga_presetActionPrimary{border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary);color:#fff}.FLE8Ga_empty{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 8px;font-size:11px;line-height:16px}.FLE8Ga_viewBtn{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex;position:relative}.FLE8Ga_viewBtn:hover{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.FLE8Ga_viewBtn:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.FLE8Ga_modalMask{z-index:100;background:#00000073;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.FLE8Ga_modal{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:12px;width:460px;max-width:100%;padding:16px;box-shadow:0 12px 40px #00000080}.FLE8Ga_modalHead{align-items:center;gap:8px;margin-bottom:12px;display:flex}.FLE8Ga_modalTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.FLE8Ga_modalClose{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;margin-left:auto;padding:2px 6px;font-size:13px;line-height:16px}.FLE8Ga_modalClose:hover{color:var(--dsw-alias-label-primary);background:#ffffff0f}.FLE8Ga_roleSlogan{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, transparent);color:var(--dsw-alias-state-business-primary);border-radius:8px;padding:8px 10px;font-size:13px;font-weight:500;line-height:20px}.FLE8Ga_modalSectionTitle{color:var(--dsw-alias-label-tertiary);margin:12px 0 6px;font-size:11px;line-height:16px}.FLE8Ga_dutyRow{gap:8px;padding:6px 10px;font-size:12px;line-height:20px;display:flex}.FLE8Ga_dutyRow+.FLE8Ga_dutyRow{border-top:1px dashed var(--dsw-alias-border-l2)}.FLE8Ga_dutyStep{color:var(--dsw-alias-label-secondary);flex:none;font-weight:500}.FLE8Ga_dutyDesc{color:var(--dsw-alias-label-primary)}.FLE8Ga_modalKv{align-items:center;gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.FLE8Ga_modalK{width:72px;color:var(--dsw-alias-label-tertiary);flex:none}.FLE8Ga_modalV{color:var(--dsw-alias-label-secondary);flex:1;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}.FLE8Ga_modalEmpty{color:var(--dsw-alias-label-tertiary);padding:6px 10px;font-size:12px;line-height:20px}.FLE8Ga_modalBody{max-height:min(52vh,420px);margin-right:-4px;padding-right:4px;overflow:auto}.FLE8Ga_ruleRow{gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.FLE8Ga_ruleBullet{color:var(--dsw-alias-state-business-primary);flex:none}.FLE8Ga_growthStat{color:var(--dsw-alias-label-primary);margin:0 0 8px;padding:0 10px;font-size:12px;line-height:20px}.FLE8Ga_growthList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.FLE8Ga_growthItem{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 40%, transparent);border-radius:8px;flex-direction:column;gap:2px;padding:8px 10px;display:flex}.FLE8Ga_growthPractice{color:var(--dsw-alias-label-primary);font-size:12px;line-height:20px}.FLE8Ga_growthMeta{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}";
		...
		var ProviderGrantsSection_module_css_default = {
			"card": "FLE8Ga_card",
			"dutyDesc": "FLE8Ga_dutyDesc",
			"dutyRow": "FLE8Ga_dutyRow",
			"dutyStep": "FLE8Ga_dutyStep",
			"empty": "FLE8Ga_empty",
			"growthItem": "FLE8Ga_growthItem",
			"growthList": "FLE8Ga_growthList",
			"growthMeta": "FLE8Ga_growthMeta",
			"growthPractice": "FLE8Ga_growthPractice",
			"growthStat": "FLE8Ga_growthStat",
			"head": "FLE8Ga_head",
			"list": "FLE8Ga_list",
			"modal": "FLE8Ga_modal",
			"modalBody": "FLE8Ga_modalBody",
			"modalClose": "FLE8Ga_modalClose",
			"modalEmpty": "FLE8Ga_modalEmpty",
			"modalHead": "FLE8Ga_modalHead",
			"modalK": "FLE8Ga_modalK",
			"modalKv": "FLE8Ga_modalKv",
			"modalMask": "FLE8Ga_modalMask",
			"modalSectionTitle": "FLE8Ga_modalSectionTitle",
			"modalTitle": "FLE8Ga_modalTitle",
			"modalV": "FLE8Ga_modalV",
			"name": "FLE8Ga_name",
			"nameWrap": "FLE8Ga_nameWrap",
			"pill": "FLE8Ga_pill",
			"presetActionGhost": "FLE8Ga_presetActionGhost",
			"presetActionPrimary": "FLE8Ga_presetActionPrimary",
			"presetActions": "FLE8Ga_presetActions",
			"presetDiffBadge": "FLE8Ga_presetDiffBadge",
			"presetHelp": "FLE8Ga_presetHelp",
			"presetItem": "FLE8Ga_presetItem",
			"presetItemDesc": "FLE8Ga_presetItemDesc",
			"presetItemHead": "FLE8Ga_presetItemHead",
			"presetItemName": "FLE8Ga_presetItemName",
			"presetList": "FLE8Ga_presetList",
			"presetMetaChip": "FLE8Ga_presetMetaChip",
			"presetMetaRow": "FLE8Ga_presetMetaRow",
			"presetPopover": "FLE8Ga_presetPopover",
			"presetTab": "FLE8Ga_presetTab",
			"presetTabs": "FLE8Ga_presetTabs",
			"presetTitle": "FLE8Ga_presetTitle",
			"resetBtn": "FLE8Ga_resetBtn",
			"roleSlogan": "FLE8Ga_roleSlogan",
			"row": "FLE8Ga_row",
			"rowSub": "FLE8Ga_rowSub",
			"ruleBullet": "FLE8Ga_ruleBullet",
			"ruleRow": "FLE8Ga_ruleRow",
			"section": "FLE8Ga_section",
			"select": "FLE8Ga_select",
			"switch": "FLE8Ga_switch",
			"switchThumb": "FLE8Ga_switchThumb",
			"title": "FLE8Ga_title",
			"viewBtn": "FLE8Ga_viewBtn"
		};
		//#endregion
