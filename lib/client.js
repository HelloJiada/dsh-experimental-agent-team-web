window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const cssText$2 = ".YPX27G_root{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:8px;width:100%;min-width:0;padding:10px 12px;display:flex}.YPX27G_head{align-items:center;gap:8px;min-width:0;display:flex}.YPX27G_leadAvatar{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0;flex:none;width:30px;height:30px}.YPX27G_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.YPX27G_memberCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;margin-left:auto;font-size:11px;line-height:16px}.YPX27G_panelButton{border:1px solid var(--dsw-alias-line-strong);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;flex:none;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:16px;transition:border-color .12s,color .12s}.YPX27G_panelButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.YPX27G_panelButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.YPX27G_members{flex-wrap:wrap;gap:6px;min-width:0;display:flex}.YPX27G_member{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:160px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:5px;padding:3px 8px 3px 3px;font-size:11px;font-weight:500;line-height:16px;transition:border-color .12s,background-color .12s;display:inline-flex}.YPX27G_member:hover{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-fill-neutral)}.YPX27G_member:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.YPX27G_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d482e);background:0 0;border:0;border-radius:0;width:24px;height:24px}.YPX27G_memberInitial{background:var(--dsw-alias-bg-fill-business);width:20px;height:20px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:10px;font-weight:600;line-height:20px;display:inline-flex}.YPX27G_memberName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}";
		...
		var AgentTeamsCard_module_css_default = {
			"head": "YPX27G_head",
			"leadAvatar": "YPX27G_leadAvatar",
			"member": "YPX27G_member",
			"memberArt": "YPX27G_memberArt",
			"memberCount": "YPX27G_memberCount",
			"memberInitial": "YPX27G_memberInitial",
			"memberName": "YPX27G_memberName",
			"members": "YPX27G_members",
			"panelButton": "YPX27G_panelButton",
			"root": "YPX27G_root",
			"teamName": "YPX27G_teamName"
		};
		//#endregion
		...
		*/
		...
		const cssText$1 = "html{--agent-team-web-panel-shift:420px}html[data-agent-team-web-panel-open] div[data-phase]{box-sizing:border-box;padding-right:var(--agent-team-web-panel-shift)}.Ii2d-q_badge,.Ii2d-q_panel{--at-bg-panel:#fff;--at-bg-raised:#fafbfc;--at-bg-fill:#f4f6f9;--at-border:#e8ebf0;--at-border-strong:#d9dee8;--at-text-primary:#1b1f27;--at-text-secondary:#5a6474;--at-text-tertiary:#8f97a6;--at-accent:#2d5ca8;--at-accent-hover:#3568b8;--at-accent-strong:#244a8a;--at-success:#15875a;--at-warning:#a4681a;--at-danger:#c23b42;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #17203014;--at-shadow-panel:0 12px 32px #17203012, 0 32px 72px #1720301c;--at-shadow-active:0 16px 40px #1720301a, 0 36px 80px #17203024;--dsw-alias-bg-module:var(--at-bg-panel);--dsw-alias-bg-module-platform:var(--at-bg-raised);--dsw-alias-bg-fill-neutral:var(--at-bg-fill);--dsw-alias-bg-fill-business:var(--at-accent);--dsw-alias-bg-fill-success:var(--at-success);--dsw-alias-bg-fill-warning:var(--at-warning);--dsw-alias-bg-fill-danger:var(--at-danger);--dsw-alias-state-business-primary:var(--at-accent);--dsw-alias-state-success:var(--at-success);--dsw-alias-state-warning:var(--at-warning);--dsw-alias-state-danger:var(--at-danger);--dsw-alias-label-primary:var(--at-text-primary);--dsw-alias-label-secondary:var(--at-text-secondary);--dsw-alias-label-tertiary:var(--at-text-tertiary);--dsw-alias-label-on-fill:var(--at-on-accent);--dsw-alias-line-normal:var(--at-border);--dsw-alias-line-strong:var(--at-border-strong)}@media (prefers-color-scheme:dark){.Ii2d-q_badge,.Ii2d-q_panel{--at-bg-panel:#1e1f22;--at-bg-raised:#202125;--at-bg-fill:#2a2c30;--at-border:#2e3136;--at-border-strong:#3a3e45;--at-text-primary:#f5f6f8;--at-text-secondary:#b9bdc6;--at-text-tertiary:#8b90a0;--at-accent:#5b8dd9;--at-accent-hover:#6d9be0;--at-accent-strong:#4a7cc9;--at-success:#3ecf7f;--at-warning:#f0a83c;--at-danger:#f0606a;--at-on-accent:#fff;--at-shadow-badge:0 8px 24px #00000073;--at-shadow-panel:0 12px 32px #00000073, 0 32px 72px #0000008c;--at-shadow-active:0 16px 40px #00000080, 0 36px 80px #0009}.Ii2d-q_stateArt{filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #00000073)}}.Ii2d-q_badge{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:color-mix(in srgb, var(--dsw-alias-bg-module-platform) 92%, transparent);backdrop-filter:blur(16px);height:34px;box-shadow:var(--at-shadow-badge);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:7px;padding:0 12px;font-size:12px;font-weight:600;line-height:20px;transition:border-color .12s,transform .12s;display:inline-flex;position:absolute;top:64px;right:18px}.Ii2d-q_badge:hover{border-color:var(--dsw-alias-line-strong);transform:translateY(-1px)}.Ii2d-q_badge:active{transform:translateY(0)scale(.97)}.Ii2d-q_badge:focus-visible,.Ii2d-q_iconButton:focus-visible,.Ii2d-q_memberRow:focus-visible,.Ii2d-q_membersToggle:focus-visible,.Ii2d-q_sectionToggleTitle:focus-visible,.Ii2d-q_historyToggle:focus-visible,.Ii2d-q_dagNode:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Ii2d-q_badgeDot,.Ii2d-q_panelDot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:7px;height:7px}.Ii2d-q_badgeDot[data-busy=true],.Ii2d-q_panelDot[data-busy=true]{background:var(--dsw-alias-state-business-primary);animation:1.25s ease-in-out infinite Ii2d-q_agentTeamsPulse}.Ii2d-q_badgeCount,.Ii2d-q_memberCount,.Ii2d-q_teamStats,.Ii2d-q_stageLabel,.Ii2d-q_taskId{font-variant-numeric:tabular-nums}.Ii2d-q_panel{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-line-strong) 58%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-module) 95%, transparent);backdrop-filter:blur(20px)saturate(1.08);box-shadow:var(--at-shadow-panel);will-change:transform;border-radius:16px;flex-direction:column;animation:.16s ease-out Ii2d-q_agentTeamsPanelIn;display:flex;position:absolute;top:0;left:0;overflow:hidden}.Ii2d-q_panel[data-dragging],.Ii2d-q_panel[data-resizing]{user-select:none;box-shadow:var(--at-shadow-active)}@keyframes Ii2d-q_agentTeamsPanelIn{0%{opacity:0}to{opacity:1}}@keyframes Ii2d-q_agentTeamsPulse{0%,to{opacity:.42}50%{opacity:1}}.Ii2d-q_panelHead{border-bottom:1px solid var(--dsw-alias-line-normal);cursor:grab;touch-action:none;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:0 14px;display:flex}.Ii2d-q_panelHead:active,.Ii2d-q_panel[data-dragging] .Ii2d-q_panelHead{cursor:grabbing}.Ii2d-q_panel[data-compact] .Ii2d-q_panelHead{cursor:default;touch-action:auto}.Ii2d-q_panelTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:8px;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}.Ii2d-q_panelControls{flex:none;align-items:center;gap:2px;display:inline-flex}.Ii2d-q_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,transform .12s;display:inline-flex}.Ii2d-q_iconButton:hover{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-primary)}.Ii2d-q_iconButton:active{transform:scale(.94)}.Ii2d-q_iconButton[data-control=dock][data-mode=docked] svg{transform:scaleX(-1)}.Ii2d-q_iconButton[data-control=close]:hover:not(:disabled){background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.Ii2d-q_iconButton[data-control=close]:disabled{opacity:.45;cursor:not-allowed}.Ii2d-q_closeError{color:var(--dsw-alias-state-danger);border-top:1px solid var(--dsw-alias-line-normal);padding:4px 14px;font-size:12px;line-height:16px}.Ii2d-q_resizeHandle{z-index:1;touch-action:none;position:absolute}.Ii2d-q_resizeHandle[data-resize-edge=left]{cursor:ew-resize;width:8px;top:44px;bottom:8px;left:0}.Ii2d-q_resizeHandle[data-resize-edge=bottom]{cursor:ns-resize;height:8px;bottom:0;left:12px;right:12px}.Ii2d-q_resizeHandle[data-resize-edge=corner]{cursor:nwse-resize;width:18px;height:18px;bottom:0;right:0}.Ii2d-q_resizeHandle[data-resize-edge=corner]:after{border-right:1px solid var(--dsw-alias-label-tertiary);border-bottom:1px solid var(--dsw-alias-label-tertiary);content:\"\";opacity:.52;width:7px;height:7px;position:absolute;bottom:4px;right:4px}.Ii2d-q_teams{overscroll-behavior:contain;scrollbar-color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent) transparent;scrollbar-width:thin;flex-direction:column;min-height:0;display:flex;overflow-y:auto}.Ii2d-q_teams::-webkit-scrollbar{width:6px}.Ii2d-q_teams::-webkit-scrollbar-track{background:0 0}.Ii2d-q_teams::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent);background-clip:padding-box;border:2px solid #0000;border-radius:999px}.Ii2d-q_teams:hover::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 44%, transparent);background-clip:padding-box}.Ii2d-q_team{border-bottom:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:12px;padding:12px 14px 14px;display:flex}.Ii2d-q_team:last-child{border-bottom:0}.Ii2d-q_teamHead{align-items:center;gap:10px;min-width:0;display:flex}.Ii2d-q_teamName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}.Ii2d-q_teamStats{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;gap:8px;font-size:10px;line-height:16px;display:inline-flex}.Ii2d-q_sectionHead{justify-content:space-between;align-items:center;gap:8px;min-width:0;display:flex}.Ii2d-q_sectionTitle{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.Ii2d-q_sectionHint{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.Ii2d-q_delegationSection{flex-direction:column;gap:10px;min-width:0;display:flex}.Ii2d-q_captainNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 32%, var(--dsw-alias-line-normal));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid}.Ii2d-q_commandLayer{grid-template-columns:1fr;gap:10px;display:grid}.Ii2d-q_commandLayer[data-leadership=solo]{grid-template-columns:1fr}.Ii2d-q_commissarNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--at-accent) 32%, var(--at-border));background:color-mix(in srgb, var(--at-accent) 5%, var(--at-bg-panel));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid;position:relative}.Ii2d-q_commissarNode:before{background:var(--at-accent);content:\"\";border-radius:2px;width:2px;position:absolute;top:8px;bottom:8px;left:0}.Ii2d-q_commissarState{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;text-align:right;font-size:10px;line-height:14px;overflow:hidden}.Ii2d-q_commissarState[data-activity=working]{color:var(--dsw-alias-state-business-primary);font-weight:600}.Ii2d-q_captainAvatar,.Ii2d-q_memberAvatar{flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}.Ii2d-q_captainAvatar{width:46px;height:46px}.Ii2d-q_leadAvatar,.Ii2d-q_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0}.Ii2d-q_leadAvatar{width:44px;height:44px}.Ii2d-q_memberArt{width:40px;height:40px}.Ii2d-q_captainInfo,.Ii2d-q_memberInfo{flex-direction:column;min-width:0;display:flex}.Ii2d-q_captainInfo{gap:2px}.Ii2d-q_captainLine,.Ii2d-q_memberLine{align-items:center;gap:6px;min-width:0;display:flex}.Ii2d-q_captainName,.Ii2d-q_memberName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:18px;overflow:hidden}.Ii2d-q_captainRole,.Ii2d-q_memberRole{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.Ii2d-q_memberModel{color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 78%, transparent);text-overflow:ellipsis;white-space:nowrap;flex:none;margin-left:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:8px;line-height:12px;overflow:hidden}.Ii2d-q_captainSummary,.Ii2d-q_memberStatusLine{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:15px;overflow:hidden}.Ii2d-q_memberElapsed{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:4px;flex:none;align-items:center;margin-left:6px;padding:0 4px;font-size:8.5px;font-weight:600;line-height:14px;display:inline-flex}.Ii2d-q_memberElapsed[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 14%, transparent);color:var(--dsw-alias-state-warning)}.Ii2d-q_memberElapsed[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 14%, transparent);color:var(--dsw-alias-state-danger)}.Ii2d-q_captainState,.Ii2d-q_memberState{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;align-items:center;gap:5px;font-size:10px;font-weight:500;line-height:15px;display:inline-flex}.Ii2d-q_captainState[data-busy=true],.Ii2d-q_memberState[data-activity=working]{color:var(--dsw-alias-state-business-primary)}.Ii2d-q_workGlyph rect{opacity:.5}.Ii2d-q_workGlyph[data-active=true] rect{animation:1.1s ease-in-out infinite Ii2d-q_agentTeamsDot}@keyframes Ii2d-q_agentTeamsDot{0%,to{opacity:.25}50%{opacity:1}}.Ii2d-q_progressOverview{flex-direction:column;gap:7px;display:flex}.Ii2d-q_progressTitle{color:var(--dsw-alias-label-secondary);font-size:11px;font-weight:600;line-height:16px}.Ii2d-q_progressSegments{gap:3px;display:flex}.Ii2d-q_progressSegments>span,.Ii2d-q_progressEmpty{background:var(--dsw-alias-line-strong);border-radius:2px;flex:1;height:5px}.Ii2d-q_progressEmpty{width:100%;display:block}.Ii2d-q_progressSegments>span[data-state=running]{background:var(--dsw-alias-state-business-primary)}.Ii2d-q_progressSegments>span[data-state=blocked]{background:var(--dsw-alias-state-warning)}.Ii2d-q_progressSegments>span[data-state=completed]{background:var(--dsw-alias-state-success)}.Ii2d-q_progressSegments>span[data-state=failed]{background:var(--dsw-alias-state-danger)}.Ii2d-q_progressSegments>span[data-state=cancelled]{opacity:.55}.Ii2d-q_progressLegend{color:var(--dsw-alias-label-tertiary);gap:10px;font-size:9px;line-height:14px;display:flex}.Ii2d-q_progressLegend>span[data-state=running]{color:var(--dsw-alias-state-business-primary)}.Ii2d-q_progressLegend>span[data-state=blocked]{color:var(--dsw-alias-state-warning)}.Ii2d-q_progressLegend>span[data-state=completed]{color:var(--dsw-alias-state-success)}.Ii2d-q_progressSummary{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));min-width:0;color:var(--dsw-alias-label-secondary);border-radius:8px;align-items:center;gap:6px;padding:5px 8px;font-size:10px;font-weight:600;line-height:15px;display:flex}.Ii2d-q_progressSummary[data-state=warning]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 8%, var(--dsw-alias-bg-module))}.Ii2d-q_progressSummary[data-state=completed]{background:color-mix(in srgb, var(--dsw-alias-state-success) 8%, var(--dsw-alias-bg-module))}.Ii2d-q_progressSummary>span:last-child{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Ii2d-q_progressSummaryDot{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:5px;height:5px}.Ii2d-q_progressSummary[data-state=warning] .Ii2d-q_progressSummaryDot{background:var(--dsw-alias-state-warning)}.Ii2d-q_progressSummary[data-state=completed] .Ii2d-q_progressSummaryDot{background:var(--dsw-alias-state-success)}.Ii2d-q_membersToggle{background:var(--dsw-alias-bg-module-platform);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.Ii2d-q_membersToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.Ii2d-q_membersToggle>span{align-items:center;gap:5px;display:inline-flex}.Ii2d-q_membersToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.Ii2d-q_historyToggle{background:var(--dsw-alias-bg-module);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10px;font-weight:600;line-height:15px;transition:background-color .12s;display:flex}.Ii2d-q_historyToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}.Ii2d-q_historyToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}.Ii2d-q_chevron{flex:none;transition:transform .12s}.Ii2d-q_chevron[data-open=true]{transform:rotate(90deg)}.Ii2d-q_delegationTree{flex-direction:column;gap:2px;margin-left:18px;padding:0 0 0 20px;display:flex;position:relative}.Ii2d-q_delegationTree:before{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));content:\"\";width:1px;position:absolute;top:0;bottom:22px;left:0}.Ii2d-q_memberBlock{flex-direction:column;min-width:0;padding:3px 0 7px;display:flex;position:relative}.Ii2d-q_memberBranch{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));width:20px;height:1px;display:block;position:absolute;top:27px;right:100%}.Ii2d-q_memberBranch:before{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:5px;height:5px;position:absolute;top:-2px;right:-1px}.Ii2d-q_memberRow{box-sizing:border-box;width:100%;min-width:0;min-height:48px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:46px minmax(0,1fr) auto;align-items:center;gap:8px;padding:4px 6px;transition:background-color .12s,transform .12s;display:grid}.Ii2d-q_memberRow:hover,.Ii2d-q_memberRow[data-activity=working]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.Ii2d-q_memberRow:active{transform:scale(.99)}.Ii2d-q_memberAvatar{width:42px;height:42px}.Ii2d-q_memberAvatar[data-unread=true]:after{box-sizing:border-box;border:1px solid var(--dsw-alias-bg-module);background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:6px;height:6px;animation:1.8s ease-in-out infinite Ii2d-q_agentTeamsUnreadPulse;position:absolute;top:0;right:-1px}@keyframes Ii2d-q_agentTeamsUnreadPulse{0%,to{opacity:.78;transform:scale(.92)}50%{opacity:1;transform:scale(1.16)}}.Ii2d-q_memberInitial{background:var(--dsw-alias-bg-fill-business);width:38px;height:38px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:15px;font-weight:600;line-height:20px;display:inline-flex}.Ii2d-q_stateArt{box-sizing:border-box;object-fit:contain;width:22px;height:22px;filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #122d483d);background:0 0;border:0;border-radius:0;position:absolute;bottom:-3px;right:-5px}.Ii2d-q_stateArt[data-activity=working]{animation:2.4s ease-in-out infinite Ii2d-q_agentTeamsFloat}.Ii2d-q_stateArt[data-activity=idle]{animation:4.2s ease-in-out infinite Ii2d-q_agentTeamsBreathe}.Ii2d-q_stateArt[data-activity=unknown]{animation:2.8s ease-in-out infinite Ii2d-q_agentTeamsThink}@keyframes Ii2d-q_agentTeamsFloat{0%,to{transform:translateY(0)rotate(-4deg)}50%{transform:translateY(-2px)rotate(4deg)}}@keyframes Ii2d-q_agentTeamsBreathe{0%,to{opacity:.82;transform:scale(1)}50%{opacity:1;transform:scale(1.06)}}@keyframes Ii2d-q_agentTeamsThink{0%,to{transform:rotate(-7deg)}50%{transform:rotate(7deg)}}.Ii2d-q_memberRight{flex:none;align-items:center;gap:8px;display:inline-flex}.Ii2d-q_memberCount{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}.Ii2d-q_assignmentLine{align-items:center;gap:7px;min-width:0;padding:0 6px 0 60px;display:flex}.Ii2d-q_assignmentLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:9px;line-height:14px}.Ii2d-q_assignmentTasks{flex-wrap:wrap;flex:1;gap:4px;min-width:0;display:flex}.Ii2d-q_assignmentChip{background:var(--dsw-alias-bg-fill-neutral);min-height:16px;color:var(--dsw-alias-label-secondary);border-radius:4px;align-items:center;padding:0 5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:600;line-height:14px;display:inline-flex}.Ii2d-q_assignmentChip[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.Ii2d-q_assignmentChip[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.Ii2d-q_assignmentChip[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.Ii2d-q_assignmentChip[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.Ii2d-q_assignmentChip[data-state=cancelled]{color:var(--dsw-alias-label-tertiary);text-decoration:line-through}.Ii2d-q_assignmentChip[data-review=pending]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.Ii2d-q_assignmentChip[data-helping=true]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 50%, transparent);outline-offset:-1px}.Ii2d-q_reviewChip,.Ii2d-q_helpingChip,.Ii2d-q_calibrationChip,.Ii2d-q_blockedChip,.Ii2d-q_inputChip{box-sizing:border-box;white-space:nowrap;min-height:16px;color:inherit;background:0 0;border-radius:4px;flex:none;align-items:center;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.Ii2d-q_reviewChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-state-warning) 70%, transparent);outline-offset:-1px}.Ii2d-q_blockedChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 75%, transparent);outline-offset:-1px}.Ii2d-q_inputChip{outline:1px dashed color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.Ii2d-q_helpingChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 65%, transparent);outline-offset:-1px}.Ii2d-q_calibrationChip{outline:1px solid color-mix(in srgb, var(--dsw-alias-label-secondary) 70%, transparent);outline-offset:-1px}.Ii2d-q_assignmentChip[data-timing=warn]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-warning) 55%, transparent);outline-offset:-1px}.Ii2d-q_assignmentChip[data-timing=over]{outline:1px solid color-mix(in srgb, var(--dsw-alias-state-danger) 62%, transparent);outline-offset:-1px}.Ii2d-q_timingChip{box-sizing:border-box;white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:16px;margin-left:4px;padding:0 3px;font-family:inherit;font-size:8.5px;font-weight:700;line-height:16px;display:inline-flex}.Ii2d-q_timingChip[data-timing=warn]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 16%, transparent);color:var(--dsw-alias-state-warning)}.Ii2d-q_timingChip[data-timing=over]{background:color-mix(in srgb, var(--dsw-alias-state-danger) 16%, transparent);color:var(--dsw-alias-state-danger)}.Ii2d-q_unreadPill{color:var(--dsw-alias-state-business-primary);white-space:nowrap;flex:none;font-size:9px;font-weight:600;line-height:14px}.Ii2d-q_taskEmpty{color:var(--dsw-alias-label-tertiary);font-size:9px;line-height:14px}.Ii2d-q_dependencySection{border-top:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:7px;min-width:0;padding-top:10px;display:flex}.Ii2d-q_sectionToggleTitle{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.Ii2d-q_dagViewport{scrollbar-width:thin;min-width:0;padding:2px 0 4px;overflow-x:auto}.Ii2d-q_dagCanvas{min-width:100%;position:relative}.Ii2d-q_dagCanvas[data-layout=parallel]{flex-wrap:wrap;gap:8px;display:flex}.Ii2d-q_dagCanvas[data-layout=parallel] .Ii2d-q_dagNode{flex:92px;min-width:92px;position:relative}.Ii2d-q_dagEdges{pointer-events:none;position:absolute;inset:0;overflow:visible}.Ii2d-q_dagEdges path{fill:none;stroke:var(--dsw-alias-line-strong);stroke-width:1px;transition:opacity .12s,stroke .12s,stroke-width .12s}.Ii2d-q_dagEdges path[data-active=true]{stroke:var(--dsw-alias-state-business-primary);stroke-width:1.6px}.Ii2d-q_dagEdges path[data-dimmed=true]{opacity:.24}.Ii2d-q_dagNode{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:6px;flex-direction:column;justify-content:center;gap:1px;padding:0 6px;transition:border-color .12s,background-color .12s,opacity .12s;display:flex;position:absolute}.Ii2d-q_dagNode:hover,.Ii2d-q_dagNode[data-focused=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.Ii2d-q_dagNode[data-dimmed=true]{opacity:.3}.Ii2d-q_dagNode[data-state=running][data-dimmed=true]{opacity:.58}.Ii2d-q_dagNode[data-state=completed]{border-color:color-mix(in srgb, var(--dsw-alias-state-success) 48%, var(--dsw-alias-line-normal))}.Ii2d-q_dagNode[data-state=blocked]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 52%, var(--dsw-alias-line-normal))}.Ii2d-q_dagNode[data-review=pending]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.Ii2d-q_dagNode[data-helping=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 70%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-business-primary) 38%, transparent)}.Ii2d-q_dagNode[data-timing=warn]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-warning) 42%, transparent)}.Ii2d-q_dagNode[data-timing=over]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 78%, var(--dsw-alias-line-normal));box-shadow:0 0 0 1px color-mix(in srgb, var(--dsw-alias-state-danger) 46%, transparent)}.Ii2d-q_dagNode[data-state=failed]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 56%, var(--dsw-alias-line-normal))}.Ii2d-q_dagNodeHead{color:var(--dsw-alias-label-primary);align-items:center;gap:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:700;display:flex}.Ii2d-q_dagNodeDot{background:var(--dsw-alias-line-strong);border-radius:2px;flex:none;width:5px;height:5px}.Ii2d-q_dagNode[data-state=running] .Ii2d-q_dagNodeDot{background:var(--dsw-alias-state-business-primary)}.Ii2d-q_dagNode[data-state=running] .Ii2d-q_dagNodeHead{padding-right:12px}.Ii2d-q_dagRunningState{width:9px;height:9px;color:var(--dsw-alias-state-business-primary);pointer-events:none;justify-content:center;align-items:center;display:inline-flex;position:absolute;top:4px;right:5px}.Ii2d-q_dagRunningState .Ii2d-q_workGlyph{width:9px;height:9px}.Ii2d-q_dagNode[data-state=blocked] .Ii2d-q_dagNodeDot{background:var(--dsw-alias-state-warning)}.Ii2d-q_dagNode[data-state=completed] .Ii2d-q_dagNodeDot{background:var(--dsw-alias-state-success)}.Ii2d-q_dagNode[data-state=failed] .Ii2d-q_dagNodeDot{background:var(--dsw-alias-state-danger)}.Ii2d-q_dagNodeLabel{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:11px;overflow:hidden}.Ii2d-q_taskDetail{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:8px;flex-direction:column;gap:3px;min-width:0;padding:7px 9px;display:flex}.Ii2d-q_taskDetailHead{align-items:center;gap:6px;min-width:0;display:flex}.Ii2d-q_taskDetailId{color:var(--dsw-alias-state-business-primary);flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;font-weight:700}.Ii2d-q_taskDetailSubject{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.Ii2d-q_taskDetailBadge{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:8.5px;font-weight:600;line-height:14px}.Ii2d-q_taskDetailBadge[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.Ii2d-q_taskDetailBadge[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.Ii2d-q_taskDetailBadge[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.Ii2d-q_taskDetailBadge[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.Ii2d-q_taskDetailLine,.Ii2d-q_taskDetailMeta{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.Ii2d-q_taskDetailMeta{color:var(--dsw-alias-label-tertiary)}.Ii2d-q_archiveAction{color:var(--dsw-alias-state-danger);background:color-mix(in srgb, var(--dsw-alias-state-danger) 12%, transparent);cursor:pointer;border:0;border-radius:5px;padding:3px 6px;font-size:9px}.Ii2d-q_archiveAction:disabled{opacity:.55;cursor:not-allowed}.Ii2d-q_diagnosticBanner{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-warning) 10%, var(--dsw-alias-bg-module));flex-wrap:wrap;align-items:flex-start;gap:6px 8px;padding:7px 10px;font-size:11px;line-height:16px;display:flex}.Ii2d-q_diagnosticBanner button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-fill-neutral);cursor:pointer;border:0;border-radius:4px;padding:2px 6px}.Ii2d-q_archiveConfirm{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-danger) 10%, var(--dsw-alias-background-base));justify-content:space-between;gap:8px;padding:7px 10px;font-size:10px;display:flex}.Ii2d-q_archiveConfirmActions{gap:5px;display:flex}.Ii2d-q_archiveConfirmActions button{cursor:pointer;border:0;border-radius:4px;padding:3px 6px}.Ii2d-q_connectionStatus{color:var(--dsw-alias-label-tertiary);margin-left:5px;font-size:9px;font-weight:400}.Ii2d-q_connectionStatus[data-connection=stale],.Ii2d-q_connectionStatus[data-connection=offline],.Ii2d-q_connectionStatus[data-connection=auth-failed]{color:var(--dsw-alias-state-warning)}.Ii2d-q_taskDetailActions{gap:6px;margin-top:3px;display:flex}.Ii2d-q_taskDetailActions button{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;padding:1px 4px;font-size:9px}.Ii2d-q_taskDetailTiming{color:var(--dsw-alias-label-secondary);font-size:9px;line-height:14px}.Ii2d-q_taskDetailTiming[data-timing=warn]{color:var(--dsw-alias-state-warning)}.Ii2d-q_taskDetailTiming[data-timing=over]{color:var(--dsw-alias-state-danger);font-weight:600}.Ii2d-q_taskDetailBudgetFact{color:var(--dsw-alias-label-secondary);font-size:11px;line-height:16px}.Ii2d-q_taskDetailBudgetFact[data-budget-fact=over_budget]{color:var(--dsw-alias-state-warning);font-weight:700}.Ii2d-q_taskDetailBudgetFact[data-budget-fact=within_budget]{color:var(--dsw-alias-state-success)}.Ii2d-q_taskDetailSignals,.Ii2d-q_taskDetailRetro{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:13px;overflow:hidden}.Ii2d-q_taskDetail[data-expanded] .Ii2d-q_taskDetailSignals,.Ii2d-q_taskDetail[data-expanded] .Ii2d-q_taskDetailRetro{overflow-wrap:anywhere;text-overflow:clip;white-space:normal;font-size:12px;line-height:18px;overflow:visible}.Ii2d-q_taskDetail[data-expanded] .Ii2d-q_taskDetailActions{margin-top:7px}.Ii2d-q_taskDetailActions button{min-height:32px}.Ii2d-q_taskDetailActions button:focus-visible,.Ii2d-q_archiveAction:focus-visible,.Ii2d-q_archiveConfirmActions button:focus-visible{outline:2px solid var(--dsw-alias-state-primary);outline-offset:2px}.Ii2d-q_taskDetailRetro[data-cause=underestimated],.Ii2d-q_taskDetailRetro[data-cause=dependency-blocked]{color:var(--dsw-alias-state-danger)}.Ii2d-q_taskDetailRetro[data-cause=on_time]{color:var(--dsw-alias-state-success)}.Ii2d-q_taskDetailReview{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:600;line-height:14px}.Ii2d-q_taskDetailReview[data-verdict=pass]{color:var(--dsw-alias-state-success)}.Ii2d-q_taskDetailReview[data-verdict=reject]{color:var(--dsw-alias-state-danger)}.Ii2d-q_taskDetailCalibration{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.Ii2d-q_taskDetailBlocked{color:var(--dsw-alias-state-warning);font-size:9px;font-weight:700;line-height:14px}.Ii2d-q_taskDetailInput{color:var(--dsw-alias-label-secondary);font-size:9px;font-weight:600;line-height:14px}.Ii2d-q_emptyHint{color:var(--dsw-alias-label-tertiary);padding:10px 14px;font-size:11px;line-height:16px}.Ii2d-q_modeHint{color:var(--dsw-alias-label-secondary);padding:0 14px 6px;font-size:11px;line-height:16px;display:block}.Ii2d-q_modeBadge{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 7px;font-size:11px;font-weight:600;line-height:16px}.Ii2d-q_modeBadge[data-mode=light]{color:var(--dsw-alias-label-secondary)}.Ii2d-q_modeBadge[data-mode=standard]{color:var(--dsw-alias-state-business-primary)}.Ii2d-q_modeBadge[data-mode=governed]{color:var(--dsw-alias-state-warning)}.Ii2d-q_historicPill{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;margin-left:auto;padding:1px 7px;font-size:9px;font-weight:600;line-height:15px}.Ii2d-q_members{flex-direction:column;gap:3px;display:flex}.Ii2d-q_archiveLabel{color:var(--dsw-alias-label-tertiary);padding:5px 14px 0;font-size:9px;font-weight:600;line-height:14px;display:block}.Ii2d-q_archiveFilterBar{flex-wrap:wrap;align-items:center;gap:6px 8px;padding:6px 14px 2px;display:flex}.Ii2d-q_archiveFilterField{color:var(--dsw-alias-label-tertiary);align-items:center;gap:4px;font-size:9px;line-height:14px;display:inline-flex}.Ii2d-q_archiveFilterCaption{white-space:nowrap;font-weight:600}.Ii2d-q_archiveSelect{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:120px;color:var(--dsw-alias-label-primary);border-radius:4px;padding:1px 2px;font-size:9px;line-height:14px}.Ii2d-q_archiveFilterCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;margin-left:auto;font-size:9px}.Ii2d-q_archiveEmpty{color:var(--dsw-alias-label-tertiary);padding:4px 14px 2px;font-size:9px;display:block}@media (prefers-reduced-motion:reduce){.Ii2d-q_panel,.Ii2d-q_badge,.Ii2d-q_badgeDot,.Ii2d-q_panelDot,.Ii2d-q_workGlyph rect,.Ii2d-q_stateArt,.Ii2d-q_memberAvatar[data-unread=true]:after{transition:none;animation:none}}@media (width<=960px){html[data-agent-team-web-panel-open] div[data-phase]{padding-right:0}.Ii2d-q_team{padding:12px 12px 14px}.Ii2d-q_delegationTree{margin-left:12px;padding-left:15px}.Ii2d-q_memberBranch{width:15px}}@media (width<=640px){.Ii2d-q_badge{top:56px;right:10px}.Ii2d-q_teamStats span[data-stat=messages]{display:none}.Ii2d-q_captainNode{grid-template-columns:48px minmax(0,1fr)}.Ii2d-q_captainState{display:none}.Ii2d-q_assignmentLine{padding-left:60px}}.Ii2d-q_healthChip{box-sizing:border-box;background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;flex:none;align-items:center;gap:5px;padding:1px 8px;font-size:11px;line-height:16px;display:inline-flex}.Ii2d-q_healthChip strong{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:11px;font-weight:700}.Ii2d-q_healthChip em{color:var(--dsw-alias-label-secondary);font-style:normal}.Ii2d-q_healthChip[data-level=ok] strong{color:var(--dsw-alias-state-success)}.Ii2d-q_healthChip[data-level=warn] strong{color:var(--dsw-alias-state-warning)}.Ii2d-q_healthChip[data-level=critical] strong,.Ii2d-q_riskStat{color:var(--dsw-alias-state-danger)}.Ii2d-q_prioritySection{flex-direction:column;gap:5px;min-width:0;display:flex}.Ii2d-q_priorityCard{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);border-radius:8px;align-items:flex-start;gap:8px;padding:6px 8px;display:flex}.Ii2d-q_priorityCard[data-severity=high]{border-color:color-mix(in srgb,var(--dsw-alias-state-danger) 45%,var(--dsw-alias-line-normal))}.Ii2d-q_priorityCard[data-severity=medium]{border-color:color-mix(in srgb,var(--dsw-alias-state-warning) 40%,var(--dsw-alias-line-normal))}.Ii2d-q_priorityBadge{background:var(--dsw-alias-bg-fill-business);min-width:22px;height:18px;color:var(--dsw-alias-label-on-fill);border-radius:6px;flex:none;justify-content:center;align-items:center;font-size:11px;font-weight:700;display:inline-flex}.Ii2d-q_priorityBody{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.Ii2d-q_priorityTitle{flex-wrap:wrap;align-items:center;gap:5px;min-width:0;display:flex}.Ii2d-q_priorityTitle strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.Ii2d-q_chip{background:var(--dsw-alias-bg-module);border:1px solid var(--dsw-alias-line-normal);border-radius:999px;padding:0 6px;font-size:11px;font-style:normal;font-weight:600;line-height:16px;display:inline-flex}.Ii2d-q_chip[data-readiness=blocked],.Ii2d-q_chip[data-readiness=orphaned],.Ii2d-q_chip[data-readiness=stalled],.Ii2d-q_chip[data-readiness=failed],.Ii2d-q_chip[data-severity=high]{border-color:var(--dsw-alias-state-danger);color:var(--dsw-alias-state-danger)}.Ii2d-q_chip[data-severity=medium],.Ii2d-q_chip[data-readiness=ready]{border-color:var(--dsw-alias-state-warning);color:var(--dsw-alias-state-warning)}.Ii2d-q_chip[data-severity=low],.Ii2d-q_chip[data-readiness=cancelled]{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary)}.Ii2d-q_priorityReasons{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.Ii2d-q_milestoneRow{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;line-height:16px;display:flex}.Ii2d-q_milestoneRow strong{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-weight:600;overflow:hidden}.Ii2d-q_loadBar{background:var(--dsw-alias-line-strong);border-radius:999px;flex:none;align-items:stretch;width:44px;min-width:0;height:6px;display:inline-flex;overflow:hidden}.Ii2d-q_loadBar>span{display:block}.Ii2d-q_loadActive{background:var(--dsw-alias-state-business-primary)}.Ii2d-q_loadPending{background:var(--dsw-alias-state-warning)}.Ii2d-q_loadStalled,.Ii2d-q_loadOrphaned{background:var(--dsw-alias-state-danger)}";
		...
		var ActivityPanel_module_css_default = {
			"agentTeamsBreathe": "Ii2d-q_agentTeamsBreathe",
			"agentTeamsDot": "Ii2d-q_agentTeamsDot",
			"agentTeamsFloat": "Ii2d-q_agentTeamsFloat",
			"agentTeamsPanelIn": "Ii2d-q_agentTeamsPanelIn",
			"agentTeamsPulse": "Ii2d-q_agentTeamsPulse",
			"agentTeamsThink": "Ii2d-q_agentTeamsThink",
			"agentTeamsUnreadPulse": "Ii2d-q_agentTeamsUnreadPulse",
			"archiveAction": "Ii2d-q_archiveAction",
			"archiveConfirm": "Ii2d-q_archiveConfirm",
			"archiveConfirmActions": "Ii2d-q_archiveConfirmActions",
			"archiveEmpty": "Ii2d-q_archiveEmpty",
			"archiveFilterBar": "Ii2d-q_archiveFilterBar",
			"archiveFilterCaption": "Ii2d-q_archiveFilterCaption",
			"archiveFilterCount": "Ii2d-q_archiveFilterCount",
			"archiveFilterField": "Ii2d-q_archiveFilterField",
			"archiveLabel": "Ii2d-q_archiveLabel",
			"archiveSelect": "Ii2d-q_archiveSelect",
			"assignmentChip": "Ii2d-q_assignmentChip",
			"assignmentLabel": "Ii2d-q_assignmentLabel",
			"assignmentLine": "Ii2d-q_assignmentLine",
			"assignmentTasks": "Ii2d-q_assignmentTasks",
			"badge": "Ii2d-q_badge",
			"badgeCount": "Ii2d-q_badgeCount",
			"badgeDot": "Ii2d-q_badgeDot",
			"blockedChip": "Ii2d-q_blockedChip",
			"calibrationChip": "Ii2d-q_calibrationChip",
			"captainAvatar": "Ii2d-q_captainAvatar",
			"captainInfo": "Ii2d-q_captainInfo",
			"captainLine": "Ii2d-q_captainLine",
			"captainName": "Ii2d-q_captainName",
			"captainNode": "Ii2d-q_captainNode",
			"captainRole": "Ii2d-q_captainRole",
			"captainState": "Ii2d-q_captainState",
			"captainSummary": "Ii2d-q_captainSummary",
			"chevron": "Ii2d-q_chevron",
			"chip": "Ii2d-q_chip",
			"closeError": "Ii2d-q_closeError",
			"commandLayer": "Ii2d-q_commandLayer",
			"commissarNode": "Ii2d-q_commissarNode",
			"commissarState": "Ii2d-q_commissarState",
			"connectionStatus": "Ii2d-q_connectionStatus",
			"dagCanvas": "Ii2d-q_dagCanvas",
			"dagEdges": "Ii2d-q_dagEdges",
			"dagNode": "Ii2d-q_dagNode",
			"dagNodeDot": "Ii2d-q_dagNodeDot",
			"dagNodeHead": "Ii2d-q_dagNodeHead",
			"dagNodeLabel": "Ii2d-q_dagNodeLabel",
			"dagRunningState": "Ii2d-q_dagRunningState",
			"dagViewport": "Ii2d-q_dagViewport",
			"delegationSection": "Ii2d-q_delegationSection",
			"delegationTree": "Ii2d-q_delegationTree",
			"dependencySection": "Ii2d-q_dependencySection",
			"diagnosticBanner": "Ii2d-q_diagnosticBanner",
			"emptyHint": "Ii2d-q_emptyHint",
			"healthChip": "Ii2d-q_healthChip",
			"helpingChip": "Ii2d-q_helpingChip",
			"historicPill": "Ii2d-q_historicPill",
			"historyToggle": "Ii2d-q_historyToggle",
			"iconButton": "Ii2d-q_iconButton",
			"inputChip": "Ii2d-q_inputChip",
			"leadAvatar": "Ii2d-q_leadAvatar",
			"loadActive": "Ii2d-q_loadActive",
			"loadBar": "Ii2d-q_loadBar",
			"loadOrphaned": "Ii2d-q_loadOrphaned",
			"loadPending": "Ii2d-q_loadPending",
			"loadStalled": "Ii2d-q_loadStalled",
			"memberArt": "Ii2d-q_memberArt",
			"memberAvatar": "Ii2d-q_memberAvatar",
			"memberBlock": "Ii2d-q_memberBlock",
			"memberBranch": "Ii2d-q_memberBranch",
			"memberCount": "Ii2d-q_memberCount",
			"memberElapsed": "Ii2d-q_memberElapsed",
			"memberInfo": "Ii2d-q_memberInfo",
			"memberInitial": "Ii2d-q_memberInitial",
			"memberLine": "Ii2d-q_memberLine",
			"memberModel": "Ii2d-q_memberModel",
			"memberName": "Ii2d-q_memberName",
			"memberRight": "Ii2d-q_memberRight",
			"memberRole": "Ii2d-q_memberRole",
			"memberRow": "Ii2d-q_memberRow",
			"memberState": "Ii2d-q_memberState",
			"memberStatusLine": "Ii2d-q_memberStatusLine",
			"members": "Ii2d-q_members",
			"membersToggle": "Ii2d-q_membersToggle",
			"milestoneRow": "Ii2d-q_milestoneRow",
			"modeBadge": "Ii2d-q_modeBadge",
			"modeHint": "Ii2d-q_modeHint",
			"panel": "Ii2d-q_panel",
			"panelControls": "Ii2d-q_panelControls",
			"panelDot": "Ii2d-q_panelDot",
			"panelHead": "Ii2d-q_panelHead",
			"panelTitle": "Ii2d-q_panelTitle",
			"priorityBadge": "Ii2d-q_priorityBadge",
			"priorityBody": "Ii2d-q_priorityBody",
			"priorityCard": "Ii2d-q_priorityCard",
			"priorityReasons": "Ii2d-q_priorityReasons",
			"prioritySection": "Ii2d-q_prioritySection",
			"priorityTitle": "Ii2d-q_priorityTitle",
			"progressEmpty": "Ii2d-q_progressEmpty",
			"progressLegend": "Ii2d-q_progressLegend",
			"progressOverview": "Ii2d-q_progressOverview",
			"progressSegments": "Ii2d-q_progressSegments",
			"progressSummary": "Ii2d-q_progressSummary",
			"progressSummaryDot": "Ii2d-q_progressSummaryDot",
			"progressTitle": "Ii2d-q_progressTitle",
			"resizeHandle": "Ii2d-q_resizeHandle",
			"reviewChip": "Ii2d-q_reviewChip",
			"riskStat": "Ii2d-q_riskStat",
			"sectionHead": "Ii2d-q_sectionHead",
			"sectionHint": "Ii2d-q_sectionHint",
			"sectionTitle": "Ii2d-q_sectionTitle",
			"sectionToggleTitle": "Ii2d-q_sectionToggleTitle",
			"stageLabel": "Ii2d-q_stageLabel",
			"stateArt": "Ii2d-q_stateArt",
			"taskDetail": "Ii2d-q_taskDetail",
			"taskDetailActions": "Ii2d-q_taskDetailActions",
			"taskDetailBadge": "Ii2d-q_taskDetailBadge",
			"taskDetailBlocked": "Ii2d-q_taskDetailBlocked",
			"taskDetailBudgetFact": "Ii2d-q_taskDetailBudgetFact",
			"taskDetailCalibration": "Ii2d-q_taskDetailCalibration",
			"taskDetailHead": "Ii2d-q_taskDetailHead",
			"taskDetailId": "Ii2d-q_taskDetailId",
			"taskDetailInput": "Ii2d-q_taskDetailInput",
			"taskDetailLine": "Ii2d-q_taskDetailLine",
			"taskDetailMeta": "Ii2d-q_taskDetailMeta",
			"taskDetailRetro": "Ii2d-q_taskDetailRetro",
			"taskDetailReview": "Ii2d-q_taskDetailReview",
			"taskDetailSignals": "Ii2d-q_taskDetailSignals",
			"taskDetailSubject": "Ii2d-q_taskDetailSubject",
			"taskDetailTiming": "Ii2d-q_taskDetailTiming",
			"taskEmpty": "Ii2d-q_taskEmpty",
			"taskId": "Ii2d-q_taskId",
			"team": "Ii2d-q_team",
			"teamHead": "Ii2d-q_teamHead",
			"teamName": "Ii2d-q_teamName",
			"teamStats": "Ii2d-q_teamStats",
			"teams": "Ii2d-q_teams",
			"timingChip": "Ii2d-q_timingChip",
			"unreadPill": "Ii2d-q_unreadPill",
			"workGlyph": "Ii2d-q_workGlyph"
		};
		//#endregion
		...
		*/
		...
		const cssText = ".ArsnRG_section{flex-direction:column;gap:14px;display:flex}.ArsnRG_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:10px;padding:14px 16px;display:flex}.ArsnRG_head{align-items:center;gap:8px;display:flex}.ArsnRG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.ArsnRG_list{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.ArsnRG_row{box-sizing:border-box;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;min-width:0;min-height:36px;padding:0 10px;display:flex}.ArsnRG_nameWrap{flex:1;align-items:center;gap:8px;min-width:0;display:flex}.ArsnRG_name{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.ArsnRG_rowSub{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;line-height:16px}.ArsnRG_pill{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.ArsnRG_switch{box-sizing:border-box;background:var(--dsw-alias-border-l2);cursor:pointer;border:none;border-radius:999px;flex:none;width:32px;height:18px;padding:0;transition:background .12s ease-in-out;position:relative}.ArsnRG_switch[data-on=true]{background:var(--dsw-alias-state-business-primary)}.ArsnRG_switch:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.ArsnRG_switchThumb{background:var(--dsw-alias-bg-layer-1);border-radius:50%;width:14px;height:14px;transition:transform .12s ease-in-out;position:absolute;top:2px;left:2px}.ArsnRG_switch[data-on=true] .ArsnRG_switchThumb{transform:translate(14px)}.ArsnRG_select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;max-width:200px;color:var(--dsw-alias-label-primary);border-radius:6px;flex:1;padding:2px 4px;font-size:11px;line-height:16px}.ArsnRG_select:disabled{opacity:.55}@media (prefers-color-scheme:dark){.ArsnRG_select{color:#e8e8e8;background:#26282b}}.ArsnRG_resetBtn{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;flex:none;margin-left:auto;padding:2px 10px;font-size:11px;line-height:16px;transition:color .12s ease-in-out,border-color .12s ease-in-out}.ArsnRG_resetBtn:hover:not(:disabled){border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.ArsnRG_resetBtn:disabled{opacity:.45;cursor:default}.ArsnRG_presetPopover{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 56%, transparent);border-radius:10px;flex-direction:column;gap:8px;margin:2px 0 10px;padding:10px;display:flex}.ArsnRG_presetTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}.ArsnRG_presetHelp{color:var(--dsw-alias-label-tertiary);margin:0;font-size:11px;line-height:16px}.ArsnRG_presetTabs{flex-wrap:wrap;gap:6px;display:flex}.ArsnRG_presetTab{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:999px;padding:3px 8px;font-size:11px;line-height:16px}.ArsnRG_presetTab[data-active=true]{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.ArsnRG_presetList{flex-direction:column;gap:6px;display:flex}.ArsnRG_presetItem{border:1px solid var(--dsw-alias-border-l2);color:inherit;text-align:left;cursor:pointer;background:0 0;border-radius:8px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.ArsnRG_presetItem[data-active=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.ArsnRG_presetItemHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.ArsnRG_presetItemName{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:600;line-height:16px}.ArsnRG_presetMetaRow{flex-wrap:wrap;gap:6px;display:flex}.ArsnRG_presetMetaChip{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 46%, transparent);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 6px;font-size:10px;line-height:15px}.ArsnRG_presetItemDesc{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.ArsnRG_presetDiffBadge{color:var(--dsw-alias-label-secondary);flex:none;font-size:10px;line-height:15px}.ArsnRG_presetActions{justify-content:flex-end;gap:8px;display:flex}.ArsnRG_presetActionGhost,.ArsnRG_presetActionPrimary{cursor:pointer;border-radius:6px;padding:3px 10px;font-size:11px;line-height:16px}.ArsnRG_presetActionGhost{color:var(--dsw-alias-label-secondary);background:0 0;border:1px solid #0000}.ArsnRG_presetActionPrimary{border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary);color:#fff}.ArsnRG_empty{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 8px;font-size:11px;line-height:16px}.ArsnRG_viewBtn{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex;position:relative}.ArsnRG_viewBtn:hover{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent)}.ArsnRG_viewBtn:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.ArsnRG_modalMask{z-index:100;background:#00000073;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.ArsnRG_modal{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:12px;width:460px;max-width:100%;padding:16px;box-shadow:0 12px 40px #00000080}.ArsnRG_modalHead{align-items:center;gap:8px;margin-bottom:12px;display:flex}.ArsnRG_modalTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;line-height:20px}.ArsnRG_modalClose{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;margin-left:auto;padding:2px 6px;font-size:13px;line-height:16px}.ArsnRG_modalClose:hover{color:var(--dsw-alias-label-primary);background:#ffffff0f}.ArsnRG_roleSlogan{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, transparent);color:var(--dsw-alias-state-business-primary);border-radius:8px;padding:8px 10px;font-size:13px;font-weight:500;line-height:20px}.ArsnRG_modalSectionTitle{color:var(--dsw-alias-label-tertiary);margin:12px 0 6px;font-size:11px;line-height:16px}.ArsnRG_dutyRow{gap:8px;padding:6px 10px;font-size:12px;line-height:20px;display:flex}.ArsnRG_dutyRow+.ArsnRG_dutyRow{border-top:1px dashed var(--dsw-alias-border-l2)}.ArsnRG_dutyStep{color:var(--dsw-alias-label-secondary);flex:none;font-weight:500}.ArsnRG_dutyDesc{color:var(--dsw-alias-label-primary)}.ArsnRG_modalKv{align-items:center;gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.ArsnRG_modalK{width:72px;color:var(--dsw-alias-label-tertiary);flex:none}.ArsnRG_modalV{color:var(--dsw-alias-label-secondary);flex:1;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}.ArsnRG_modalEmpty{color:var(--dsw-alias-label-tertiary);padding:6px 10px;font-size:12px;line-height:20px}.ArsnRG_modalBody{max-height:min(52vh,420px);margin-right:-4px;padding-right:4px;overflow:auto}.ArsnRG_ruleRow{gap:8px;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.ArsnRG_ruleBullet{color:var(--dsw-alias-state-business-primary);flex:none}.ArsnRG_growthStat{color:var(--dsw-alias-label-primary);margin:0 0 8px;padding:0 10px;font-size:12px;line-height:20px}.ArsnRG_growthList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.ArsnRG_growthItem{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 40%, transparent);border-radius:8px;flex-direction:column;gap:2px;padding:8px 10px;display:flex}.ArsnRG_growthPractice{color:var(--dsw-alias-label-primary);font-size:12px;line-height:20px}.ArsnRG_growthMeta{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}";
		...
		var ProviderGrantsSection_module_css_default = {
			"card": "ArsnRG_card",
			"dutyDesc": "ArsnRG_dutyDesc",
			"dutyRow": "ArsnRG_dutyRow",
			"dutyStep": "ArsnRG_dutyStep",
			"empty": "ArsnRG_empty",
			"growthItem": "ArsnRG_growthItem",
			"growthList": "ArsnRG_growthList",
			"growthMeta": "ArsnRG_growthMeta",
			"growthPractice": "ArsnRG_growthPractice",
			"growthStat": "ArsnRG_growthStat",
			"head": "ArsnRG_head",
			"list": "ArsnRG_list",
			"modal": "ArsnRG_modal",
			"modalBody": "ArsnRG_modalBody",
			"modalClose": "ArsnRG_modalClose",
			"modalEmpty": "ArsnRG_modalEmpty",
			"modalHead": "ArsnRG_modalHead",
			"modalK": "ArsnRG_modalK",
			"modalKv": "ArsnRG_modalKv",
			"modalMask": "ArsnRG_modalMask",
			"modalSectionTitle": "ArsnRG_modalSectionTitle",
			"modalTitle": "ArsnRG_modalTitle",
			"modalV": "ArsnRG_modalV",
			"name": "ArsnRG_name",
			"nameWrap": "ArsnRG_nameWrap",
			"pill": "ArsnRG_pill",
			"presetActionGhost": "ArsnRG_presetActionGhost",
			"presetActionPrimary": "ArsnRG_presetActionPrimary",
			"presetActions": "ArsnRG_presetActions",
			"presetDiffBadge": "ArsnRG_presetDiffBadge",
			"presetHelp": "ArsnRG_presetHelp",
			"presetItem": "ArsnRG_presetItem",
			"presetItemDesc": "ArsnRG_presetItemDesc",
			"presetItemHead": "ArsnRG_presetItemHead",
			"presetItemName": "ArsnRG_presetItemName",
			"presetList": "ArsnRG_presetList",
			"presetMetaChip": "ArsnRG_presetMetaChip",
			"presetMetaRow": "ArsnRG_presetMetaRow",
			"presetPopover": "ArsnRG_presetPopover",
			"presetTab": "ArsnRG_presetTab",
			"presetTabs": "ArsnRG_presetTabs",
			"presetTitle": "ArsnRG_presetTitle",
			"resetBtn": "ArsnRG_resetBtn",
			"roleSlogan": "ArsnRG_roleSlogan",
			"row": "ArsnRG_row",
			"rowSub": "ArsnRG_rowSub",
			"ruleBullet": "ArsnRG_ruleBullet",
			"ruleRow": "ArsnRG_ruleRow",
			"section": "ArsnRG_section",
			"select": "ArsnRG_select",
			"switch": "ArsnRG_switch",
			"switchThumb": "ArsnRG_switchThumb",
			"title": "ArsnRG_title",
			"viewBtn": "ArsnRG_viewBtn"
		};
		//#endregion
